...
describe("PrefixUtils", function () {
    describe("getLocalName", function () {
        ...
        describe("When localname should be set", function () {
            ...
            it("Maintaining single slash after protocol", function () {
                expect(prefixUtils.getLocalNameInfo("http:/blaa.com/local/")).to.deep.equal({
                    iri: "http:/blaa.com/",
                    localName: "local/",
                });
    ...
    describe("getPrefixInfo", function () {
        describe("from prefix to iri", function () {
            ...
            it("should work with a map", function () {
                const prefixMap = { abc: { prefixLabel: "abc", iri: "http://blaa.com/" } };
        ...
        describe("from iri to prefix", function () {
            ...
            it("match complete iri", function () {
                expect(prefixUtils.getPrefixInfoFromIri("https://iisg.triply.cc/iisg/cshapes/", [
                    ...
                    iri: "https://iisg.triply.cc/iisg/cshapes/",
                    localName: "",
                    prefixLabel: "cshapes",
                });
            });
    ...
    describe("merging prefix arrays", function () {
        it("merge prefix arrays", function () {
            const mergedPrefixes = prefixUtils.mergePrefixArray([
                { prefixLabel: "cshapes", iri: "https://iisg.triply.cc/iisg/cshapes/" },
                { prefixLabel: "triply", iri: "https://triply.cc/" },
            ], [
                { prefixLabel: "cshape", iri: "https://iisg.triply.cc/iisg/cshapes/" },
                { prefixLabel: "iisg", iri: "https://iisg.triply.cc/iisg/" },
                { prefixLabel: "triply", iri: "https://iisg.triply.cc/" },
            ]);
            expect(mergedPrefixes).to.have.lengthOf(3);
            expect(mergedPrefixes[0].prefixLabel).to.equal("cshapes");
            expect(mergedPrefixes[1].prefixLabel).to.equal("triply");
            expect(mergedPrefixes[1].iri).to.equal("https://triply.cc/");
            expect(mergedPrefixes[2].prefixLabel).to.equal("iisg");
        });
    });
});
