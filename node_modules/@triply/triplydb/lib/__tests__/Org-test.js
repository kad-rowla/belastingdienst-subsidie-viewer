...
describe("Orgs", function () {
    ...
    describe("Initialization", function () {
        it("Should throw error when organization does not exist", async function () {
            return expect(App.get().getOrganization("Triply_")).to.eventually.rejectedWith("Failed to fetch organization Triply_. (It does not exist)");
        });
        it("Should throw error when getting a user with an organization name", async function () {
            return expect(App.get().getUser("Triply")).to.eventually.rejectedWith("Failed to fetch user Triply. Note that there is an organization with that name.");
        });
    });
});
