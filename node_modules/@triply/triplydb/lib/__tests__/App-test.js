...
describe("App", function () {
    describe("Initialization", function () {
        it("Should throw error on URL that isnt an API", async function () {
            return expect(App.get({
                url: "https://google.com",
            }).getInfo()).to.eventually.rejectedWith("Failed to fetch API information of https://google.com. (Expected a JSON response, but got text/html");
        });
        it("Should not break when the API url contains a trailing slash", async function () {
            return expect((await App.get({
                url: "https://api.nightly.triplydb.com/",
            }).getInfo()).apiUrl).to.equal("https://api.nightly.triplydb.com");
        });
        it("Should throw error on domain that doesnt exist", async function () {
            return expect(App.get({
                url: "https://googlsdfsdfsdfe.com",
            }).getInfo()).to.eventually.rejectedWith("Failed to fetch API information of https://googlsdfsdfsdfe.com. (request to https://googlsdfsdfsdfe.com/info failed");
        });
    ...
    it("Should postprocess URLs when needed", async function () {
        ...
        expect(app["getPostProcessedApiUrl"]("https://somethingelse.com/somepath/run.nt?somearg=https%3A%2F%2Fwww%2Frijksbegrotingsstructuur%2FBC6BA34-2018-27938&pageSize=5000")).to.equal("http://something.com:5000/somepath/run.nt?somearg=https%3A%2F%2Fwww%2Frijksbegrotingsstructuur%2FBC6BA34-2018-27938&pageSize=5000");
    });
});
