...
describe('f', () => {
    ...
    describe('Extended language subtags and their primary language subtag counterparts', () => {
        test('zh-cmn-Hans-CN', () => expect(f('zh-cmn-Hans-CN')).toBe('Mandarin Chinese, written in Han (Simplified variant) script, as used in China'));
        test('cmn-Hans-CN', () => expect(f('cmn-Hans-CN')).toBe('Mandarin Chinese, written in Han (Simplified variant) script, as used in China'));
    ...
    describe('Language-Script-Region', () => {
        test('zh-Hans-CN', () => expect(f('zh-Hans-CN')).toBe('Chinese, written in Han (Simplified variant) script, as used in China'));
    ...
    describe('Language-Variant', () => {
        ...
        test('sl-rozaj-biske', () => expect(f('sl-rozaj-biske')).toBe('Resian or San Giorgio dialect of Resian variant of Slovenian'));
        test('sl-nedis', () => expect(f('sl-nedis')).toBe('Natisone dialect of Slovenian'));
    });
    describe('Language-Region-Variant', () => {
        test('de-CH-1901', () => expect(f('de-CH-1901')).toBe('Traditional orthography variant of German, as used in Switzerland'));
    ...
    describe('Language-Script-Region-Variant', () => {
        test('hy-Latn-IT-arevela', () => expect(f('hy-Latn-IT-arevela')).toBe('Eastern variant of Armenian, written in Latin script, as used in Italy'));
    });
    ...
    describe('Private use subtags', () => {
        test('de-CH-x-phonebk', () => expect(f('de-CH-x-phonebk')).toBe('German, as used in Switzerland (with private extension ‘x-phonebk’)'));
        test('az-Arab-x-AZE-derbend', () => expect(f('az-Arab-x-AZE-derbend')).toBe('Azerbaijani, written in Arabic script (with private extension ‘x-aze-derbend’)'));
    });
    describe('Private use registry values', () => {
        test('x-whatever', () => expect(f('x-whatever')).toBe('private extension ‘x-whatever’'));
        test('qaa-Qaaa-QM-x-southern', () => expect(f('qaa-Qaaa-QM-x-southern')).toBe('private use language ‘qaa’, written in private use script ‘Qaaa’ script, as used in private use region ‘QM’ (with private extension ‘x-southern’)'));
        test('de-Qaaa', () => expect(f('de-Qaaa')).toBe('German, written in private use script ‘Qaaa’ script'));
        test('sr-Latn-QM', () => expect(f('sr-Latn-QM')).toBe('Serbian, written in Latin script, as used in private use region ‘QM’'));
        test('sr-Qaaa-RS', () => expect(f('sr-Qaaa-RS')).toBe('Serbian, written in private use script ‘Qaaa’ script, as used in Serbia'));
    });
