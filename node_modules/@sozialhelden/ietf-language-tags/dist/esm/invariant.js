export default function invariant(message, ignoreErrors, log) {
    if (ignoreErrors) {
        if (log !== null) {
            log(message.trim());
        }
...
export const errorMessages = {
  ...
  `,
    invalidExtension: (tag, extension, previousValue) => `
