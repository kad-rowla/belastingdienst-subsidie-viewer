...
const _1 = require(".");
const regexp = (0, _1.createRFC5646Regexp)();
describe('createRFC5646Regexp()', () => {
    ...
    it('does not match the most basic invalid tags', () => {
        const match = 'zhzhzhzhzhzh-Latn-CN-pinyin-a-extend1-x-foobar-private1-abc-def-ghi-jkl-mno-pqr'.match(regexp);
        expect(match).toBeNull();
    });
});
//# sourceMappingURL=rfc5646RegExp.spec.js.map