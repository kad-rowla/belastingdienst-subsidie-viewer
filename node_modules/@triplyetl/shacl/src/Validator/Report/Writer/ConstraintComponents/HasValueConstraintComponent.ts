...
export default class HasValueConstraintComponent extends ConstraintComponent {
  public async toString (): Promise<string> {
    ...
    return await Promise.resolve(this.format('The node %o has a predicate %o%s %s match the value%s defined in your shape %o.', this.result.focusNode, this.result.resultPath ?? '[unknown sh:resultPath]', values, constraintMessage, expectedValues, this.result.sourceShape ?? ['unknown SourceShape']))
  }
}
