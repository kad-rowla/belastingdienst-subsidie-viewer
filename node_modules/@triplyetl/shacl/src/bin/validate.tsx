...
const error = (msg: string, exit: number = 0): void => {
  if (exit > 0) {
...
if (shapesFile === undefined) error('usage: npx validate <shapes> [<data>]', 1)
if (!await checkFileAccessibility(shapesFile)) error(`${util.format('%o', shapesFile)}}: file is not accessible`, 2)
if (dataFile !== undefined && !await checkFileAccessibility(dataFile)) error(`${util.format('%o', dataFile)}: file is not accessible`, 2)
