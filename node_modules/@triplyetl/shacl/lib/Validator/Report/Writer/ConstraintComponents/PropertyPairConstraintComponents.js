...
select ?compare ?actual ?comparePredicate where {
  ...
  <${this.result.focusNode.value}> <${this.result.resultPath.value}> ?actual; ?comparePredicate ?compare .
        ...
        return await this.engine
            ...
            .then((bindings) => {
            var _a, _b;
            let compare = getFactory().literal('[unknown value]');
            let comparePredicate = getFactory().literal('[unknown value]');
            ...
            const template = 'The node %o has a predicate %o%s, your shape %o defines that this value must be ' +
                msg +
                ' the value of predicate %o which is %o';
            return this.format(template, this.result.focusNode, (_a = this.result.resultPath) !== null && _a !== void 0 ? _a : '[unknown sh:resultPath]', this.valuesToString(), (_b = this.result.sourceShape) !== null && _b !== void 0 ? _b : '[unknown SHACL SourceShape]', comparePredicate, compare);
        })
            .catch((e) => {
            throw e;
        });
...
//   })
// }
//# sourceMappingURL=PropertyPairConstraintComponents.js.map