...
const assertIsSHACLValidationReport = (dataset) => {
    ...
    return {
        report: reports[0].termType === 'BlankNode' ? reports[0] : reports[0],
        conforms: conforms[0].equals(getFactory().literal('true', xsd.boolean))
    };
};
export default assertIsSHACLValidationReport;
//# sourceMappingURL=assertIsSHACLValidationReport.js.map