...
import { Iri, rdf } from "@triplyetl/vocabularies";

// TODO @DocumentationTeam: add TS doc comment here
function list(
  prefix: Iri,
  listOrReference:
    | TermGetter<NamedNode | Literal | Key | StaticString>[]
    | TermGetter<NamedNode | Literal | Key | StaticString>,
): TermGetter<NamedNode> {
  return function _list(ctx: Context) {
    ...
    let listId: NamedNode;
    let previousItemId: NamedNode | undefined;
