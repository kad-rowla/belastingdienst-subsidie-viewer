...
const _objects = (subject: SPG, predicate: SPG, ...objects: O[]): MiddlewareList =>
  objects.map((object) => triple(subject, predicate, object));
 ...
 * ```
 */
export default function objects(subject: SPG, predicate: SPG, ...objects: O[]): Middleware {
