...
import quad, { O, SPG } from "./rdf/quad.js";
 ...
 * ```
 */
export default (subject: SPG, predicate: SPG, object: O): Middleware =>
  addMwCallSiteToError(quad(subject, predicate, object), {
    sourceFuncName: "_triple",
