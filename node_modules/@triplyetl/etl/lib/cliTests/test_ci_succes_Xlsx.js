...
export default async () => {
    const app = new Etl();
    app.use(fromXlsx(Source.file("./src/__tests__/resources/xlsxFiles/addresses_and_cities.xlsx")), addIri({ prefix, key: "S", content: "$recordId" }), when((ctx) => ctx.record.$sheetName === "addresses", addresses), when((ctx) => ctx.record.$sheetName === "cities", cities));
    return app;
};
//# sourceMappingURL=test_ci_succes_Xlsx.js.map