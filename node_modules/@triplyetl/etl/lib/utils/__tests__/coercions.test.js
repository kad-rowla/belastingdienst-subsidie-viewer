...
describe("Coercions", function () {
    describe("With illegal IRIs", function () {
        it("Unknown value to IRI when string", async function () {
            assert.throw(() => unknownValToIri("https://en.wiktionary ^\\.org/wiki/Ρόδος"), /The IRI includes the invalid character/);
        ...
        it("Unknown value to IRI when namedNode", async function () {
            assert.throw(() => unknownValToIri(DataFactory.namedNode("https://en.wiktionary ^\n.org/wiki/Ρόδος")), /The IRI includes the invalid character/);
...
//# sourceMappingURL=coercions.test.js.map