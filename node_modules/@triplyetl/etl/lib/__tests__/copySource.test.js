...
`;
        ...
        await etl.copySource(Source.file("src/__tests__/resources/rdfFiles/family-doe.ttl"), Destination.TriplyDb.rdf(dataset, { defaultGraph: "https://example.com/firstGraph" }));
        const url = "https://www.w3.org/TeamSubmission/turtle/tests/test-30.ttl";
        await etl.copySource(Source.url(url), Destination.TriplyDb.rdf(dataset, { defaultGraph: "https://example.com/secondGraph" }));
        await etl.run();
        const etl2 = new Etl();
        etl2.use(loadRdf(Source.TriplyDb.rdf(dataset, {
...
//# sourceMappingURL=copySource.test.js.map