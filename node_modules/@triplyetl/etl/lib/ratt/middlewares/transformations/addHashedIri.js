import { iriCharacterCleaner, randomHash, hashify, addMwCallSiteToError } from "../../../utils/index.js";
...
export default function (args) {
    return addMwCallSiteToError(add({
        value: (context) => {
            const hash = args.content !== undefined ? hashify(context, args.content) : randomHash();
            return iriCharacterCleaner(context.getIri(args.prefix).value + hash);
        },
        key: args.key,
    }), { sourceFuncName: "_addHashedIri" });
}
//# sourceMappingURL=addHashedIri.js.map