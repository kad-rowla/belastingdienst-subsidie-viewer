 ...
 * ```
 */
declare function addLiteral<R = unknown>(args: ArgumentsWithLanguage): Middleware<R>;
declare function addLiteral<R = unknown>(args: ArgumentsWithDataType): Middleware<R>;
declare function addLiteral<R = unknown>(args: ArgumentsNoDatatypeOrLanguage): Middleware<R>;
...
//# sourceMappingURL=addLiteral.d.ts.map