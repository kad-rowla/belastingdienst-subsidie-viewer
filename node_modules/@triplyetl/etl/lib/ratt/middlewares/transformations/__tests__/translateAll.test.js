...
describe("Transform.translateAll ", () => {
    it("should work on static strings", () => getEtlForTesting([
        translateAll({
            content: str("nl"),
            table,
            nulls: ["Unknown"],
    ...
    it("should work using default values", () => getEtlForTesting([
        translateAll({
            content: str("cz"),
            table,
            default: world,
    ...
    it("should return undefined where content is a null value", () => getEtlForTesting([
        translateAll({
            content: str("Unknown"),
            table,
            nulls: ["Unknown"],
    ...
    it("should throw Error on static strings when value is not in table", () => expect(getEtlForTesting([
        translateAll({
            content: str("??"),
            table,
            nulls: ["Unknown"],
    ...
    ]).run()).to.eventually.rejected);
    it("should work on keys", () => getEtlForTesting([
    ...
    it("should work with functions that return IRI's", () => getEtlForTesting([
    ...
    it("should work with a Vocabulary", async () => {
        const etl = new Etl();
        etl.use(fromJson({ gemeenteNaam: "Heiloo", type: "City" }), translateAll({
...
//# sourceMappingURL=translateAll.test.js.map