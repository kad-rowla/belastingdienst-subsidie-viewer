...
const key = "foo";
describe("replace ", () => {
    it("should throw an Error if key already exists.", () => expect(getEtlForTesting([replace({ key, content: "bar", from: "foo" })]).run())
        .to.eventually.be.rejectedWith(/^Record already contains key 'foo'/)
        .and.be.an.instanceOf(EtlError));
    it("should replace static strings where `to` is undefined", () => getEtlForTesting([
    ...
    it("should replace key strings where `to` is undefined", () => getEtlForTesting([
    ...
    it("should replace static strings where `to` is a static string", () => getEtlForTesting([
    ...
    it("should replace static strings where `from` is a RegExp", () => getEtlForTesting([
