...
const skolemIriChecker = async (ctx, next) => {
...
describe("Transform.addSkolemIri ", () => {
    ...
    it("should fail when URL value does not match standard defined pattern for Skolem IRI's", () => {
        ...
        return expect(promise).to.eventually.be.rejectedWith(/^Skolem IRI must start with '\/.well-known\/genid\/', either provide it or just use a base url./);
    });
});
//# sourceMappingURL=addSkolemIri.test.js.map