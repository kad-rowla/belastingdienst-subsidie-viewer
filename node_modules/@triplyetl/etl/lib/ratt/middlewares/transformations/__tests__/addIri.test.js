...
describe("Transform.iri ", () => {
    ...
    it("should work with the scenario's from https://git.triply.cc/etl/ratt-helpers/-/issues/38", () => {
        ...
        app.use(fromJson({ name: "johndoe", url: "https://example.com/id/person/johndoe" }), 
        ...
        addIri({ prefix, content: str("johndoe"), key: "case4" }), async (ctx, next) => {
            for (let i = 1; i <= 4; i++) {
...
//# sourceMappingURL=addIri.test.js.map