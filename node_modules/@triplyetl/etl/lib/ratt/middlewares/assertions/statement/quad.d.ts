...
import { ObjectLiterals } from "./rdf/quad.js";
/**
 ...
 */
declare const _default: (subject: StaticString | Key | TermGetter<NamedNode>, predicate: StaticString | Key | TermGetter<NamedNode>, object: StaticString | ObjectLiterals | ObjectLiterals[] | TermGetter<NamedNode | Literal>, graphName: StaticString | Key | TermGetter<NamedNode>) => Middleware;
