...
describe("Testing blanknode (as SkolemIri's)", () => {
    it("Should work with skolem iri's", async () => {
        ...
        }), pairs(iri(app.standardPrefixes.id, "$recordId"), [a, sdo.Person], [sdo.givenName, "firstname"], [sdo.familyName, "lastname"]), forEach("nephews", [
            blanknode(iri(app.standardPrefixes.id, "$root.$recordId"), sdo.relatedTo, [a, sdo.Person], [sdo.givenName, "name"]),
...
//# sourceMappingURL=blanknode.test.js.map