...
describe("writing.pairs", () => {
    it("should create 5 triples", () => {
        return getEtlForTesting([
            ...
            pairs(vocab.sdo.Brewery, [vocab.rdf.type, vocab.sdo.FoodEstablishment], [vocab.sdo.name, literal(str("Heineken"), vocab.languageTag("en"))], [vocab.sdo.name, str("Heineken")], [vocab.sdo.name, "objectIri"], [vocab.sdo.name, "naamPrimitive"]),
            async (ctx, next) => {
    ...
    it("should create 5 triples in a graph", () => {
        ...
        return getEtlForTesting([
            ...
            addIri({ content: str("http://ex.com/name"), key: "predicate" }),
            addIri({ content: str("http://ex.com/names/Heineken"), key: "objectIri" }),
            pairs("graph", vocab.sdo.Brewery, [vocab.rdf.type, vocab.sdo.FoodEstablishment], [vocab.sdo.name, literal(str("Heineken"), vocab.languageTag("en"))], [vocab.sdo.name, str("Heineken")], [vocab.sdo.name, "objectIri"], [vocab.sdo.name, "naamPrimitive"]),
            async (ctx, next) => {
