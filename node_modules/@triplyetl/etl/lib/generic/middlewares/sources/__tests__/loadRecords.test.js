...
describe("Reading.loadFromSource ", () => {
    ...
    it("Should accept a Ratt.Source.url", async function () {
        this.timeout(5000);
        const etl = new Etl();
        const content = Source.url("https://gist.githubusercontent.com/mightymax/b5496516a61f8324c3eafa53d29bd162/raw/d1487f0bd1a05424b5cf0988718f03d0fb0c4302/tableMap.json");
        etl.use(fromJson([{ a: 1 }, { a: 1 }, { a: 1 }, { a: 1 }]), loadRecords(fromJson(content, { skipEnrich: true }), "table"), async (ctx, next) => {
...
//# sourceMappingURL=loadRecords.test.js.map