 ...
 */
export default function <T, R = unknown>(key: string, value: T | T[], ...middleware: MiddlewareList): MiddlewareList<R>;
export declare function whenEqualOrNotEqual<T, R = unknown>(key: Key, value: T | T[], negate: boolean, ...middleware: MiddlewareList): MiddlewareList<R>;
//# sourceMappingURL=whenEqual.d.ts.map