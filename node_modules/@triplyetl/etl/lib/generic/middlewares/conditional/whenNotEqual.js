import { whenEqualOrNotEqual } from "./whenEqual.js";
/**
 ...
 * specified values.
 */
export default function (key, value, ...middleware) {
    return whenEqualOrNotEqual(key, value, true, middleware);
}
//# sourceMappingURL=whenNotEqual.js.map