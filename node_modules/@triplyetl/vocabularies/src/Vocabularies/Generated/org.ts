 ...
 * org.ts (2023-08-08T17:30:09.277Z)
 */
import VocabularyBase from '../../Classes/Vocabulary.js'

class Vocabulary extends VocabularyBase<'http://www.w3.org/ns/org#'> {
  /**
   * **[org:Change Event](http://www.w3.org/ns/org#ChangeEvent)**
   *
   ...
   */
  public readonly ChangeEvent = this.toIri().concat('ChangeEvent')

  /**
   * **[org:Formal Organization](http://www.w3.org/ns/org#FormalOrganization)**
   *
   ...
   */
  public readonly FormalOrganization = this.toIri().concat('FormalOrganization')

  /**
   * **[org:head](http://www.w3.org/ns/org#Head)**
   *
   ...
   * @type        class
   */
  public readonly Membership = this.toIri().concat('Membership')
  ...
  /**
   * **[org:Endeavour](http://www.w3.org/ns/org#OrganizationalCollaboration)**
   *
   ...
   */
  public readonly OrganizationalCollaboration = this.toIri().concat('OrganizationalCollaboration')
   ...
   * @parent      org:Organization
   */
  public readonly OrganizationalUnit = this.toIri().concat('OrganizationalUnit')
   ...
   * @type        class
   */
  public readonly Post = this.toIri().concat('Post')
  ...
  /**
   * **[org:Site](http://www.w3.org/ns/org#Site)**
   *
  ...
  /**
   * **[org:based At](http://www.w3.org/ns/org#basedAt)**
   *
   ...
   * @range       org:Site
   */
  public readonly basedAt = this.toIri().concat('basedAt')

  /**
   * **[org:changed by](http://www.w3.org/ns/org#changedBy)**
   *
   ...
   */
  public readonly changedBy = this.toIri().concat('changedBy')

  /**
   * **[org:classification](http://www.w3.org/ns/org#classification)**
   *
  ...
  /**
   * **[org:has member](http://www.w3.org/ns/org#hasMember)**
   *
   ...
   */
  public readonly hasMember = this.toIri().concat('hasMember')

  /**
   * **[org:membership](http://www.w3.org/ns/org#hasMembership)**
   *
   ...
   */
  public readonly hasMembership = this.toIri().concat('hasMembership')

  /**
   * **[org:post](http://www.w3.org/ns/org#hasPost)**
   *
   ...
   * @range       org:Post
   */
  public readonly hasPost = this.toIri().concat('hasPost')

  /**
   * **[org:primary Site](http://www.w3.org/ns/org#hasPrimarySite)**
   *
   ...
   * @range       org:Site
   */
  public readonly hasPrimarySite = this.toIri().concat('hasPrimarySite')

  /**
   * **[org:registered Site](http://www.w3.org/ns/org#hasRegisteredSite)**
   *
   ...
   *
   * @type        property
   * @parent      org:hasPrimarySite
   * @domain      org:FormalOrganization
   * @range       org:Site
   */
  public readonly hasRegisteredSite = this.toIri().concat('hasRegisteredSite')

  /**
   * **[org:has site](http://www.w3.org/ns/org#hasSite)**
   *
   ...
   * @range       org:Site
   */
  public readonly hasSite = this.toIri().concat('hasSite')

  /**
   * **[org:has SubOrganization](http://www.w3.org/ns/org#hasSubOrganization)**
   *
   ...
   */
  public readonly hasSubOrganization = this.toIri().concat('hasSubOrganization')

  /**
   * **[org:has Unit](http://www.w3.org/ns/org#hasUnit)**
   *
  ...
  /**
   * **[org:head of](http://www.w3.org/ns/org#headOf)**
   *
   ...
   * @range       org:Organization
   */
  public readonly headOf = this.toIri().concat('headOf')

  /**
   * **[org:held by](http://www.w3.org/ns/org#heldBy)**
   *
   ...
   * @range       http://xmlns.com/foaf/0.1/Agent
   */
  public readonly heldBy = this.toIri().concat('heldBy')

  /**
   * **[org:holds](http://www.w3.org/ns/org#holds)**
   *
   ...
   * @range       org:Post
   */
  public readonly holds = this.toIri().concat('holds')

  /**
   * **[org:identifier](http://www.w3.org/ns/org#identifier)**
   *
  ...
  /**
   * **[org:linked to](http://www.w3.org/ns/org#linkedTo)**
   *
   ...
   * @range       org:Organization
   */
  public readonly linkedTo = this.toIri().concat('linkedTo')

  /**
   * **[org:location](http://www.w3.org/ns/org#location)**
   *
  ...
  /**
   * **[org:member](http://www.w3.org/ns/org#member)**
   *
  ...
  /**
   * **[org:member During](http://www.w3.org/ns/org#memberDuring)**
   *
   ...
   * @domain      org:Membership
   */
  public readonly memberDuring = this.toIri().concat('memberDuring')

  /**
   * **[org:member of](http://www.w3.org/ns/org#memberOf)**
   *
  ...
  /**
   * **[org:original organization](http://www.w3.org/ns/org#originalOrganization)**
   *
   ...
   *
   * @type        property
   * @parent      http://www.w3.org/ns/prov#used
   * @domain      org:ChangeEvent
   * @range       org:Organization
   */
  public readonly originalOrganization = this.toIri().concat('originalOrganization')

  /**
   * **[org:post in](http://www.w3.org/ns/org#postIn)**
   *
   ...
   * @range       org:Organization
   */
  public readonly postIn = this.toIri().concat('postIn')

  /**
   * **[org:purpose](http://www.w3.org/ns/org#purpose)**
   *
   ...
   * @domain      org:Organization
   */
  public readonly purpose = this.toIri().concat('purpose')

  /**
   * **[org:remuneration](http://www.w3.org/ns/org#remuneration)**
   *
   ...
   * @domain      org:Role
   */
  public readonly remuneration = this.toIri().concat('remuneration')

  /**
   * **[org:reports to](http://www.w3.org/ns/org#reportsTo)**
   *
   ...
   *
   * @type        property
   * @domain      http://xmlns.com/foaf/0.1/Agent or org:Post
   * @range       http://xmlns.com/foaf/0.1/Agent or org:Post
   */
  public readonly reportsTo = this.toIri().concat('reportsTo')

  /**
   * **[org:resulted from](http://www.w3.org/ns/org#resultedFrom)**
   *
   * Indicates an event which resulted in this organization. Inverse of `org:resultingOrganization`.
   *
   * @type        property
   * @parent      http://www.w3.org/ns/prov#wasGeneratedBy
   * @domain      org:Organization
   * @range       org:ChangeEvent
   */
  public readonly resultedFrom = this.toIri().concat('resultedFrom')

  /**
   * **[org:resulted in](http://www.w3.org/ns/org#resultingOrganization)**
   *
   ...
   * @range       org:Organization
   */
  public readonly resultingOrganization = this.toIri().concat('resultingOrganization')
   ...
   *
   * @type        property
   * @domain      org:Membership or org:Post
   * @range       org:Role
   */
  public readonly role = this.toIri().concat('role')

  /**
   * **[org:role (property)](http://www.w3.org/ns/org#roleProperty)**
   *
   ...
   */
  public readonly roleProperty = this.toIri().concat('roleProperty')

  /**
   * **[org:site Address](http://www.w3.org/ns/org#siteAddress)**
   *
   ...
   * @domain      org:Site
   */
  public readonly siteAddress = this.toIri().concat('siteAddress')

  /**
   * **[org:site Of](http://www.w3.org/ns/org#siteOf)**
   *
   ...
   * @range       org:Organization
   */
  public readonly siteOf = this.toIri().concat('siteOf')

  /**
   * **[org:subOrganization of](http://www.w3.org/ns/org#subOrganizationOf)**
   *
   ...
   *
   * @type        property
   * @parent      org:transitiveSubOrganizationOf
   * @domain      org:Organization
   * @range       org:Organization
   */
  public readonly subOrganizationOf = this.toIri().concat('subOrganizationOf')

  /**
   * **[org:transitive sub-organization](http://www.w3.org/ns/org#transitiveSubOrganizationOf)**
   *
   ...
   * @range       org:Organization
   */
  public readonly transitiveSubOrganizationOf = this.toIri().concat('transitiveSubOrganizationOf')

  /**
   * **[org:unit Of](http://www.w3.org/ns/org#unitOf)**
   *
   ...
   *
   * @type        property
   * @parent      org:subOrganizationOf
   * @domain      org:OrganizationalUnit
   * @range       org:FormalOrganization
   */
  public readonly unitOf = this.toIri().concat('unitOf')
}
 ...
 *
 * <figure>
 *   <img src='https://www.w3.org/TR/vocab-org/img/OrgOntology20130502.png'>
 * </figure>
 */
const org = new Vocabulary('http://www.w3.org/ns/org#')
export default org
