...
class Vocabulary extends VocabularyBase<'http://www.w3.org/2003/01/geo/wgs84_pos#'> {
  /**
   ...
   * @type        class
   */
  public readonly SpatialThing = this.toIri().concat('SpatialThing')
   ...
   * @domain      wgs84:SpatialThing
   */
  public readonly lat = this.toIri().concat('lat')
   ...
   * @type        property
   */
  public readonly lat_long = this.toIri().concat('lat_long')
   ...
   * @domain      wgs84:SpatialThing
   */
  public readonly long = this.toIri().concat('long')
}
 ...
 * Version: 1.22.0
 */
const wgs84 = new Vocabulary('http://www.w3.org/2003/01/geo/wgs84_pos#')
