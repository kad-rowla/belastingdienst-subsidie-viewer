...
class Vocabulary extends VocabularyBase<'http://www.w3.org/ns/prov#'> {
  /**
   ...
   */
  public readonly Accept = this.toIri().concat('Accept')
   ...
   */
  public readonly ActivityInfluence = this.toIri().concat('ActivityInfluence')
   ...
   */
  public readonly AgentInfluence = this.toIri().concat('AgentInfluence')
   ...
   */
  public readonly Association = this.toIri().concat('Association')
   ...
   * @parent      prov:AgentInfluence
   */
  public readonly Attribution = this.toIri().concat('Attribution')
   ...
   * @parent      prov:Entity
   */
  public readonly Bundle = this.toIri().concat('Bundle')
   ...
   */
  public readonly Communication = this.toIri().concat('Communication')
   ...
   * @parent      prov:Activity
   */
  public readonly Contribute = this.toIri().concat('Contribute')
   ...
   * @parent      prov:Activity
   */
  public readonly Copyright = this.toIri().concat('Copyright')
   ...
   */
  public readonly Create = this.toIri().concat('Create')
   ...
   * @parent      prov:AgentInfluence
   */
  public readonly Delegation = this.toIri().concat('Delegation')
   ...
   */
  public readonly Derivation = this.toIri().concat('Derivation')
   ...
   * @type        class
   */
  public readonly Dictionary = this.toIri().concat('Dictionary')
   ...
   */
  public readonly DirectQueryService = this.toIri().concat('DirectQueryService')
   ...
   */
  public readonly EmptyCollection = this.toIri().concat('EmptyCollection')
   ...
   */
  public readonly EmptyDictionary = this.toIri().concat('EmptyDictionary')
   ...
   * @parent      prov:EntityInfluence
   */
  public readonly End = this.toIri().concat('End')
   ...
   * @type        class
   */
  public readonly Entity = this.toIri().concat('Entity')
   ...
   * @parent      prov:Influence
   */
  public readonly EntityInfluence = this.toIri().concat('EntityInfluence')
   ...
   * @parent      prov:ActivityInfluence
   */
  public readonly Generation = this.toIri().concat('Generation')
   ...
   * @type        class
   */
  public readonly Influence = this.toIri().concat('Influence')
   ...
   * @type        class
   */
  public readonly InstantaneousEvent = this.toIri().concat('InstantaneousEvent')
   ...
   * @parent      prov:ActivityInfluence
   */
  public readonly Invalidation = this.toIri().concat('Invalidation')
   ...
   */
  public readonly KeyEntityPair = this.toIri().concat('KeyEntityPair')
   ...
   * @parent      prov:Activity
   */
  public readonly Modify = this.toIri().concat('Modify')
   ...
   */
  public readonly PrimarySource = this.toIri().concat('PrimarySource')
   ...
   * @parent      prov:Activity
   */
  public readonly Publish = this.toIri().concat('Publish')
   ...
   */
  public readonly Removal = this.toIri().concat('Removal')
   ...
   * @parent      prov:Activity
   */
  public readonly Replace = this.toIri().concat('Replace')
   ...
   * @parent      prov:Derivation
   */
  public readonly Revision = this.toIri().concat('Revision')
   ...
   * @parent      prov:Activity
   */
  public readonly RightsAssignment = this.toIri().concat('RightsAssignment')
   ...
   * @parent      prov:Role
   */
  public readonly RightsHolder = this.toIri().concat('RightsHolder')
   ...
   * @parent      prov:SoftwareAgent
   */
  public readonly ServiceDescription = this.toIri().concat('ServiceDescription')
   ...
   */
  public readonly SoftwareAgent = this.toIri().concat('SoftwareAgent')
   ...
   * @parent      prov:EntityInfluence
   */
  public readonly Start = this.toIri().concat('Start')
   ...
   * @parent      prov:Activity
   */
  public readonly Submit = this.toIri().concat('Submit')
   ...
   * @parent      prov:EntityInfluence
   */
  public readonly Usage = this.toIri().concat('Usage')
   ...
   * @range       prov:Agent
   */
  public readonly actedOnBehalfOf = this.toIri().concat('actedOnBehalfOf')
   ...
   * @range       prov:Entity
   */
  public readonly alternateOf = this.toIri().concat('alternateOf')
   ...
   */
  public readonly aq = this.toIri().concat('aq')
   ...
   * @range       prov:Bundle
   */
  public readonly asInBundle = this.toIri().concat('asInBundle')
   ...
   * @range       prov:Location
   */
  public readonly atLocation = this.toIri().concat('atLocation')
   ...
   */
  public readonly atTime = this.toIri().concat('atTime')
   ...
   * @type        property
   */
  public readonly component = this.toIri().concat('component')
   ...
   * @parent      http://www.w3.org/2000/01/rdf-schema#seeAlso
   */
  public readonly constraints = this.toIri().concat('constraints')
   ...
   * @type        property
   */
  public readonly definition = this.toIri().concat('definition')
   ...
   */
  public readonly derivedByInsertionFrom = this.toIri().concat('derivedByInsertionFrom')
   ...
   * @range       prov:Dictionary
   */
  public readonly derivedByRemovalFrom = this.toIri().concat('derivedByRemovalFrom')
   ...
   * @type        property
   */
  public readonly describesService = this.toIri().concat('describesService')
   ...
   * @parent      http://www.w3.org/2000/01/rdf-schema#seeAlso
   */
  public readonly dm = this.toIri().concat('dm')
   ...
   * @type        property
   */
  public readonly editorialNote = this.toIri().concat('editorialNote')
   ...
   */
  public readonly editorsDefinition = this.toIri().concat('editorsDefinition')
   ...
   * @range       http://www.w3.org/2001/XMLSchema#dateTime
   */
  public readonly endedAtTime = this.toIri().concat('endedAtTime')
   ...
   * @range       prov:Entity
   */
  public readonly generated = this.toIri().concat('generated')
   ...
   * @range       http://www.w3.org/2001/XMLSchema#dateTime
   */
  public readonly generatedAtTime = this.toIri().concat('generatedAtTime')
   ...
   * @range       prov:Activity
   */
  public readonly hadActivity = this.toIri().concat('hadActivity')
   ...
   */
  public readonly hadDictionaryMember = this.toIri().concat('hadDictionaryMember')
   ...
   */
  public readonly hadGeneration = this.toIri().concat('hadGeneration')
   ...
   * @range       prov:Entity
   */
  public readonly hadMember = this.toIri().concat('hadMember')
   ...
   * @range       prov:Plan
   */
  public readonly hadPlan = this.toIri().concat('hadPlan')
   ...
   * @range       prov:Entity
   */
  public readonly hadPrimarySource = this.toIri().concat('hadPrimarySource')
   ...
   * @range       prov:Role
   */
  public readonly hadRole = this.toIri().concat('hadRole')
   ...
   * @range       prov:Usage
   */
  public readonly hadUsage = this.toIri().concat('hadUsage')
   ...
   * @type        property
   */
  public readonly has_anchor = this.toIri().concat('has_anchor')
   ...
   * @type        property
   */
  public readonly has_provenance = this.toIri().concat('has_provenance')
   ...
   * @type        property
   */
  public readonly has_query_service = this.toIri().concat('has_query_service')
   ...
   * @type        property
   */
  public readonly influenced = this.toIri().concat('influenced')
   ...
   */
  public readonly influencer = this.toIri().concat('influencer')
   ...
   * @range       prov:KeyEntityPair
   */
  public readonly insertedKeyEntityPair = this.toIri().concat('insertedKeyEntityPair')
   ...
   * @range       prov:Entity
   */
  public readonly invalidated = this.toIri().concat('invalidated')
   ...
   * @range       http://www.w3.org/2001/XMLSchema#dateTime
   */
  public readonly invalidatedAtTime = this.toIri().concat('invalidatedAtTime')
   ...
   * @type        property
   */
  public readonly inverse = this.toIri().concat('inverse')
   ...
   * @range       prov:Entity
   */
  public readonly mentionOf = this.toIri().concat('mentionOf')
   ...
   * @parent      http://www.w3.org/2000/01/rdf-schema#seeAlso
   */
  public readonly 'n' = this.toIri().concat('n')
   ...
   * @range       prov:Entity
   */
  public readonly pairEntity = this.toIri().concat('pairEntity')
   ...
   */
  public readonly pairKey = this.toIri().concat('pairKey')
   ...
   * @type        property
   */
  public readonly pingback = this.toIri().concat('pingback')
   ...
   * @type        property
   */
  public readonly provenanceUriTemplate = this.toIri().concat('provenanceUriTemplate')
   ...
   */
  public readonly qualifiedAssociation = this.toIri().concat('qualifiedAssociation')
   ...
   */
  public readonly qualifiedAttribution = this.toIri().concat('qualifiedAttribution')
   ...
   */
  public readonly qualifiedCommunication = this.toIri().concat('qualifiedCommunication')
   ...
   */
  public readonly qualifiedDelegation = this.toIri().concat('qualifiedDelegation')
   ...
   */
  public readonly qualifiedDerivation = this.toIri().concat('qualifiedDerivation')
   ...
   * @range       prov:End
   */
  public readonly qualifiedEnd = this.toIri().concat('qualifiedEnd')
   ...
   * @parent      http://www.w3.org/2000/01/rdf-schema#seeAlso
   */
  public readonly qualifiedForm = this.toIri().concat('qualifiedForm')
   ...
   * @range       prov:Generation
   */
  public readonly qualifiedGeneration = this.toIri().concat('qualifiedGeneration')
   ...
   */
  public readonly qualifiedInfluence = this.toIri().concat('qualifiedInfluence')
   ...
   */
  public readonly qualifiedInsertion = this.toIri().concat('qualifiedInsertion')
   ...
   */
  public readonly qualifiedInvalidation = this.toIri().concat('qualifiedInvalidation')
   ...
   */
  public readonly qualifiedPrimarySource = this.toIri().concat('qualifiedPrimarySource')
   ...
   */
  public readonly qualifiedQuotation = this.toIri().concat('qualifiedQuotation')
   ...
   * @range       prov:Removal
   */
  public readonly qualifiedRemoval = this.toIri().concat('qualifiedRemoval')
   ...
   * @range       prov:Revision
   */
  public readonly qualifiedRevision = this.toIri().concat('qualifiedRevision')
   ...
   * @range       prov:Start
   */
  public readonly qualifiedStart = this.toIri().concat('qualifiedStart')
   ...
   * @range       prov:Usage
   */
  public readonly qualifiedUsage = this.toIri().concat('qualifiedUsage')
   ...
   * @range       http://www.w3.org/2000/01/rdf-schema#Literal
   */
  public readonly removedKey = this.toIri().concat('removedKey')
   ...
   * @parent      http://www.w3.org/2000/01/rdf-schema#seeAlso
   */
  public readonly sharesDefinitionWith = this.toIri().concat('sharesDefinitionWith')
   ...
   * @range       prov:Entity
   */
  public readonly specializationOf = this.toIri().concat('specializationOf')
   ...
   * @range       http://www.w3.org/2001/XMLSchema#dateTime
   */
  public readonly startedAtTime = this.toIri().concat('startedAtTime')
   ...
   * @type        property
   */
  public readonly todo = this.toIri().concat('todo')
   ...
   * @parent      http://www.w3.org/2000/01/rdf-schema#seeAlso
   */
  public readonly unqualifiedForm = this.toIri().concat('unqualifiedForm')
   ...
   * @range       prov:Entity
   */
  public readonly used = this.toIri().concat('used')
   ...
   * @range       prov:Agent
   */
  public readonly wasAssociatedWith = this.toIri().concat('wasAssociatedWith')
   ...
   * @range       prov:Agent
   */
  public readonly wasAttributedTo = this.toIri().concat('wasAttributedTo')
   ...
   * @range       prov:Entity
   */
  public readonly wasDerivedFrom = this.toIri().concat('wasDerivedFrom')
   ...
   * @range       prov:Entity
   */
  public readonly wasEndedBy = this.toIri().concat('wasEndedBy')
   ...
   * @range       prov:Activity
   */
  public readonly wasGeneratedBy = this.toIri().concat('wasGeneratedBy')
   ...
   */
  public readonly wasInfluencedBy = this.toIri().concat('wasInfluencedBy')
   ...
   * @range       prov:Activity
   */
  public readonly wasInformedBy = this.toIri().concat('wasInformedBy')
   ...
   * @range       prov:Activity
   */
  public readonly wasInvalidatedBy = this.toIri().concat('wasInvalidatedBy')
   ...
   * @range       prov:Entity
   */
  public readonly wasQuotedFrom = this.toIri().concat('wasQuotedFrom')
   ...
   * @range       prov:Entity
   */
  public readonly wasRevisionOf = this.toIri().concat('wasRevisionOf')
   ...
   * @range       prov:Entity
   */
  public readonly wasStartedBy = this.toIri().concat('wasStartedBy')
}
 ...
 */
const prov = new Vocabulary('http://www.w3.org/ns/prov#')
export default prov
