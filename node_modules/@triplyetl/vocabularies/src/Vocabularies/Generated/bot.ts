...
class Vocabulary extends VocabularyBase<'https://w3id.org/bot#'> {
  /**
   ...
   */
  public readonly adjacentElement = this.toIri().concat('adjacentElement')
   ...
   * @range       bot:Zone
   */
  public readonly adjacentZone = this.toIri().concat('adjacentZone')
   ...
   * @type        property
   */
  public readonly aggregates = this.toIri().concat('aggregates')
   ...
   * @parent      bot:hasElement
   */
  public readonly containsElement = this.toIri().concat('containsElement')
   ...
   * @range       bot:Zone
   */
  public readonly containsZone = this.toIri().concat('containsZone')
   ...
   * @type        property
   */
  public readonly has3DModel = this.toIri().concat('has3DModel')
   ...
   * @range       bot:Building
   */
  public readonly hasBuilding = this.toIri().concat('hasBuilding')
   ...
   * @range       bot:Element
   */
  public readonly hasElement = this.toIri().concat('hasElement')
   ...
   * @type        property
   */
  public readonly hasSimple3DModel = this.toIri().concat('hasSimple3DModel')
   ...
   * @range       bot:Space
   */
  public readonly hasSpace = this.toIri().concat('hasSpace')
   ...
   * @range       bot:Storey
   */
  public readonly hasStorey = this.toIri().concat('hasStorey')
   ...
   * @range       bot:Element
   */
  public readonly hasSubElement = this.toIri().concat('hasSubElement')
   ...
   * @domain      bot:Site
   */
  public readonly hasZeroPoint = this.toIri().concat('hasZeroPoint')
   ...
   * @range       bot:Element
   */
  public readonly hostsElement = this.toIri().concat('hostsElement')
   ...
   */
  public readonly interfaceOf = this.toIri().concat('interfaceOf')
   ...
   * @parent      bot:hasElement
   */
  public readonly intersectingElement = this.toIri().concat('intersectingElement')
   ...
   * @range       bot:Zone
   */
  public readonly intersectsZone = this.toIri().concat('intersectsZone')
}
 ...
 */
const bot = new Vocabulary('https://w3id.org/bot#')
export default bot
