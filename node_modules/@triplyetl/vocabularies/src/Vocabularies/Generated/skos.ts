...
class Vocabulary extends VocabularyBase<'http://www.w3.org/2004/02/skos/core#'> {
  /**
   ...
   * @type        class
   */
  public readonly ConceptScheme = this.toIri().concat('ConceptScheme')
   ...
   */
  public readonly OrderedCollection = this.toIri().concat('OrderedCollection')
   ...
   */
  public readonly altLabel = this.toIri().concat('altLabel')
   ...
   * @parent      skos:broader
   */
  public readonly broadMatch = this.toIri().concat('broadMatch')
   ...
   */
  public readonly broader = this.toIri().concat('broader')
   ...
   */
  public readonly broaderTransitive = this.toIri().concat('broaderTransitive')
   ...
   * @parent      skos:note
   */
  public readonly changeNote = this.toIri().concat('changeNote')
   ...
   */
  public readonly closeMatch = this.toIri().concat('closeMatch')
   ...
   * @range       skos:Concept
   */
  public readonly hasTopConcept = this.toIri().concat('hasTopConcept')
   ...
   * @parent      http://www.w3.org/2000/01/rdf-schema#label
   */
  public readonly hiddenLabel = this.toIri().concat('hiddenLabel')
   ...
   * @parent      skos:note
   */
  public readonly historyNote = this.toIri().concat('historyNote')
   ...
   */
  public readonly inScheme = this.toIri().concat('inScheme')
   ...
   * @parent      skos:semanticRelation
   */
  public readonly mappingRelation = this.toIri().concat('mappingRelation')
   ...
   */
  public readonly memberList = this.toIri().concat('memberList')
   ...
   * @parent      skos:mappingRelation
   */
  public readonly narrowMatch = this.toIri().concat('narrowMatch')
   ...
   */
  public readonly narrower = this.toIri().concat('narrower')
   ...
   * @parent      skos:semanticRelation
   */
  public readonly narrowerTransitive = this.toIri().concat('narrowerTransitive')
   ...
   * @type        property
   */
  public readonly notation = this.toIri().concat('notation')
   ...
   * @type        property
   */
  public readonly note = this.toIri().concat('note')
   ...
   * @parent      http://www.w3.org/2000/01/rdf-schema#label
   */
  public readonly prefLabel = this.toIri().concat('prefLabel')
   ...
   * @parent      skos:semanticRelation
   */
  public readonly related = this.toIri().concat('related')
   ...
   * @parent      skos:mappingRelation
   */
  public readonly relatedMatch = this.toIri().concat('relatedMatch')
   ...
   * @parent      skos:note
   */
  public readonly scopeNote = this.toIri().concat('scopeNote')
   ...
   * @range       skos:Concept
   */
  public readonly semanticRelation = this.toIri().concat('semanticRelation')
   ...
   * @range       skos:ConceptScheme
   */
  public readonly topConceptOf = this.toIri().concat('topConceptOf')
}
