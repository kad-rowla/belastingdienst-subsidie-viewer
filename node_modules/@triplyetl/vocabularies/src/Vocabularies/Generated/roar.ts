...
class Vocabulary extends VocabularyBase<'https://w3id.org/roar#'> {
  /**
   ...
   */
  public readonly LocationObservation = this.toIri().concat('LocationObservation')
   ...
   */
  public readonly LocationReconstruction = this.toIri().concat('LocationReconstruction')
   ...
   * @parent      roar:Observation
   */
  public readonly PersonObservation = this.toIri().concat('PersonObservation')
   ...
   * @parent      roar:Person
   */
  public readonly PersonReconstruction = this.toIri().concat('PersonReconstruction')
   ...
   * @parent      http://www.w3.org/ns/prov#Entity
   */
  public readonly Reconstruction = this.toIri().concat('Reconstruction')
   ...
   * @range       roar:Document
   */
  public readonly documentedIn = this.toIri().concat('documentedIn')
   ...
   * @range       roar:Person
   */
  public readonly hasPerson = this.toIri().concat('hasPerson')
   ...
   * @range       roar:Entity
   */
  public readonly hasRelation = this.toIri().concat('hasRelation')
   ...
   */
  public readonly locationInDocument = this.toIri().concat('locationInDocument')
   ...
   * @domain      roar:Observation
   */
  public readonly onScan = this.toIri().concat('onScan')
   ...
   * @parent      http://www.w3.org/2002/07/owl#topDataProperty
   */
  public readonly relationType = this.toIri().concat('relationType')
 ...
 */
const roar = new Vocabulary('https://w3id.org/roar#')
export default roar
