...
class Vocabulary extends VocabularyBase<'https://w3id.org/pnv#'> {
  /**
   ...
   * @type        class
   */
  public readonly PersonName = this.toIri().concat('PersonName')
   ...
   */
  public readonly baseSurname = this.toIri().concat('baseSurname')
   ...
   * @range       http://www.w3.org/2001/XMLSchema#string
   */
  public readonly givenNameSuffix = this.toIri().concat('givenNameSuffix')
   ...
   */
  public readonly hasName = this.toIri().concat('hasName')
   ...
   * @range       http://www.w3.org/2001/XMLSchema#string
   */
  public readonly infix = this.toIri().concat('infix')
   ...
   * @range       http://www.w3.org/2001/XMLSchema#string
   */
  public readonly infixTitle = this.toIri().concat('infixTitle')
   ...
   * @range       http://www.w3.org/2001/XMLSchema#string
   */
  public readonly initials = this.toIri().concat('initials')
   ...
   * @range       http://www.w3.org/2001/XMLSchema#string
   */
  public readonly literalName = this.toIri().concat('literalName')
   ...
   * @domain      pnv:PersonName
   */
  public readonly nameSpecification = this.toIri().concat('nameSpecification')
   ...
   * @range       http://www.w3.org/2001/XMLSchema#string
   */
  public readonly patronym = this.toIri().concat('patronym')
   ...
   * @range       http://www.w3.org/2001/XMLSchema#string
   */
  public readonly suffix = this.toIri().concat('suffix')
   ...
   * @range       http://www.w3.org/2001/XMLSchema#string
   */
  public readonly surnamePrefix = this.toIri().concat('surnamePrefix')
   ...
   * @range       http://www.w3.org/2001/XMLSchema#string
   */
  public readonly trailingPatronym = this.toIri().concat('trailingPatronym')
}
