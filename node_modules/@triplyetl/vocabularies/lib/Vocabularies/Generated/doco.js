...
class Vocabulary extends VocabularyBase {
     ...
     */
    Afterword = this.toIri().concat('Afterword');
    /**
     ...
     */
    Appendix = this.toIri().concat('Appendix');
    /**
     ...
     */
    BackMatter = this.toIri().concat('BackMatter');
    /**
     ...
     */
    BibliographicReferenceList = this.toIri().concat('BibliographicReferenceList');
    /**
     ...
     */
    Bibliography = this.toIri().concat('Bibliography');
    /**
     ...
     */
    BlockQuotation = this.toIri().concat('BlockQuotation');
    /**
     ...
     */
    BodyMatter = this.toIri().concat('BodyMatter');
    /**
     ...
     */
    CaptionedBox = this.toIri().concat('CaptionedBox');
    /**
     ...
     */
    ChapterLabel = this.toIri().concat('ChapterLabel');
    /**
     ...
     */
    ChapterSubtitle = this.toIri().concat('ChapterSubtitle');
    /**
     ...
     * @parent      doco:Title
     */
    ChapterTitle = this.toIri().concat('ChapterTitle');
    /**
     ...
     */
    Colophon = this.toIri().concat('Colophon');
    /**
     ...
     */
    ComplexRunInQuotation = this.toIri().concat('ComplexRunInQuotation');
    /**
     ...
     */
    FigureBox = this.toIri().concat('FigureBox');
    /**
     ...
     * @parent      http://purl.org/spar/deo/DiscourseElement
     */
    Footnote = this.toIri().concat('Footnote');
    /**
     ...
     */
    Foreword = this.toIri().concat('Foreword');
    /**
     ...
     * @parent      http://purl.org/spar/deo/DiscourseElement
     */
    Formula = this.toIri().concat('Formula');
    /**
     ...
     */
    FormulaBox = this.toIri().concat('FormulaBox');
    /**
     ...
     */
    FrontMatter = this.toIri().concat('FrontMatter');
    /**
     ...
     */
    Glossary = this.toIri().concat('Glossary');
    /**
     ...
     * @parent      doco:List
     */
    ListOfAgents = this.toIri().concat('ListOfAgents');
    /**
     ...
     */
    ListOfAuthors = this.toIri().concat('ListOfAuthors');
    /**
     ...
     * @parent      doco:ListOfAgents
     */
    ListOfContributors = this.toIri().concat('ListOfContributors');
    /**
     ...
     */
    ListOfFigures = this.toIri().concat('ListOfFigures');
    /**
     ...
     * @parent      doco:ListOfAgents
     */
    ListOfOrganizations = this.toIri().concat('ListOfOrganizations');
    /**
     ...
     */
    ListOfReferences = this.toIri().concat('ListOfReferences');
    /**
     ...
     */
    ListOfTables = this.toIri().concat('ListOfTables');
    /**
     ...
     */
    Paragraph = this.toIri().concat('Paragraph');
    /**
     ...
     */
    Preface = this.toIri().concat('Preface');
    /**
     ...
     */
    Section = this.toIri().concat('Section');
    /**
     ...
     * @parent      doco:Label
     */
    SectionLabel = this.toIri().concat('SectionLabel');
    /**
     ...
     * @parent      doco:Subtitle
     */
    SectionSubtitle = this.toIri().concat('SectionSubtitle');
    /**
     ...
     * @parent      doco:Title
     */
    SectionTitle = this.toIri().concat('SectionTitle');
    /**
     ...
     * @parent      http://purl.org/spar/deo/DiscourseElement
     */
    Sentence = this.toIri().concat('Sentence');
    /**
     ...
     */
    SimpleRunInQuotation = this.toIri().concat('SimpleRunInQuotation');
    /**
     ...
     */
    Stanza = this.toIri().concat('Stanza');
    /**
     ...
     * @parent      http://purl.org/spar/deo/DiscourseElement
     */
    Subtitle = this.toIri().concat('Subtitle');
    /**
     ...
     */
    TableBox = this.toIri().concat('TableBox');
    /**
     ...
     */
    TableLabel = this.toIri().concat('TableLabel');
    /**
     ...
     * @parent      http://purl.org/spar/deo/DiscourseElement
     */
    TextBox = this.toIri().concat('TextBox');
    /**
     ...
     * @parent      http://www.essepuntato.it/2008/12/pattern#Inline
     */
    TextChunk = this.toIri().concat('TextChunk');
    /**
 ...
 * Version: 1.3.0
 */
const doco = new Vocabulary('http://purl.org/spar/doco/');
export default doco;
//# sourceMappingURL=doco.js.map