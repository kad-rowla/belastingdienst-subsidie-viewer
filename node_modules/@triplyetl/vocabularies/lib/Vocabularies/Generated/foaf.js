...
class Vocabulary extends VocabularyBase {
     ...
     * @type        class
     */
    Document = this.toIri().concat('Document');
    /**
     ...
     * @type        class
     */
    LabelProperty = this.toIri().concat('LabelProperty');
    /**
     ...
     */
    OnlineAccount = this.toIri().concat('OnlineAccount');
    /**
     ...
     */
    OnlineChatAccount = this.toIri().concat('OnlineChatAccount');
    /**
     ...
     * @parent      foaf:OnlineAccount
     */
    OnlineEcommerceAccount = this.toIri().concat('OnlineEcommerceAccount');
    /**
     ...
     * @parent      foaf:OnlineAccount
     */
    OnlineGamingAccount = this.toIri().concat('OnlineGamingAccount');
    /**
     ...
     * @parent      foaf:Document
     */
    PersonalProfileDocument = this.toIri().concat('PersonalProfileDocument');
    /**
     ...
     * @type        class
     */
    Project = this.toIri().concat('Project');
    /**
     ...
     */
    account = this.toIri().concat('account');
    /**
     ...
     */
    accountName = this.toIri().concat('accountName');
    /**
     ...
     * @range       foaf:Document
     */
    accountServiceHomepage = this.toIri().concat('accountServiceHomepage');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    aimChatID = this.toIri().concat('aimChatID');
    /**
     ...
     */
    based_near = this.toIri().concat('based_near');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    birthday = this.toIri().concat('birthday');
    /**
     ...
     */
    currentProject = this.toIri().concat('currentProject');
    /**
     ...
     * @range       foaf:Image
     */
    depiction = this.toIri().concat('depiction');
    /**
     ...
     * @range       http://www.w3.org/2002/07/owl#Thing
     */
    depicts = this.toIri().concat('depicts');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    dnaChecksum = this.toIri().concat('dnaChecksum');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    familyName = this.toIri().concat('familyName');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    family_name = this.toIri().concat('family_name');
    /**
     ...
     * @range       http://www.w3.org/2002/07/owl#Thing
     */
    fundedBy = this.toIri().concat('fundedBy');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    geekcode = this.toIri().concat('geekcode');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    gender = this.toIri().concat('gender');
    /**
     ...
     * @range       foaf:OnlineAccount
     */
    holdsAccount = this.toIri().concat('holdsAccount');
    /**
     ...
     * @range       foaf:Document
     */
    homepage = this.toIri().concat('homepage');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    icqChatID = this.toIri().concat('icqChatID');
    /**
     ...
     * @range       foaf:Document
     */
    interest = this.toIri().concat('interest');
    /**
     ...
     * @range       foaf:Document
     */
    isPrimaryTopicOf = this.toIri().concat('isPrimaryTopicOf');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    jabberID = this.toIri().concat('jabberID');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    lastName = this.toIri().concat('lastName');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    mbox_sha1sum = this.toIri().concat('mbox_sha1sum');
    /**
     ...
     * @type        property
     */
    membershipClass = this.toIri().concat('membershipClass');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    msnChatID = this.toIri().concat('msnChatID');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    myersBriggs = this.toIri().concat('myersBriggs');
    /**
     ...
     * @range       foaf:Document
     */
    openid = this.toIri().concat('openid');
    /**
     ...
     * @range       http://www.w3.org/2002/07/owl#Thing
     */
    pastProject = this.toIri().concat('pastProject');
    /**
     ...
     * @range       http://www.w3.org/2002/07/owl#Thing
     */
    primaryTopic = this.toIri().concat('primaryTopic');
    /**
     ...
     * @range       foaf:Document
     */
    publications = this.toIri().concat('publications');
    /**
     ...
     * @range       foaf:Document
     */
    schoolHomepage = this.toIri().concat('schoolHomepage');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    skypeID = this.toIri().concat('skypeID');
    /**
     ...
     * @range       foaf:Image
     */
    thumbnail = this.toIri().concat('thumbnail');
    /**
     ...
     * @range       foaf:Document
     */
    tipjar = this.toIri().concat('tipjar');
    /**
     ...
     * @range       http://www.w3.org/2002/07/owl#Thing
     */
    topic_interest = this.toIri().concat('topic_interest');
    /**
     ...
     * @range       foaf:Document
     */
    weblog = this.toIri().concat('weblog');
    /**
     ...
     * @range       foaf:Document
     */
    workInfoHomepage = this.toIri().concat('workInfoHomepage');
    /**
     ...
     * @range       foaf:Document
     */
    workplaceHomepage = this.toIri().concat('workplaceHomepage');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    yahooChatID = this.toIri().concat('yahooChatID');
}
/**
