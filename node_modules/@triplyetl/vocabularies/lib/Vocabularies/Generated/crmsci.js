...
class Vocabulary extends VocabularyBase {
     ...
     */
    O10_assigned_dimension = this.toIri().concat('O10_assigned_dimension');
    /**
     ...
     */
    O10i_dimension_was_assigned_by = this.toIri().concat('O10i_dimension_was_assigned_by');
    /**
     ...
     */
    O11_described = this.toIri().concat('O11_described');
    /**
     ...
     * @range       crmsci:S6_Data_Evaluation
     */
    O11i_was_described_by = this.toIri().concat('O11i_was_described_by');
    /**
     ...
     * @range       http://www.cidoc-crm.org/cidoc-crm/E54_Dimension
     */
    O12_has_dimension = this.toIri().concat('O12_has_dimension');
    /**
     ...
     * @range       crmsci:S15_Observable_Entity
     */
    O12i_is_dimension_of = this.toIri().concat('O12i_is_dimension_of');
    /**
     ...
     */
    O13_triggered = this.toIri().concat('O13_triggered');
    /**
     ...
     * @range       http://www.cidoc-crm.org/cidoc-crm/E5_Event
     */
    O13i_was_triggered_by = this.toIri().concat('O13i_was_triggered_by');
    /**
     ...
     */
    O15_occupied = this.toIri().concat('O15_occupied');
    /**
     ...
     */
    O15i_was_occupied_by = this.toIri().concat('O15i_was_occupied_by');
    /**
     ...
     */
    O16_observed_value = this.toIri().concat('O16_observed_value');
    /**
     ...
     */
    O16i_value_was_observed_by = this.toIri().concat('O16i_value_was_observed_by');
    /**
     ...
     */
    O17_generated = this.toIri().concat('O17_generated');
    /**
     ...
     */
    O17i_was_generated_by = this.toIri().concat('O17i_was_generated_by');
    /**
     ...
     * @range       http://www.cidoc-crm.org/cidoc-crm/E18_Physical_Thing
     */
    O18_altered = this.toIri().concat('O18_altered');
    /**
     ...
     */
    O18i_was_altered_by = this.toIri().concat('O18i_was_altered_by');
    /**
     ...
     * @range       http://www.cidoc-crm.org/cidoc-crm/E18_Physical_Thing
     */
    O19_encountered_object = this.toIri().concat('O19_encountered_object');
    /**
     ...
     */
    O19i_was_object_encountered_through = this.toIri().concat('O19i_was_object_encountered_through');
    /**
     ...
     * @range       crmsci:S10_Material_Substantial
     */
    O1_diminished = this.toIri().concat('O1_diminished');
    /**
     ...
     */
    O1i_was_diminished_by = this.toIri().concat('O1i_was_diminished_by');
    /**
     ...
     */
    O20_sampled_from_type_of_part = this.toIri().concat('O20_sampled_from_type_of_part');
    /**
     ...
     */
    O20i_type_of_part_was_sampled_by = this.toIri().concat('O20i_type_of_part_was_sampled_by');
    /**
     ...
     * @range       http://www.cidoc-crm.org/cidoc-crm/E53_Place
     */
    O21_encountered_at = this.toIri().concat('O21_encountered_at');
    /**
     ...
     * @range       crmsci:S19_Encounter_Event
     */
    O21i_witnessed_encounter = this.toIri().concat('O21i_witnessed_encounter');
    /**
     ...
     */
    O23_is_defined_by = this.toIri().concat('O23_is_defined_by');
    /**
     ...
     */
    O23i_defines = this.toIri().concat('O23i_defines');
    /**
     ...
     * @range       crmsci:S15_Observable_Entity
     */
    O24_measured = this.toIri().concat('O24_measured');
    /**
     ...
     */
    O24i_was_measured_by = this.toIri().concat('O24i_was_measured_by');
    /**
     ...
     * @range       crmsci:S10_Material_Substantial
     */
    O25_contains = this.toIri().concat('O25_contains');
    /**
     ...
     * @range       crmsci:S10_Material_Substantial
     */
    O25i_is_contained_in = this.toIri().concat('O25i_is_contained_in');
    /**
     ...
     */
    O27_split = this.toIri().concat('O27_split');
    /**
     ...
     */
    O27i_was_source_for = this.toIri().concat('O27i_was_source_for');
    /**
     ...
     * @range       http://www.cidoc-crm.org/cidoc-crm/E55_Type
     */
    O28_is_conceptually_greater_than = this.toIri().concat('O28_is_conceptually_greater_than');
    /**
     ...
     * @range       http://www.cidoc-crm.org/cidoc-crm/E55_Type
     */
    O28i_is_conceptually_less_than = this.toIri().concat('O28i_is_conceptually_less_than');
    /**
     ...
     * @range       crmsci:S13_Sample
     */
    'O29_removed_sub-sample' = this.toIri().concat('O29_removed_sub-sample');
    /**
     ...
     * @range       crmsci:S24_Sample_Splitting
     */
    'O29i_was_sub-sample_removed_by' = this.toIri().concat('O29i_was_sub-sample_removed_by');
    /**
     ...
     */
    O2_removed = this.toIri().concat('O2_removed');
    /**
     ...
     * @range       crmsci:S1_Matter_Removal
     */
    O2i_was_removed_by = this.toIri().concat('O2i_was_removed_by');
    /**
     ...
     */
    O30_determined_position = this.toIri().concat('O30_determined_position');
    /**
     ...
     */
    'O31_has_validity_time-span' = this.toIri().concat('O31_has_validity_time-span');
    /**
     ...
     */
    'O31i_is_time-span_validity_for' = this.toIri().concat('O31i_is_time-span_validity_for');
    /**
     ...
     * @range       crmsci:S15_Observable_Entity
     */
    O32_determined_position_of = this.toIri().concat('O32_determined_position_of');
    /**
     ...
     * @range       crmsci:S23_Position_Determination
     */
    O32i_was_located_by = this.toIri().concat('O32i_was_located_by');
    /**
     ...
     * @range       crmsci:S10_Material_Substantial
     */
    O3_sampled_from = this.toIri().concat('O3_sampled_from');
    /**
     ...
     * @range       crmsci:S2_Sample_Taking
     */
    O3i_was_sample_by = this.toIri().concat('O3i_was_sample_by');
    /**
     ...
     * @range       http://www.cidoc-crm.org/cidoc-crm/E53_Place
     */
    O4_sampled_at = this.toIri().concat('O4_sampled_at');
    /**
     ...
     * @range       crmsci:S2_Sample_Taking
     */
    O4i_was_sampling_location_of = this.toIri().concat('O4i_was_sampling_location_of');
    /**
     ...
     * @range       crmsci:S13_Sample
     */
    O5_removed = this.toIri().concat('O5_removed');
    /**
     ...
     * @range       crmsci:S2_Sample_Taking
     */
    O5i_was_removed_by = this.toIri().concat('O5i_was_removed_by');
    /**
     ...
     */
    O6_is_former_or_current_part_of = this.toIri().concat('O6_is_former_or_current_part_of');
    /**
     ...
     */
    O6i_has_former_or_current_part = this.toIri().concat('O6i_has_former_or_current_part');
    /**
     ...
     * @range       crmsci:S10_Material_Substantial
     */
    O7_confines = this.toIri().concat('O7_confines');
    /**
     ...
     */
    O7i_is_confined_by = this.toIri().concat('O7i_is_confined_by');
    /**
     ...
     * @range       crmsci:S15_Observable_Entity
     */
    O8_observed = this.toIri().concat('O8_observed');
    /**
     ...
     * @range       crmsci:S4_Observation
     */
    O8i_was_observed_by = this.toIri().concat('O8i_was_observed_by');
    /**
     ...
     */
    O9_observed_property_type = this.toIri().concat('O9_observed_property_type');
    /**
     ...
     * @range       crmsci:S4_Observation
     */
    O9i_property_type_was_observed_by = this.toIri().concat('O9i_property_type_was_observed_by');
    /**
     ...
     */
    S10_Material_Substantial = this.toIri().concat('S10_Material_Substantial');
    /**
     ...
     */
    S11_Amount_of_Matter = this.toIri().concat('S11_Amount_of_Matter');
    /**
     ...
     */
    S12_Amount_of_Fluid = this.toIri().concat('S12_Amount_of_Fluid');
    /**
     ...
     * @parent      crmsci:S11_Amount_of_Matter
     */
    S13_Sample = this.toIri().concat('S13_Sample');
    /**
     ...
     * @parent      crmsci:S10_Material_Substantial
     */
    S14_Fluid_Body = this.toIri().concat('S14_Fluid_Body');
    /**
     ...
     */
    S15_Observable_Entity = this.toIri().concat('S15_Observable_Entity');
    /**
     ...
     */
    S17_Physical_Genesis = this.toIri().concat('S17_Physical_Genesis');
    /**
     ...
     */
    S18_Alteration = this.toIri().concat('S18_Alteration');
    /**
     ...
     */
    S19_Encounter_Event = this.toIri().concat('S19_Encounter_Event');
    /**
     ...
     */
    S1_Matter_Removal = this.toIri().concat('S1_Matter_Removal');
    /**
     ...
     */
    S20_Rigid_Physical_Feature = this.toIri().concat('S20_Rigid_Physical_Feature');
    /**
     ...
     * @parent      crmsci:S4_Observation
     */
    S21_Measurement = this.toIri().concat('S21_Measurement');
    /**
     ...
     */
    S22_Segment_of_Matter = this.toIri().concat('S22_Segment_of_Matter');
    /**
     ...
     * @parent      crmsci:S4_Observation
     */
    S23_Position_Determination = this.toIri().concat('S23_Position_Determination');
    /**
     ...
     */
    S24_Sample_Splitting = this.toIri().concat('S24_Sample_Splitting');
    /**
     ...
     */
    S2_Sample_Taking = this.toIri().concat('S2_Sample_Taking');
    /**
     ...
     */
    S3_Measurement_by_Sampling = this.toIri().concat('S3_Measurement_by_Sampling');
    /**
     ...
     */
    S4_Observation = this.toIri().concat('S4_Observation');
    /**
     ...
     * @parent      http://www.cidoc-crm.org/cidoc-crm/E13_Attribute_Assignment
     */
    S5_Inference_Making = this.toIri().concat('S5_Inference_Making');
    /**
     ...
     */
    S6_Data_Evaluation = this.toIri().concat('S6_Data_Evaluation');
    /**
     ...
     * @parent      crmsci:S5_Inference_Making
     */
    S7_Simulation_or_Prediction = this.toIri().concat('S7_Simulation_or_Prediction');
    /**
     ...
     * @parent      crmsci:S5_Inference_Making
     */
    S8_Categorical_Hypothesis_Building = this.toIri().concat('S8_Categorical_Hypothesis_Building');
    /**
     ...
     */
    S9_Property_Type = this.toIri().concat('S9_Property_Type');
}
/**
...
//# sourceMappingURL=crmsci.js.map