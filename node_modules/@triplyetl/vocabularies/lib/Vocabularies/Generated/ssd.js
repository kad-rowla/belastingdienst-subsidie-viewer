...
class Vocabulary extends VocabularyBase {
     ...
     * @type        instance
     */
    BasicFederatedQuery = this.toIri().concat('BasicFederatedQuery');
    /**
     ...
     * @type        instance
     */
    DereferencesURIs = this.toIri().concat('DereferencesURIs');
    /**
     ...
     * @type        instance
     */
    EmptyGraphs = this.toIri().concat('EmptyGraphs');
    /**
     ...
     * @parent      ssd:Feature
     */
    EntailmentProfile = this.toIri().concat('EntailmentProfile');
    /**
     ...
     * @parent      ssd:Feature
     */
    EntailmentRegime = this.toIri().concat('EntailmentRegime');
    /**
     ...
     * @type        class
     */
    Feature = this.toIri().concat('Feature');
    /**
     ...
     * @type        class
     */
    GraphCollection = this.toIri().concat('GraphCollection');
    /**
     ...
     * @type        class
     */
    NamedGraph = this.toIri().concat('NamedGraph');
    /**
     ...
     * @type        instance
     */
    RequiresDataset = this.toIri().concat('RequiresDataset');
    /**
     ...
     * @type        instance
     */
    SPARQL10Query = this.toIri().concat('SPARQL10Query');
    /**
     ...
     * @type        instance
     */
    SPARQL11Query = this.toIri().concat('SPARQL11Query');
    /**
     ...
     * @type        instance
     */
    SPARQL11Update = this.toIri().concat('SPARQL11Update');
    /**
     ...
     * @type        instance
     */
    UnionDefaultGraph = this.toIri().concat('UnionDefaultGraph');
    /**
     ...
     */
    availableGraphs = this.toIri().concat('availableGraphs');
    /**
     ...
     * @range       ssd:Dataset
     */
    defaultDataset = this.toIri().concat('defaultDataset');
    /**
     ...
     */
    defaultEntailmentRegime = this.toIri().concat('defaultEntailmentRegime');
    /**
     ...
     * @range       ssd:Graph
     */
    defaultGraph = this.toIri().concat('defaultGraph');
    /**
     ...
     */
    defaultSupportedEntailmentProfile = this.toIri().concat('defaultSupportedEntailmentProfile');
    /**
     ...
     * @domain      ssd:Service
     */
    endpoint = this.toIri().concat('endpoint');
    /**
     * **[ssd:entailment regime](http://www.w3.org/ns/sparql-service-description#entailmentRegime)**
     *
     ...
     * @range       ssd:Aggregate
     */
    extensionAggregate = this.toIri().concat('extensionAggregate');
    /**
     ...
     * @range       ssd:Function
     */
    extensionFunction = this.toIri().concat('extensionFunction');
    /**
     * **[ssd:feature](http://www.w3.org/ns/sparql-service-description#feature)**
     *
     ...
     */
    inputFormat = this.toIri().concat('inputFormat');
    /**
     ...
     * @range       ssd:Feature
     */
    languageExtension = this.toIri().concat('languageExtension');
    /**
     ...
     * @range       ssd:Feature
     */
    propertyFeature = this.toIri().concat('propertyFeature');
    /**
     ...
     * @range       http://www.w3.org/ns/formats/Format
     */
    resultFormat = this.toIri().concat('resultFormat');
    /**
     ...
     * @range       ssd:EntailmentProfile
     */
    supportedEntailmentProfile = this.toIri().concat('supportedEntailmentProfile');
    /**
     ...
     * @range       ssd:Language
     */
    supportedLanguage = this.toIri().concat('supportedLanguage');
}
/**
 ...
 * SPARQL Service Description
 */
const ssd = new Vocabulary('http://www.w3.org/ns/sparql-service-description#');
export default ssd;
