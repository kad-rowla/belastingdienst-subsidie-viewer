...
class Vocabulary extends VocabularyBase {
     ...
     */
    CompoundLiteral = this.toIri().concat('CompoundLiteral');
    /**
     ...
     * @parent      http://www.w3.org/2000/01/rdf-schema#Literal
     */
    PlainLiteral = this.toIri().concat('PlainLiteral');
    /**
     ...
     * @parent      http://www.w3.org/2000/01/rdf-schema#Literal
     */
    XMLLiteral = this.toIri().concat('XMLLiteral');
    /**
     ...
     * @parent      http://www.w3.org/2000/01/rdf-schema#Literal
     */
    langString = this.toIri().concat('langString');
    /**
