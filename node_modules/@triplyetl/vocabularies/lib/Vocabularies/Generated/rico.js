...
class Vocabulary extends VocabularyBase {
     ...
     */
    AccumulationRelation = this.toIri().concat('AccumulationRelation');
    /**
     ...
     */
    Activity = this.toIri().concat('Activity');
    /**
     ...
     */
    ActivityDocumentationRelation = this.toIri().concat('ActivityDocumentationRelation');
    /**
     ...
     */
    ActivityType = this.toIri().concat('ActivityType');
    /**
     ...
     */
    AgentControlRelation = this.toIri().concat('AgentControlRelation');
    /**
     ...
     */
    AgentHierarchicalRelation = this.toIri().concat('AgentHierarchicalRelation');
    /**
     ...
     * @parent      rico:Name
     */
    AgentName = this.toIri().concat('AgentName');
    /**
     ...
     */
    AgentOriginationRelation = this.toIri().concat('AgentOriginationRelation');
    /**
     ...
     */
    AgentTemporalRelation = this.toIri().concat('AgentTemporalRelation');
    /**
     ...
     */
    AgentToAgentRelation = this.toIri().concat('AgentToAgentRelation');
    /**
     ...
     * @parent      rico:Concept
     */
    Appellation = this.toIri().concat('Appellation');
    /**
     ...
     */
    AppellationRelation = this.toIri().concat('AppellationRelation');
    /**
     ...
     */
    AuthorityRelation = this.toIri().concat('AuthorityRelation');
    /**
     ...
     */
    AuthorshipRelation = this.toIri().concat('AuthorshipRelation');
    /**
     ...
     * @parent      rico:Extent
     */
    CarrierExtent = this.toIri().concat('CarrierExtent');
    /**
     ...
     */
    CarrierType = this.toIri().concat('CarrierType');
    /**
     ...
     */
    ChildRelation = this.toIri().concat('ChildRelation');
    /**
     ...
     */
    ContentType = this.toIri().concat('ContentType');
    /**
     ...
     * @parent      rico:Group
     */
    CorporateBody = this.toIri().concat('CorporateBody');
    /**
     ...
     */
    CorporateBodyType = this.toIri().concat('CorporateBodyType');
    /**
     ...
     */
    CorrespondenceRelation = this.toIri().concat('CorrespondenceRelation');
    /**
     ...
     */
    CreationRelation = this.toIri().concat('CreationRelation');
    /**
     ...
     */
    DateRange = this.toIri().concat('DateRange');
    /**
     ...
     * @parent      rico:Date
     */
    DateSet = this.toIri().concat('DateSet');
    /**
     ...
     * @parent      rico:Type
     */
    DemographicGroup = this.toIri().concat('DemographicGroup');
    /**
     ...
     */
    DerivationRelation = this.toIri().concat('DerivationRelation');
    /**
     ...
     */
    DescendanceRelation = this.toIri().concat('DescendanceRelation');
    /**
     ...
     */
    DocumentaryFormType = this.toIri().concat('DocumentaryFormType');
    /**
     ...
     */
    EventRelation = this.toIri().concat('EventRelation');
    /**
     ...
     */
    EventType = this.toIri().concat('EventType');
    /**
     ...
     * @parent      rico:Thing
     */
    Extent = this.toIri().concat('Extent');
    /**
     ...
     * @parent      rico:Type
     */
    ExtentType = this.toIri().concat('ExtentType');
    /**
     ...
     * @parent      rico:Group
     */
    Family = this.toIri().concat('Family');
    /**
     ...
     */
    FamilyRelation = this.toIri().concat('FamilyRelation');
    /**
     ...
     */
    FamilyType = this.toIri().concat('FamilyType');
    /**
     ...
     */
    FunctionalEquivalenceRelation = this.toIri().concat('FunctionalEquivalenceRelation');
    /**
     ...
     */
    GroupSubdivisionRelation = this.toIri().concat('GroupSubdivisionRelation');
    /**
     ...
     */
    Identifier = this.toIri().concat('Identifier');
    /**
     ...
     */
    IdentifierType = this.toIri().concat('IdentifierType');
    /**
     ...
     */
    Instantiation = this.toIri().concat('Instantiation');
    /**
     ...
     * @parent      rico:Extent
     */
    InstantiationExtent = this.toIri().concat('InstantiationExtent');
    /**
     ...
     */
    InstantiationToInstantiationRelation = this.toIri().concat('InstantiationToInstantiationRelation');
    /**
     ...
     */
    IntellectualPropertyRightsRelation = this.toIri().concat('IntellectualPropertyRightsRelation');
    /**
     ...
     */
    KnowingOfRelation = this.toIri().concat('KnowingOfRelation');
    /**
     ...
     */
    KnowingRelation = this.toIri().concat('KnowingRelation');
    /**
     ...
     * @parent      rico:Concept
     */
    Language = this.toIri().concat('Language');
    /**
     ...
     */
    LeadershipRelation = this.toIri().concat('LeadershipRelation');
    /**
     ...
     * @parent      rico:Type
     */
    LegalStatus = this.toIri().concat('LegalStatus');
    /**
     ...
     */
    ManagementRelation = this.toIri().concat('ManagementRelation');
    /**
     ...
     */
    Mandate = this.toIri().concat('Mandate');
    /**
     ...
     */
    MandateRelation = this.toIri().concat('MandateRelation');
    /**
     ...
     * @parent      rico:Agent
     */
    Mechanism = this.toIri().concat('Mechanism');
    /**
     ...
     */
    MembershipRelation = this.toIri().concat('MembershipRelation');
    /**
     ...
     */
    MigrationRelation = this.toIri().concat('MigrationRelation');
    /**
     ...
     */
    OccupationType = this.toIri().concat('OccupationType');
    /**
     ...
     */
    OwnershipRelation = this.toIri().concat('OwnershipRelation');
    /**
     ...
     */
    PerformanceRelation = this.toIri().concat('PerformanceRelation');
    /**
     ...
     */
    PhysicalLocation = this.toIri().concat('PhysicalLocation');
    /**
     ...
     * @parent      rico:Name
     */
    PlaceName = this.toIri().concat('PlaceName');
    /**
     ...
     */
    PlaceRelation = this.toIri().concat('PlaceRelation');
    /**
     ...
     */
    PositionHoldingRelation = this.toIri().concat('PositionHoldingRelation');
    /**
     ...
     */
    PositionToGroupRelation = this.toIri().concat('PositionToGroupRelation');
    /**
     ...
     */
    ProductionTechniqueType = this.toIri().concat('ProductionTechniqueType');
    /**
     ...
     */
    ProvenanceRelation = this.toIri().concat('ProvenanceRelation');
    /**
     ...
     */
    Record = this.toIri().concat('Record');
    /**
     ...
     * @parent      rico:RecordResource
     */
    RecordPart = this.toIri().concat('RecordPart');
    /**
     ...
     */
    RecordResource = this.toIri().concat('RecordResource');
    /**
     ...
     * @parent      rico:Extent
     */
    RecordResourceExtent = this.toIri().concat('RecordResourceExtent');
    /**
     ...
     */
    RecordResourceGeneticRelation = this.toIri().concat('RecordResourceGeneticRelation');
    /**
     ...
     */
    RecordResourceHoldingRelation = this.toIri().concat('RecordResourceHoldingRelation');
    /**
     ...
     */
    RecordResourceToInstantiationRelation = this.toIri().concat('RecordResourceToInstantiationRelation');
    /**
     ...
     */
    RecordResourceToRecordResourceRelation = this.toIri().concat('RecordResourceToRecordResourceRelation');
    /**
     ...
     */
    RecordSet = this.toIri().concat('RecordSet');
    /**
     ...
     */
    RecordSetType = this.toIri().concat('RecordSetType');
    /**
     ...
     * @parent      rico:Type
     */
    RecordState = this.toIri().concat('RecordState');
    /**
     ...
     * @parent      rico:Thing
     */
    Relation = this.toIri().concat('Relation');
    /**
     ...
     */
    RepresentationType = this.toIri().concat('RepresentationType');
    /**
     ...
     */
    RiCCMCorrespondingComponent = this.toIri().concat('RiCCMCorrespondingComponent');
    /**
     ...
     * @parent      rico:Type
     */
    RoleType = this.toIri().concat('RoleType');
    /**
     ...
     */
    RuleRelation = this.toIri().concat('RuleRelation');
    /**
     ...
     */
    SequentialRelation = this.toIri().concat('SequentialRelation');
    /**
     ...
     */
    SiblingRelation = this.toIri().concat('SiblingRelation');
    /**
     ...
     * @parent      rico:Date
     */
    SingleDate = this.toIri().concat('SingleDate');
    /**
     ...
     */
    SpouseRelation = this.toIri().concat('SpouseRelation');
    /**
     ...
     */
    TeachingRelation = this.toIri().concat('TeachingRelation');
    /**
     ...
     */
    TemporalRelation = this.toIri().concat('TemporalRelation');
    /**
     ...
     */
    TypeRelation = this.toIri().concat('TypeRelation');
    /**
     ...
     * @parent      rico:Concept
     */
    UnitOfMeasurement = this.toIri().concat('UnitOfMeasurement');
    /**
     ...
     */
    WholePartRelation = this.toIri().concat('WholePartRelation');
    /**
     ...
     */
    WorkRelation = this.toIri().concat('WorkRelation');
    /**
     ...
     */
    accrual = this.toIri().concat('accrual');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    accrualStatus = this.toIri().concat('accrualStatus');
    /**
     ...
     */
    accumulationRelationHasSource = this.toIri().concat('accumulationRelationHasSource');
    /**
     ...
     * @range       rico:Agent
     */
    accumulationRelationHasTarget = this.toIri().concat('accumulationRelationHasTarget');
    /**
     ...
     * @range       rico:Instantiation or rico:RecordResource
     */
    activityDocumentationRelationHasSource = this.toIri().concat('activityDocumentationRelationHasSource');
    /**
     ...
     * @range       rico:Activity
     */
    activityDocumentationRelationHasTarget = this.toIri().concat('activityDocumentationRelationHasTarget');
    /**
     ...
     */
    activityIsContextOfRelation = this.toIri().concat('activityIsContextOfRelation');
    /**
     ...
     */
    activityIsSourceOfPerformanceRelation = this.toIri().concat('activityIsSourceOfPerformanceRelation');
    /**
     ...
     */
    activityIsTargetOfActivityDocumentationRelation = this.toIri().concat('activityIsTargetOfActivityDocumentationRelation');
    /**
     ...
     * @range       rico:Thing
     */
    affectsOrAffected = this.toIri().concat('affectsOrAffected');
    /**
     ...
     * @range       rico:Agent
     */
    agentControlRelationHasSource = this.toIri().concat('agentControlRelationHasSource');
    /**
     ...
     * @range       rico:Agent
     */
    agentControlRelationHasTarget = this.toIri().concat('agentControlRelationHasTarget');
    /**
     ...
     */
    agentHasWorkRelation = this.toIri().concat('agentHasWorkRelation');
    /**
     ...
     * @range       rico:Agent
     */
    agentHierarchicalRelationHasSource = this.toIri().concat('agentHierarchicalRelationHasSource');
    /**
     ...
     * @range       rico:Agent
     */
    agentHierarchicalRelationHasTarget = this.toIri().concat('agentHierarchicalRelationHasTarget');
    /**
     ...
     */
    agentIsConnectedToAgentRelation = this.toIri().concat('agentIsConnectedToAgentRelation');
    /**
     ...
     */
    agentIsSourceOfAgentControlRelation = this.toIri().concat('agentIsSourceOfAgentControlRelation');
    /**
     ...
     */
    agentIsSourceOfAgentHierarchicalRelation = this.toIri().concat('agentIsSourceOfAgentHierarchicalRelation');
    /**
     ...
     */
    agentIsSourceOfAgentTemporalRelation = this.toIri().concat('agentIsSourceOfAgentTemporalRelation');
    /**
     ...
     */
    agentIsSourceOfAuthorityRelation = this.toIri().concat('agentIsSourceOfAuthorityRelation');
    /**
     ...
     */
    agentIsSourceOfIntellectualPropertyRightsRelation = this.toIri().concat('agentIsSourceOfIntellectualPropertyRightsRelation');
    /**
     ...
     */
    agentIsSourceOfManagementRelation = this.toIri().concat('agentIsSourceOfManagementRelation');
    /**
     ...
     */
    agentIsSourceOfOwnershipRelation = this.toIri().concat('agentIsSourceOfOwnershipRelation');
    /**
     ...
     */
    agentIsSourceOfRecordResourceHoldingRelation = this.toIri().concat('agentIsSourceOfRecordResourceHoldingRelation');
    /**
     ...
     */
    agentIsTargetOfAccumulationRelation = this.toIri().concat('agentIsTargetOfAccumulationRelation');
    /**
     ...
     * @range       rico:AgentControlRelation
     */
    agentIsTargetOfAgentControlRelation = this.toIri().concat('agentIsTargetOfAgentControlRelation');
    /**
     ...
     * @range       rico:AgentHierarchicalRelation
     */
    agentIsTargetOfAgentHierarchicalRelation = this.toIri().concat('agentIsTargetOfAgentHierarchicalRelation');
    /**
     ...
     */
    agentIsTargetOfAgentOriginationRelation = this.toIri().concat('agentIsTargetOfAgentOriginationRelation');
    /**
     ...
     * @range       rico:AgentTemporalRelation
     */
    agentIsTargetOfAgentTemporalRelation = this.toIri().concat('agentIsTargetOfAgentTemporalRelation');
    /**
     ...
     */
    agentIsTargetOfAuthorshipRelation = this.toIri().concat('agentIsTargetOfAuthorshipRelation');
    /**
     ...
     */
    agentIsTargetOfCreationRelation = this.toIri().concat('agentIsTargetOfCreationRelation');
    /**
     ...
     */
    agentIsTargetOfMandateRelation = this.toIri().concat('agentIsTargetOfMandateRelation');
    /**
     ...
     * @range       rico:PerformanceRelation
     */
    agentIsTargetOfPerformanceRelation = this.toIri().concat('agentIsTargetOfPerformanceRelation');
    /**
     ...
     */
    agentOrActivityIsTargetOfProvenanceRelation = this.toIri().concat('agentOrActivityIsTargetOfProvenanceRelation');
    /**
     ...
     * @range       rico:Instantiation or rico:RecordResource
     */
    agentOriginationRelationHasSource = this.toIri().concat('agentOriginationRelationHasSource');
    /**
     ...
     * @range       rico:Agent
     */
    agentOriginationRelationHasTarget = this.toIri().concat('agentOriginationRelationHasTarget');
    /**
     ...
     * @range       rico:Agent
     */
    agentRelationConnects = this.toIri().concat('agentRelationConnects');
    /**
     ...
     * @range       rico:Agent
     */
    agentTemporalRelationHasSource = this.toIri().concat('agentTemporalRelationHasSource');
    /**
     ...
     * @range       rico:Agent
     */
    agentTemporalRelationHasTarget = this.toIri().concat('agentTemporalRelationHasTarget');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    altimetricSystem = this.toIri().concat('altimetricSystem');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    altitude = this.toIri().concat('altitude');
    /**
     ...
     */
    appellationIsSourceOfAppellationRelation = this.toIri().concat('appellationIsSourceOfAppellationRelation');
    /**
     ...
     */
    appellationRelationHasSource = this.toIri().concat('appellationRelationHasSource');
    /**
     ...
     * @range       rico:Thing
     */
    appellationRelationHasTarget = this.toIri().concat('appellationRelationHasTarget');
    /**
     ...
     * @range       rico:Activity
     */
    asConcernsActivity = this.toIri().concat('asConcernsActivity');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    authenticityNote = this.toIri().concat('authenticityNote');
    /**
     ...
     * @range       rico:Agent
     */
    authorityRelationHasSource = this.toIri().concat('authorityRelationHasSource');
    /**
     ...
     * @range       rico:Thing
     */
    authorityRelationHasTarget = this.toIri().concat('authorityRelationHasTarget');
    /**
     ...
     * @range       rico:Mandate
     */
    authorizedBy = this.toIri().concat('authorizedBy');
    /**
     ...
     * @range       rico:Agent
     */
    authorizes = this.toIri().concat('authorizes');
    /**
     ...
     * @range       rico:Agent
     */
    authorizingAgent = this.toIri().concat('authorizingAgent');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    authorizingMandate = this.toIri().concat('authorizingMandate');
    /**
     ...
     * @range       rico:Record
     */
    authorshipRelationHasSource = this.toIri().concat('authorshipRelationHasSource');
    /**
     ...
     */
    authorshipRelationHasTarget = this.toIri().concat('authorshipRelationHasTarget');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    beginningDate = this.toIri().concat('beginningDate');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    birthDate = this.toIri().concat('birthDate');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    calendar = this.toIri().concat('calendar');
    /**
     * **[rico:carrier extent](https://www.ica.org/standards/RiC/ontology#carrierExtent)**
     *
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    certainty = this.toIri().concat('certainty');
    /**
     ...
     * @range       rico:Person
     */
    childRelationHasSource = this.toIri().concat('childRelationHasSource');
    /**
     ...
     * @range       rico:Person
     */
    childRelationHasTarget = this.toIri().concat('childRelationHasTarget');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    classification = this.toIri().concat('classification');
    /**
     ...
     * @parent      http://www.w3.org/2000/01/rdf-schema#comment
     */
    closeTo = this.toIri().concat('closeTo');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    conditionsOfAccess = this.toIri().concat('conditionsOfAccess');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    conditionsOfUse = this.toIri().concat('conditionsOfUse');
    /**
     ...
     * @range       rico:Place
     */
    containsOrContained = this.toIri().concat('containsOrContained');
    /**
     ...
     * @range       rico:Person
     */
    correspondenceRelationConnects = this.toIri().concat('correspondenceRelationConnects');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    creationDate = this.toIri().concat('creationDate');
    /**
     ...
     * @range       rico:Instantiation or rico:RecordResource
     */
    creationRelationHasSource = this.toIri().concat('creationRelationHasSource');
    /**
     ...
     * @range       rico:Agent
     */
    creationRelationHasTarget = this.toIri().concat('creationRelationHasTarget');
    /**
     ...
     * @range       rico:RoleType
     */
    creationWithRole = this.toIri().concat('creationWithRole');
    /**
     * **[rico:date](https://www.ica.org/standards/RiC/ontology#date)**
     *
     * Chronological information associated with an entity that            contributes to its identification and contextualization.
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    dateQualifier = this.toIri().concat('dateQualifier');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    dateStandard = this.toIri().concat('dateStandard');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    deathDate = this.toIri().concat('deathDate');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    deletionDate = this.toIri().concat('deletionDate');
    /**
     ...
     */
    derivationRelationHasSource = this.toIri().concat('derivationRelationHasSource');
    /**
     ...
     * @range       rico:Instantiation
     */
    derivationRelationHasTarget = this.toIri().concat('derivationRelationHasTarget');
    /**
     ...
     * @range       rico:Person
     */
    descendanceRelationHasSource = this.toIri().concat('descendanceRelationHasSource');
    /**
     ...
     * @range       rico:Person
     */
    descendanceRelationHasTarget = this.toIri().concat('descendanceRelationHasTarget');
    /**
     ...
     * @range       rico:Thing
     */
    describesOrDescribed = this.toIri().concat('describesOrDescribed');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    descriptiveNote = this.toIri().concat('descriptiveNote');
    /**
     ...
     * @range       rico:Instantiation or rico:RecordResource
     */
    documentedBy = this.toIri().concat('documentedBy');
    /**
     ...
     * @range       rico:Activity
     */
    documents = this.toIri().concat('documents');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    endDate = this.toIri().concat('endDate');
    /**
     ...
     */
    eventIsSourceOfEventRelation = this.toIri().concat('eventIsSourceOfEventRelation');
    /**
     ...
     * @range       rico:Event
     */
    eventRelationHasSource = this.toIri().concat('eventRelationHasSource');
    /**
     ...
     * @range       rico:Thing
     */
    eventRelationHasTarget = this.toIri().concat('eventRelationHasTarget');
    /**
     ...
     * @range       rico:Group
     */
    existsOrExistedIn = this.toIri().concat('existsOrExistedIn');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    expressedDate = this.toIri().concat('expressedDate');
    /**
     ...
     * @range       rico:Rule
     */
    expressesOrExpressed = this.toIri().concat('expressesOrExpressed');
    /**
     ...
     * @range       rico:Person
     */
    familyRelationConnects = this.toIri().concat('familyRelationConnects');
    /**
     ...
     * @range       rico:Thing
     */
    followsInTime = this.toIri().concat('followsInTime');
    /**
     ...
     * @range       rico:Thing
     */
    followsOrFollowed = this.toIri().concat('followsOrFollowed');
    /**
     ...
     * @range       rico:Instantiation
     */
    functionalEquivalenceRelationConnects = this.toIri().concat('functionalEquivalenceRelationConnects');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    geodesicSystem = this.toIri().concat('geodesicSystem');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    geographicalCoordinates = this.toIri().concat('geographicalCoordinates');
    /**
     ...
     */
    groupIsSourceOfGroupSubdivisionRelation = this.toIri().concat('groupIsSourceOfGroupSubdivisionRelation');
    /**
     ...
     */
    groupIsSourceOfMembershipRelation = this.toIri().concat('groupIsSourceOfMembershipRelation');
    /**
     ...
     * @range       rico:GroupSubdivisionRelation
     */
    groupIsTargetOfGroupSubdivisionRelation = this.toIri().concat('groupIsTargetOfGroupSubdivisionRelation');
    /**
     ...
     */
    groupIsTargetOfLeadershipRelation = this.toIri().concat('groupIsTargetOfLeadershipRelation');
    /**
     ...
     */
    groupIsTargetOfPositionToGroupRelation = this.toIri().concat('groupIsTargetOfPositionToGroupRelation');
    /**
     ...
     * @range       rico:Group
     */
    groupSubdivisionRelationHasSource = this.toIri().concat('groupSubdivisionRelationHasSource');
    /**
     ...
     * @range       rico:Group
     */
    groupSubdivisionRelationHasTarget = this.toIri().concat('groupSubdivisionRelationHasTarget');
    /**
     ...
     * @range       rico:Agent
     */
    hasAccumulator = this.toIri().concat('hasAccumulator');
    /**
     ...
     */
    hasActivityType = this.toIri().concat('hasActivityType');
    /**
     ...
     * @range       rico:Agent
     */
    hasAddressee = this.toIri().concat('hasAddressee');
    /**
     ...
     * @range       rico:Person
     */
    hasAncestor = this.toIri().concat('hasAncestor');
    /**
     ...
     * @range       rico:Group or rico:Person or rico:Position
     */
    hasAuthor = this.toIri().concat('hasAuthor');
    /**
     ...
     * @range       rico:Date
     */
    hasBeginningDate = this.toIri().concat('hasBeginningDate');
    /**
     ...
     * @range       rico:Date
     */
    hasBirthDate = this.toIri().concat('hasBirthDate');
    /**
     ...
     */
    hasCarrierType = this.toIri().concat('hasCarrierType');
    /**
     ...
     * @range       rico:Person
     */
    hasChild = this.toIri().concat('hasChild');
    /**
     ...
     * @range       rico:Agent
     */
    hasCollector = this.toIri().concat('hasCollector');
    /**
     ...
     */
    hasContentOfType = this.toIri().concat('hasContentOfType');
    /**
     ...
     */
    hasCopy = this.toIri().concat('hasCopy');
    /**
     ...
     * @range       rico:Agent
     */
    hasCreator = this.toIri().concat('hasCreator');
    /**
     ...
     * @range       rico:Date
     */
    hasDeathDate = this.toIri().concat('hasDeathDate');
    /**
     ...
     * @range       rico:Instantiation
     */
    hasDerivedInstantiation = this.toIri().concat('hasDerivedInstantiation');
    /**
     ...
     * @range       rico:Person
     */
    hasDescendant = this.toIri().concat('hasDescendant');
    /**
     ...
     */
    hasDocumentaryFormType = this.toIri().concat('hasDocumentaryFormType');
    /**
     ...
     */
    hasDraft = this.toIri().concat('hasDraft');
    /**
     ...
     * @range       rico:Date
     */
    hasEndDate = this.toIri().concat('hasEndDate');
    /**
     ...
     */
    hasEventType = this.toIri().concat('hasEventType');
    /**
     ...
     * @range       rico:Extent
     */
    hasExtent = this.toIri().concat('hasExtent');
    /**
     ...
     */
    hasExtentType = this.toIri().concat('hasExtentType');
    /**
     ...
     * @range       rico:Person
     */
    hasFamilyAssociationWith = this.toIri().concat('hasFamilyAssociationWith');
    /**
     ...
     */
    hasFamilyType = this.toIri().concat('hasFamilyType');
    /**
     ...
     * @range       rico:RecordResource
     */
    hasGeneticLinkToRecordResource = this.toIri().concat('hasGeneticLinkToRecordResource');
    /**
     ...
     */
    hasIdentifierType = this.toIri().concat('hasIdentifierType');
    /**
     ...
     * @range       rico:Instantiation
     */
    hasInstantiation = this.toIri().concat('hasInstantiation');
    /**
     ...
     * @range       rico:Date
     */
    hasModificationDate = this.toIri().concat('hasModificationDate');
    /**
     ...
     */
    hasOrHadAgentName = this.toIri().concat('hasOrHadAgentName');
    /**
     ...
     * @range       rico:Type
     */
    hasOrHadAllMembersWithCategory = this.toIri().concat('hasOrHadAllMembersWithCategory');
    /**
     ...
     * @range       rico:ContentType
     */
    hasOrHadAllMembersWithContentType = this.toIri().concat('hasOrHadAllMembersWithContentType');
    /**
     ...
     * @range       rico:DocumentaryFormType
     */
    hasOrHadAllMembersWithDocumentaryFormType = this.toIri().concat('hasOrHadAllMembersWithDocumentaryFormType');
    /**
     ...
     * @range       rico:Language
     */
    hasOrHadAllMembersWithLanguage = this.toIri().concat('hasOrHadAllMembersWithLanguage');
    /**
     ...
     */
    hasOrHadAllMembersWithLegalStatus = this.toIri().concat('hasOrHadAllMembersWithLegalStatus');
    /**
     ...
     */
    hasOrHadAllMembersWithRecordState = this.toIri().concat('hasOrHadAllMembersWithRecordState');
    /**
     ...
     * @range       rico:Appellation
     */
    hasOrHadAppellation = this.toIri().concat('hasOrHadAppellation');
    /**
     ...
     * @range       rico:Thing
     */
    hasOrHadAuthorityOver = this.toIri().concat('hasOrHadAuthorityOver');
    /**
     ...
     * @range       rico:Type
     */
    hasOrHadCategory = this.toIri().concat('hasOrHadCategory');
    /**
     ...
     * @range       rico:Instantiation
     */
    hasOrHadComponent = this.toIri().concat('hasOrHadComponent');
    /**
     ...
     */
    hasOrHadConstituent = this.toIri().concat('hasOrHadConstituent');
    /**
     ...
     * @range       rico:Agent
     */
    hasOrHadController = this.toIri().concat('hasOrHadController');
    /**
     ...
     */
    hasOrHadCoordinates = this.toIri().concat('hasOrHadCoordinates');
    /**
     ...
     */
    hasOrHadCorporateBodyType = this.toIri().concat('hasOrHadCorporateBodyType');
    /**
     ...
     * @range       rico:Person
     */
    hasOrHadCorrespondent = this.toIri().concat('hasOrHadCorrespondent');
    /**
     ...
     */
    hasOrHadDemographicGroup = this.toIri().concat('hasOrHadDemographicGroup');
    /**
     ...
     * @range       rico:Agent
     */
    hasOrHadHolder = this.toIri().concat('hasOrHadHolder');
    /**
     ...
     */
    hasOrHadIdentifier = this.toIri().concat('hasOrHadIdentifier');
    /**
     ...
     * @range       rico:Group or rico:Person or rico:Position
     */
    hasOrHadIntellectualPropertyRightsHolder = this.toIri().concat('hasOrHadIntellectualPropertyRightsHolder');
    /**
     ...
     * @range       rico:Place
     */
    hasOrHadJurisdiction = this.toIri().concat('hasOrHadJurisdiction');
    /**
     ...
     * @range       rico:Language
     */
    hasOrHadLanguage = this.toIri().concat('hasOrHadLanguage');
    /**
     ...
     * @range       rico:Person
     */
    hasOrHadLeader = this.toIri().concat('hasOrHadLeader');
    /**
     ...
     * @range       rico:LegalStatus
     */
    hasOrHadLegalStatus = this.toIri().concat('hasOrHadLegalStatus');
    /**
     ...
     * @range       rico:Place
     */
    hasOrHadLocation = this.toIri().concat('hasOrHadLocation');
    /**
     ...
     * @range       rico:Thing
     */
    hasOrHadMainSubject = this.toIri().concat('hasOrHadMainSubject');
    /**
     ...
     * @range       rico:Agent
     */
    hasOrHadManager = this.toIri().concat('hasOrHadManager');
    /**
     ...
     * @range       rico:Person
     */
    hasOrHadMember = this.toIri().concat('hasOrHadMember');
    /**
     ...
     * @range       rico:Name
     */
    hasOrHadName = this.toIri().concat('hasOrHadName');
    /**
     ...
     */
    hasOrHadOccupationOfType = this.toIri().concat('hasOrHadOccupationOfType');
    /**
     ...
     * @range       rico:Group or rico:Person or rico:Position
     */
    hasOrHadOwner = this.toIri().concat('hasOrHadOwner');
    /**
     ...
     * @range       rico:Thing
     */
    hasOrHadPart = this.toIri().concat('hasOrHadPart');
    /**
     ...
     * @range       rico:Thing
     */
    hasOrHadParticipant = this.toIri().concat('hasOrHadParticipant');
    /**
     ...
     */
    hasOrHadPhysicalLocation = this.toIri().concat('hasOrHadPhysicalLocation');
    /**
     ...
     */
    hasOrHadPlaceName = this.toIri().concat('hasOrHadPlaceName');
    /**
     ...
     */
    hasOrHadPlaceType = this.toIri().concat('hasOrHadPlaceType');
    /**
     ...
     * @range       rico:Position
     */
    hasOrHadPosition = this.toIri().concat('hasOrHadPosition');
    /**
     ...
     * @range       rico:RuleType
     */
    hasOrHadRuleType = this.toIri().concat('hasOrHadRuleType');
    /**
     ...
     * @range       rico:Type
     */
    hasOrHadSomeMembersWithCategory = this.toIri().concat('hasOrHadSomeMembersWithCategory');
    /**
     ...
     * @range       rico:ContentType
     */
    hasOrHadSomeMembersWithContentType = this.toIri().concat('hasOrHadSomeMembersWithContentType');
    /**
     ...
     * @range       rico:Language
     */
    hasOrHadSomeMembersWithLanguage = this.toIri().concat('hasOrHadSomeMembersWithLanguage');
    /**
     ...
     * @range       rico:LegalStatus
     */
    hasOrHadSomeMembersWithLegalStatus = this.toIri().concat('hasOrHadSomeMembersWithLegalStatus');
    /**
     ...
     * @range       rico:RecordState
     */
    hasOrHadSomeMembersWithRecordState = this.toIri().concat('hasOrHadSomeMembersWithRecordState');
    /**
     ...
     * @range       rico:DocumentaryFormType
     */
    hasOrHadSomeMemberswithDocumentaryFormType = this.toIri().concat('hasOrHadSomeMemberswithDocumentaryFormType');
    /**
     ...
     * @range       rico:Person
     */
    hasOrHadSpouse = this.toIri().concat('hasOrHadSpouse');
    /**
     ...
     * @range       rico:Person
     */
    hasOrHadStudent = this.toIri().concat('hasOrHadStudent');
    /**
     ...
     * @range       rico:Group
     */
    hasOrHadSubdivision = this.toIri().concat('hasOrHadSubdivision');
    /**
     ...
     * @range       rico:Event
     */
    hasOrHadSubevent = this.toIri().concat('hasOrHadSubevent');
    /**
     ...
     * @range       rico:Thing
     */
    hasOrHadSubject = this.toIri().concat('hasOrHadSubject');
    /**
     ...
     * @range       rico:Agent
     */
    hasOrHadSubordinate = this.toIri().concat('hasOrHadSubordinate');
    /**
     ...
     * @range       rico:Person
     */
    hasOrHadTeacher = this.toIri().concat('hasOrHadTeacher');
    /**
     ...
     * @range       rico:Title
     */
    hasOrHadTitle = this.toIri().concat('hasOrHadTitle');
    /**
     ...
     * @range       rico:Agent
     */
    hasOrHadWorkRelationWith = this.toIri().concat('hasOrHadWorkRelationWith');
    /**
     ...
     * @range       rico:Record or rico:RecordPart
     */
    hasOriginal = this.toIri().concat('hasOriginal');
    /**
     ...
     */
    hasProductionTechniqueType = this.toIri().concat('hasProductionTechniqueType');
    /**
     ...
     * @range       rico:Agent
     */
    hasProvenance = this.toIri().concat('hasProvenance');
    /**
     ...
     * @range       rico:Agent
     */
    hasPublisher = this.toIri().concat('hasPublisher');
    /**
     ...
     * @range       rico:Agent
     */
    hasReceiver = this.toIri().concat('hasReceiver');
    /**
     ...
     */
    hasRecordSetType = this.toIri().concat('hasRecordSetType');
    /**
     ...
     * @range       rico:RecordState
     */
    hasRecordState = this.toIri().concat('hasRecordState');
    /**
     ...
     * @range       rico:RecordResource
     */
    hasReply = this.toIri().concat('hasReply');
    /**
     ...
     */
    hasRepresentationType = this.toIri().concat('hasRepresentationType');
    /**
     ...
     * @range       rico:Agent
     */
    hasSender = this.toIri().concat('hasSender');
    /**
     ...
     * @range       rico:Person
     */
    hasSibling = this.toIri().concat('hasSibling');
    /**
     ...
     */
    hasSource = this.toIri().concat('hasSource');
    /**
     ...
     * @range       rico:Agent
     */
    hasSuccessor = this.toIri().concat('hasSuccessor');
    /**
     ...
     */
    hasUnitOfMeasurement = this.toIri().concat('hasUnitOfMeasurement');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    history = this.toIri().concat('history');
    /**
     * **[rico:identifier](https://www.ica.org/standards/RiC/ontology#identifier)**
     *
     ...
     */
    includesOrIncluded = this.toIri().concat('includesOrIncluded');
    /**
     * **[rico:Instantiation extent](https://www.ica.org/standards/RiC/ontology#instantiationExtent)**
     *
     ...
     */
    instantiationIsConnectedToFunctionalEquivalenceRelation = this.toIri().concat('instantiationIsConnectedToFunctionalEquivalenceRelation');
    /**
     ...
     */
    instantiationIsConnectedToInstantiationRelation = this.toIri().concat('instantiationIsConnectedToInstantiationRelation');
    /**
     ...
     */
    instantiationIsSourceOfDerivationRelation = this.toIri().concat('instantiationIsSourceOfDerivationRelation');
    /**
     ...
     */
    instantiationIsSourceOfMigrationRelation = this.toIri().concat('instantiationIsSourceOfMigrationRelation');
    /**
     ...
     * @range       rico:DerivationRelation
     */
    instantiationIsTargetOfDerivationRelation = this.toIri().concat('instantiationIsTargetOfDerivationRelation');
    /**
     ...
     * @range       rico:MigrationRelation
     */
    instantiationIsTargetOfMigrationRelation = this.toIri().concat('instantiationIsTargetOfMigrationRelation');
    /**
     ...
     */
    instantiationIsTargetOfRecordResourceToInstantiationRelation = this.toIri().concat('instantiationIsTargetOfRecordResourceToInstantiationRelation');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    instantiationStructure = this.toIri().concat('instantiationStructure');
    /**
     ...
     * @range       rico:Instantiation
     */
    instantiationToInstantiationRelationConnects = this.toIri().concat('instantiationToInstantiationRelationConnects');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    integrity = this.toIri().concat('integrity');
    /**
     ...
     * @range       rico:Group or rico:Person or rico:Position
     */
    intellectualPropertyRightsRelationHasSource = this.toIri().concat('intellectualPropertyRightsRelationHasSource');
    /**
     ...
     * @range       rico:Instantiation or rico:RecordResource
     */
    intellectualPropertyRightsRelationHasTarget = this.toIri().concat('intellectualPropertyRightsRelationHasTarget');
    /**
     ...
     * @range       rico:Instantiation or rico:RecordResource
     */
    isAccumulatorOf = this.toIri().concat('isAccumulatorOf');
    /**
     ...
     * @range       rico:Activity
     */
    isActivityTypeOf = this.toIri().concat('isActivityTypeOf');
    /**
     ...
     * @range       rico:Instantiation or rico:RecordResource
     */
    isAddresseeOf = this.toIri().concat('isAddresseeOf');
    /**
     ...
     * @range       rico:Agent
     */
    isAgentAssociatedWithAgent = this.toIri().concat('isAgentAssociatedWithAgent');
    /**
     ...
     * @range       rico:Date
     */
    isAssociatedWithDate = this.toIri().concat('isAssociatedWithDate');
    /**
     ...
     * @range       rico:Event
     */
    isAssociatedWithEvent = this.toIri().concat('isAssociatedWithEvent');
    /**
     ...
     * @range       rico:Place
     */
    isAssociatedWithPlace = this.toIri().concat('isAssociatedWithPlace');
    /**
     ...
     * @range       rico:Rule
     */
    isAssociatedWithRule = this.toIri().concat('isAssociatedWithRule');
    /**
     ...
     * @range       rico:Record
     */
    isAuthorOf = this.toIri().concat('isAuthorOf');
    /**
     ...
     * @range       rico:MandateRelation
     */
    isAuthorizingAgentInMandateRelation = this.toIri().concat('isAuthorizingAgentInMandateRelation');
    /**
     ...
     * @range       rico:Thing
     */
    isBeginningDateOf = this.toIri().concat('isBeginningDateOf');
    /**
     ...
     * @range       rico:Person
     */
    isBirthDateOf = this.toIri().concat('isBirthDateOf');
    /**
     ...
     * @range       rico:Instantiation
     */
    isCarrierTypeOf = this.toIri().concat('isCarrierTypeOf');
    /**
     ...
     * @range       rico:Person
     */
    isChildOf = this.toIri().concat('isChildOf');
    /**
     ...
     * @range       rico:Instantiation or rico:RecordResource
     */
    isCollectorOf = this.toIri().concat('isCollectorOf');
    /**
     ...
     * @range       rico:Record or rico:RecordPart
     */
    isContentTypeOf = this.toIri().concat('isContentTypeOf');
    /**
     ...
     * @range       rico:RecordResource
     */
    isCopyOf = this.toIri().concat('isCopyOf');
    /**
     ...
     * @range       rico:Instantiation or rico:RecordResource
     */
    isCreatorOf = this.toIri().concat('isCreatorOf');
    /**
     ...
     * @range       rico:Thing
     */
    isDateAssociatedWith = this.toIri().concat('isDateAssociatedWith');
    /**
     ...
     * @range       rico:Person
     */
    isDeathDateOf = this.toIri().concat('isDeathDateOf');
    /**
     ...
     * @range       rico:Instantiation
     */
    isDerivedFromInstantiation = this.toIri().concat('isDerivedFromInstantiation');
    /**
     ...
     * @range       rico:Record or rico:RecordPart
     */
    isDocumentaryFormTypeOf = this.toIri().concat('isDocumentaryFormTypeOf');
    /**
     ...
     * @range       rico:Record or rico:RecordPart
     */
    isDraftOf = this.toIri().concat('isDraftOf');
    /**
     ...
     * @range       rico:Thing
     */
    isEndDateOf = this.toIri().concat('isEndDateOf');
    /**
     ...
     * @range       rico:Thing
     */
    isEquivalentTo = this.toIri().concat('isEquivalentTo');
    /**
     ...
     * @range       rico:Thing
     */
    isEventAssociatedWith = this.toIri().concat('isEventAssociatedWith');
    /**
     ...
     * @range       rico:Event
     */
    isEventTypeOf = this.toIri().concat('isEventTypeOf');
    /**
     ...
     * @range       rico:Instantiation or rico:RecordResource
     */
    isExtentOf = this.toIri().concat('isExtentOf');
    /**
     ...
     * @range       rico:Extent
     */
    isExtentTypeOf = this.toIri().concat('isExtentTypeOf');
    /**
     ...
     * @range       rico:Family
     */
    isFamilyTypeOf = this.toIri().concat('isFamilyTypeOf');
    /**
     ...
     * @range       rico:Appellation
     */
    isFromUseDateOf = this.toIri().concat('isFromUseDateOf');
    /**
     ...
     * @range       rico:Instantiation
     */
    isFunctionallyEquivalentTo = this.toIri().concat('isFunctionallyEquivalentTo');
    /**
     ...
     * @range       rico:Identifier
     */
    isIdentifierTypeOf = this.toIri().concat('isIdentifierTypeOf');
    /**
     ...
     * @range       rico:Instantiation
     */
    isInstantiationAssociatedWithInstantiation = this.toIri().concat('isInstantiationAssociatedWithInstantiation');
    /**
     ...
     * @range       rico:RecordResource
     */
    isInstantiationOf = this.toIri().concat('isInstantiationOf');
    /**
     ...
     * @range       rico:Thing
     */
    isLastUpdateDateOf = this.toIri().concat('isLastUpdateDateOf');
    /**
     ...
     * @range       rico:Thing
     */
    isModificationDateOf = this.toIri().concat('isModificationDateOf');
    /**
     ...
     * @range       rico:Place
     */
    isOrWasAdjacentTo = this.toIri().concat('isOrWasAdjacentTo');
    /**
     ...
     * @range       rico:Event
     */
    isOrWasAffectedBy = this.toIri().concat('isOrWasAffectedBy');
    /**
     ...
     * @range       rico:Agent
     */
    isOrWasAgentNameOf = this.toIri().concat('isOrWasAgentNameOf');
    /**
     ...
     * @range       rico:Thing
     */
    isOrWasAppellationOf = this.toIri().concat('isOrWasAppellationOf');
    /**
     ...
     * @range       rico:Thing
     */
    isOrWasCategoryOf = this.toIri().concat('isOrWasCategoryOf');
    /**
     ...
     */
    isOrWasCategoryOfAllMembersOf = this.toIri().concat('isOrWasCategoryOfAllMembersOf');
    /**
     ...
     * @range       rico:RecordSet
     */
    isOrWasCategoryOfSomeMembersOf = this.toIri().concat('isOrWasCategoryOfSomeMembersOf');
    /**
     ...
     * @range       rico:Instantiation
     */
    isOrWasComponentOf = this.toIri().concat('isOrWasComponentOf');
    /**
     ...
     * @range       rico:Record
     */
    isOrWasConstituentOf = this.toIri().concat('isOrWasConstituentOf');
    /**
     ...
     * @range       rico:Place
     */
    isOrWasContainedBy = this.toIri().concat('isOrWasContainedBy');
    /**
     ...
     * @range       rico:RecordSet
     */
    isOrWasContentTypeOfAllMembersOf = this.toIri().concat('isOrWasContentTypeOfAllMembersOf');
    /**
     ...
     * @range       rico:RecordSet
     */
    isOrWasContentTypeOfSomeMembersOf = this.toIri().concat('isOrWasContentTypeOfSomeMembersOf');
    /**
     ...
     * @range       rico:Agent
     */
    isOrWasControllerOf = this.toIri().concat('isOrWasControllerOf');
    /**
     ...
     * @range       rico:PhysicalLocation
     */
    isOrWasCoordinatesOf = this.toIri().concat('isOrWasCoordinatesOf');
    /**
     ...
     */
    isOrWasCorporateBodyTypeOf = this.toIri().concat('isOrWasCorporateBodyTypeOf');
    /**
     ...
     */
    isOrWasDemographicGroupOf = this.toIri().concat('isOrWasDemographicGroupOf');
    /**
     ...
     * @range       rico:RecordResource
     */
    isOrWasDescribedBy = this.toIri().concat('isOrWasDescribedBy');
    /**
     ...
     * @range       rico:RecordSet
     */
    isOrWasDocumentaryFormTypeOfAllMembersOf = this.toIri().concat('isOrWasDocumentaryFormTypeOfAllMembersOf');
    /**
     ...
     * @range       rico:RecordSet
     */
    isOrWasDocumentaryFormTypeOfSomeMembersOf = this.toIri().concat('isOrWasDocumentaryFormTypeOfSomeMembersOf');
    /**
     ...
     * @range       rico:Agent
     */
    isOrWasEnforcedBy = this.toIri().concat('isOrWasEnforcedBy');
    /**
     ...
     * @range       rico:RecordResource
     */
    isOrWasExpressedBy = this.toIri().concat('isOrWasExpressedBy');
    /**
     ...
     * @range       rico:Instantiation or rico:RecordResource
     */
    isOrWasHolderOf = this.toIri().concat('isOrWasHolderOf');
    /**
     ...
     * @range       rico:Instantiation or rico:RecordResource
     */
    isOrWasHolderOfIntellectualPropertyRightsOf = this.toIri().concat('isOrWasHolderOfIntellectualPropertyRightsOf');
    /**
     ...
     * @range       rico:Thing
     */
    isOrWasIdentifierOf = this.toIri().concat('isOrWasIdentifierOf');
    /**
     ...
     * @range       rico:RecordSet
     */
    isOrWasIncludedIn = this.toIri().concat('isOrWasIncludedIn');
    /**
     ...
     * @range       rico:Agent
     */
    isOrWasJurisdictionOf = this.toIri().concat('isOrWasJurisdictionOf');
    /**
     ...
     */
    isOrWasLanguageOf = this.toIri().concat('isOrWasLanguageOf');
    /**
     ...
     * @range       rico:RecordSet
     */
    isOrWasLanguageOfAllMembersOf = this.toIri().concat('isOrWasLanguageOfAllMembersOf');
    /**
     ...
     * @range       rico:RecordSet
     */
    isOrWasLanguageOfSomeMembersOf = this.toIri().concat('isOrWasLanguageOfSomeMembersOf');
    /**
     ...
     * @range       rico:Group
     */
    isOrWasLeaderOf = this.toIri().concat('isOrWasLeaderOf');
    /**
     ...
     * @range       rico:Agent or rico:Record or rico:RecordPart
     */
    isOrWasLegalStatusOf = this.toIri().concat('isOrWasLegalStatusOf');
    /**
     ...
     * @range       rico:RecordSet
     */
    isOrWasLegalStatusOfAllMembersOf = this.toIri().concat('isOrWasLegalStatusOfAllMembersOf');
    /**
     ...
     * @range       rico:RecordSet
     */
    isOrWasLegalStatusOfSomeMembersOf = this.toIri().concat('isOrWasLegalStatusOfSomeMembersOf');
    /**
     ...
     * @range       rico:Thing
     */
    isOrWasLocationOf = this.toIri().concat('isOrWasLocationOf');
    /**
     ...
     * @range       rico:RecordResource
     */
    isOrWasMainSubjectOf = this.toIri().concat('isOrWasMainSubjectOf');
    /**
     ...
     * @range       rico:Instantiation or rico:RecordResource
     */
    isOrWasManagerOf = this.toIri().concat('isOrWasManagerOf');
    /**
     ...
     * @range       rico:Group
     */
    isOrWasMemberOf = this.toIri().concat('isOrWasMemberOf');
    /**
     ...
     * @range       rico:Thing
     */
    isOrWasNameOf = this.toIri().concat('isOrWasNameOf');
    /**
     ...
     * @range       rico:Person
     */
    isOrWasOccupationTypeOf = this.toIri().concat('isOrWasOccupationTypeOf');
    /**
     ...
     * @range       rico:Person
     */
    isOrWasOccupiedBy = this.toIri().concat('isOrWasOccupiedBy');
    /**
     ...
     * @range       rico:Thing
     */
    isOrWasOwnerOf = this.toIri().concat('isOrWasOwnerOf');
    /**
     ...
     * @range       rico:Thing
     */
    isOrWasPartOf = this.toIri().concat('isOrWasPartOf');
    /**
     ...
     * @range       rico:Event
     */
    isOrWasParticipantIn = this.toIri().concat('isOrWasParticipantIn');
    /**
     ...
     * @range       rico:Agent
     */
    isOrWasPerformedBy = this.toIri().concat('isOrWasPerformedBy');
    /**
     ...
     * @range       rico:Place
     */
    isOrWasPhysicalLocationOf = this.toIri().concat('isOrWasPhysicalLocationOf');
    /**
     ...
     * @range       rico:Place
     */
    isOrWasPlaceNameOf = this.toIri().concat('isOrWasPlaceNameOf');
    /**
     ...
     * @range       rico:Place
     */
    isOrWasPlaceTypeOf = this.toIri().concat('isOrWasPlaceTypeOf');
    /**
     ...
     * @range       rico:RecordSet
     */
    isOrWasRecordStateOfAllMembersOf = this.toIri().concat('isOrWasRecordStateOfAllMembersOf');
    /**
     ...
     * @range       rico:RecordSet
     */
    isOrWasRecordStateOfSomeMembersOf = this.toIri().concat('isOrWasRecordStateOfSomeMembersOf');
    /**
     ...
     * @range       rico:Rule
     */
    isOrWasRegulatedBy = this.toIri().concat('isOrWasRegulatedBy');
    /**
     ...
     * @range       rico:Rule
     */
    isOrWasResponsibleForEnforcing = this.toIri().concat('isOrWasResponsibleForEnforcing');
    /**
     ...
     * @range       rico:Rule
     */
    isOrWasRuleTypeOf = this.toIri().concat('isOrWasRuleTypeOf');
    /**
     ...
     * @range       rico:Group
     */
    isOrWasSubdivisionOf = this.toIri().concat('isOrWasSubdivisionOf');
    /**
     ...
     * @range       rico:Event
     */
    isOrWasSubeventOf = this.toIri().concat('isOrWasSubeventOf');
    /**
     ...
     * @range       rico:RecordResource
     */
    isOrWasSubjectOf = this.toIri().concat('isOrWasSubjectOf');
    /**
     ...
     * @range       rico:Agent
     */
    isOrWasSubordinateTo = this.toIri().concat('isOrWasSubordinateTo');
    /**
     ...
     */
    isOrWasTitleOf = this.toIri().concat('isOrWasTitleOf');
    /**
     ...
     * @range       rico:Agent
     */
    isOrWasUnderAuthorityOf = this.toIri().concat('isOrWasUnderAuthorityOf');
    /**
     ...
     * @range       rico:Record or rico:RecordPart
     */
    isOriginalOf = this.toIri().concat('isOriginalOf');
    /**
     ...
     * @range       rico:Thing
     */
    isPlaceAssociatedWith = this.toIri().concat('isPlaceAssociatedWith');
    /**
     ...
     * @range       rico:Instantiation
     */
    isProductionTechniqueTypeOf = this.toIri().concat('isProductionTechniqueTypeOf');
    /**
     ...
     * @range       rico:Instantiation or rico:RecordResource
     */
    isProvenanceOf = this.toIri().concat('isProvenanceOf');
    /**
     ...
     * @range       rico:RecordResource
     */
    isPublisherOf = this.toIri().concat('isPublisherOf');
    /**
     ...
     * @range       rico:Instantiation or rico:RecordResource
     */
    isReceiverOf = this.toIri().concat('isReceiverOf');
    /**
     ...
     * @range       rico:RecordResource
     */
    isRecordResourceAssociatedWithRecordResource = this.toIri().concat('isRecordResourceAssociatedWithRecordResource');
    /**
     ...
     * @range       rico:RecordSet
     */
    isRecordSetTypeOf = this.toIri().concat('isRecordSetTypeOf');
    /**
     ...
     * @range       rico:Record or rico:RecordPart
     */
    isRecordStateOf = this.toIri().concat('isRecordStateOf');
    /**
     ...
     * @range       rico:Thing
     */
    isRelatedTo = this.toIri().concat('isRelatedTo');
    /**
     ...
     * @range       rico:RecordResource
     */
    isReplyTo = this.toIri().concat('isReplyTo');
    /**
     ...
     * @range       rico:Instantiation
     */
    isRepresentationTypeOf = this.toIri().concat('isRepresentationTypeOf');
    /**
     ...
     * @range       rico:Rule
     */
    isResponsibleForIssuing = this.toIri().concat('isResponsibleForIssuing');
    /**
     ...
     * @range       rico:Thing
     */
    isRuleAssociatedWith = this.toIri().concat('isRuleAssociatedWith');
    /**
     ...
     * @range       rico:Instantiation or rico:RecordResource
     */
    isSenderOf = this.toIri().concat('isSenderOf');
    /**
     ...
     */
    isSourceOf = this.toIri().concat('isSourceOf');
    /**
     ...
     * @range       rico:Agent
     */
    isSuccessorOf = this.toIri().concat('isSuccessorOf');
    /**
     ...
     * @range       rico:Appellation
     */
    isToUseDateOf = this.toIri().concat('isToUseDateOf');
    /**
     ...
     * @range       rico:Extent
     */
    isUnitOfMeasurementOf = this.toIri().concat('isUnitOfMeasurementOf');
    /**
     ...
     * @range       rico:Agent
     */
    issuedBy = this.toIri().concat('issuedBy');
    /**
     ...
     * @range       rico:Person
     */
    knowingOfRelationHasSource = this.toIri().concat('knowingOfRelationHasSource');
    /**
     ...
     * @range       rico:Person
     */
    knowingOfRelationHasTarget = this.toIri().concat('knowingOfRelationHasTarget');
    /**
     ...
     * @range       rico:Person
     */
    knowingRelationConnects = this.toIri().concat('knowingRelationConnects');
    /**
     ...
     * @range       rico:Person
     */
    knownBy = this.toIri().concat('knownBy');
    /**
     ...
     * @range       rico:Person
     */
    knowsOf = this.toIri().concat('knowsOf');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    lastModificationDate = this.toIri().concat('lastModificationDate');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    latitude = this.toIri().concat('latitude');
    /**
     ...
     * @range       rico:Person
     */
    leadershipRelationHasSource = this.toIri().concat('leadershipRelationHasSource');
    /**
     ...
     * @range       rico:Group
     */
    leadershipRelationHasTarget = this.toIri().concat('leadershipRelationHasTarget');
    /**
     ...
     * @range       rico:Position
     */
    leadershipWithPosition = this.toIri().concat('leadershipWithPosition');
    /**
     ...
     * @range       rico:Agent
     */
    managementRelationHasSource = this.toIri().concat('managementRelationHasSource');
    /**
     ...
     * @range       rico:Instantiation or rico:RecordResource
     */
    managementRelationHasTarget = this.toIri().concat('managementRelationHasTarget');
    /**
     ...
     * @range       rico:MandateRelation
     */
    mandateIsSourceOfMandateRelation = this.toIri().concat('mandateIsSourceOfMandateRelation');
    /**
     ...
     * @range       rico:Mandate
     */
    mandateRelationHasSource = this.toIri().concat('mandateRelationHasSource');
    /**
     ...
     * @range       rico:Agent
     */
    mandateRelationHasTarget = this.toIri().concat('mandateRelationHasTarget');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    measure = this.toIri().concat('measure');
    /**
     ...
     * @range       rico:Group
     */
    membershipRelationHasSource = this.toIri().concat('membershipRelationHasSource');
    /**
     ...
     * @range       rico:Person
     */
    membershipRelationHasTarget = this.toIri().concat('membershipRelationHasTarget');
    /**
     ...
     * @range       rico:Position
     */
    membershipWithPosition = this.toIri().concat('membershipWithPosition');
    /**
     ...
     * @range       rico:Instantiation
     */
    migratedFrom = this.toIri().concat('migratedFrom');
    /**
     ...
     * @range       rico:Instantiation
     */
    migratedInto = this.toIri().concat('migratedInto');
    /**
     ...
     * @range       rico:Instantiation
     */
    migrationRelationHasSource = this.toIri().concat('migrationRelationHasSource');
    /**
     ...
     * @range       rico:Instantiation
     */
    migrationRelationHasTarget = this.toIri().concat('migrationRelationHasTarget');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    modificationDate = this.toIri().concat('modificationDate');
    /**
     * **[rico:name](https://www.ica.org/standards/RiC/ontology#name)**
     *
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    normalizedDateValue = this.toIri().concat('normalizedDateValue');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    normalizedValue = this.toIri().concat('normalizedValue');
    /**
     ...
     * @range       rico:Position
     */
    occupiesOrOccupied = this.toIri().concat('occupiesOrOccupied');
    /**
     ...
     * @range       rico:Place
     */
    overlapsOrOverlapped = this.toIri().concat('overlapsOrOverlapped');
    /**
     ...
     * @range       rico:Group or rico:Person or rico:Position
     */
    ownershipRelationHasSource = this.toIri().concat('ownershipRelationHasSource');
    /**
     ...
     * @range       rico:Thing
     */
    ownershipRelationHasTarget = this.toIri().concat('ownershipRelationHasTarget');
    /**
     ...
     * @range       rico:Activity
     */
    performanceRelationHasSource = this.toIri().concat('performanceRelationHasSource');
    /**
     ...
     * @range       rico:Agent
     */
    performanceRelationHasTarget = this.toIri().concat('performanceRelationHasTarget');
    /**
     ...
     * @range       rico:Activity
     */
    performsOrPerformed = this.toIri().concat('performsOrPerformed');
    /**
     ...
     */
    personHasCorrespondenceRelation = this.toIri().concat('personHasCorrespondenceRelation');
    /**
     ...
     */
    personHasFamilyRelation = this.toIri().concat('personHasFamilyRelation');
    /**
     ...
     */
    personHasKnowingRelation = this.toIri().concat('personHasKnowingRelation');
    /**
     ...
     */
    personHasSiblingRelation = this.toIri().concat('personHasSiblingRelation');
    /**
     ...
     */
    personHasSpouseRelation = this.toIri().concat('personHasSpouseRelation');
    /**
     ...
     */
    personIsSourceOfChildRelation = this.toIri().concat('personIsSourceOfChildRelation');
    /**
     ...
     */
    personIsSourceOfDescendanceRelation = this.toIri().concat('personIsSourceOfDescendanceRelation');
    /**
     ...
     */
    personIsSourceOfKnowingOfRelation = this.toIri().concat('personIsSourceOfKnowingOfRelation');
    /**
     ...
     * @range       rico:LeadershipRelation
     */
    personIsSourceOfLeadershipRelation = this.toIri().concat('personIsSourceOfLeadershipRelation');
    /**
     ...
     */
    personIsSourceOfPositionHoldingRelation = this.toIri().concat('personIsSourceOfPositionHoldingRelation');
    /**
     ...
     */
    personIsSourceOfTeachingRelation = this.toIri().concat('personIsSourceOfTeachingRelation');
    /**
     ...
     * @range       rico:ChildRelation
     */
    personIsTargetOfChildRelation = this.toIri().concat('personIsTargetOfChildRelation');
    /**
     ...
     * @range       rico:DescendanceRelation
     */
    personIsTargetOfDescendanceRelation = this.toIri().concat('personIsTargetOfDescendanceRelation');
    /**
     ...
     * @range       rico:KnowingOfRelation
     */
    personIsTargetOfKnowingOfRelation = this.toIri().concat('personIsTargetOfKnowingOfRelation');
    /**
     ...
     * @range       rico:MembershipRelation
     */
    personIsTargetOfMembershipRelation = this.toIri().concat('personIsTargetOfMembershipRelation');
    /**
     ...
     * @range       rico:TeachingRelation
     */
    personIsTargetOfTeachingRelation = this.toIri().concat('personIsTargetOfTeachingRelation');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    physicalCharacteristics = this.toIri().concat('physicalCharacteristics');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    physicalOrLogicalExtent = this.toIri().concat('physicalOrLogicalExtent');
    /**
     ...
     */
    placeIsSourceOfPlaceRelation = this.toIri().concat('placeIsSourceOfPlaceRelation');
    /**
     ...
     * @range       rico:Place
     */
    placeRelationHasSource = this.toIri().concat('placeRelationHasSource');
    /**
     ...
     * @range       rico:Thing
     */
    placeRelationHasTarget = this.toIri().concat('placeRelationHasTarget');
    /**
     ...
     * @range       rico:Person
     */
    positionHoldingRelationHasSource = this.toIri().concat('positionHoldingRelationHasSource');
    /**
     ...
     * @range       rico:Position
     */
    positionHoldingRelationHasTarget = this.toIri().concat('positionHoldingRelationHasTarget');
    /**
     ...
     * @range       rico:LeadershipRelation
     */
    positionIsContextOfLeadershipRelation = this.toIri().concat('positionIsContextOfLeadershipRelation');
    /**
     ...
     * @range       rico:MembershipRelation
     */
    positionIsContextOfMembershipRelation = this.toIri().concat('positionIsContextOfMembershipRelation');
    /**
     ...
     * @range       rico:PositionToGroupRelation
     */
    positionIsSourceOfPositionToGroupRelation = this.toIri().concat('positionIsSourceOfPositionToGroupRelation');
    /**
     ...
     * @range       rico:PositionHoldingRelation
     */
    positionIsTargetOfPositionHoldingRelation = this.toIri().concat('positionIsTargetOfPositionHoldingRelation');
    /**
     ...
     * @range       rico:Position
     */
    positionToGroupRelationHasSource = this.toIri().concat('positionToGroupRelationHasSource');
    /**
     ...
     * @range       rico:Group
     */
    positionToGroupRelationHasTarget = this.toIri().concat('positionToGroupRelationHasTarget');
    /**
     ...
     * @range       rico:Thing
     */
    precedesInTime = this.toIri().concat('precedesInTime');
    /**
     ...
     * @range       rico:Thing
     */
    precedesOrPreceded = this.toIri().concat('precedesOrPreceded');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    productionTechnique = this.toIri().concat('productionTechnique');
    /**
     ...
     * @range       rico:Instantiation or rico:RecordResource
     */
    provenanceRelationHasSource = this.toIri().concat('provenanceRelationHasSource');
    /**
     ...
     */
    provenanceRelationHasTarget = this.toIri().concat('provenanceRelationHasTarget');
    /**
     ...
     * @range       rico:RecordResource
     */
    proxyFor = this.toIri().concat('proxyFor');
    /**
     ...
     * @range       rico:RecordSet
     */
    proxyIn = this.toIri().concat('proxyIn');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    publicationDate = this.toIri().concat('publicationDate');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    qualityOfRepresentation = this.toIri().concat('qualityOfRepresentation');
    /**
     ...
     * @range       rico:AuthorshipRelation
     */
    recordIsSourceOfAuthorshipRelation = this.toIri().concat('recordIsSourceOfAuthorshipRelation');
    /**
     * **[rico:Record Resource extent](https://www.ica.org/standards/RiC/ontology#recordResourceExtent)**
     *
     ...
     * @range       rico:RecordResource
     */
    recordResourceGeneticRelationConnects = this.toIri().concat('recordResourceGeneticRelationConnects');
    /**
     ...
     * @range       rico:Agent
     */
    recordResourceHoldingRelationHasSource = this.toIri().concat('recordResourceHoldingRelationHasSource');
    /**
     ...
     * @range       rico:Instantiation or rico:RecordResource
     */
    recordResourceHoldingRelationHasTarget = this.toIri().concat('recordResourceHoldingRelationHasTarget');
    /**
     ...
     */
    recordResourceIsConnectedToRecordResourceGeneticRelation = this.toIri().concat('recordResourceIsConnectedToRecordResourceGeneticRelation');
    /**
     ...
     */
    recordResourceIsConnectedToRecordResourceRelation = this.toIri().concat('recordResourceIsConnectedToRecordResourceRelation');
    /**
     ...
     * @range       rico:RecordResourceToInstantiationRelation
     */
    recordResourceIsSourceOfRecordResourceToInstantiationRelation = this.toIri().concat('recordResourceIsSourceOfRecordResourceToInstantiationRelation');
    /**
     ...
     * @range       rico:AccumulationRelation
     */
    recordResourceOrInstantiationIsSourceOfAccumulationRelation = this.toIri().concat('recordResourceOrInstantiationIsSourceOfAccumulationRelation');
    /**
     ...
     * @range       rico:ActivityDocumentationRelation
     */
    recordResourceOrInstantiationIsSourceOfActivityDocumentationRelation = this.toIri().concat('recordResourceOrInstantiationIsSourceOfActivityDocumentationRelation');
    /**
     ...
     * @range       rico:AgentOriginationRelation
     */
    recordResourceOrInstantiationIsSourceOfAgentOriginationRelation = this.toIri().concat('recordResourceOrInstantiationIsSourceOfAgentOriginationRelation');
    /**
     ...
     * @range       rico:CreationRelation
     */
    recordResourceOrInstantiationIsSourceOfCreationRelation = this.toIri().concat('recordResourceOrInstantiationIsSourceOfCreationRelation');
    /**
     ...
     * @range       rico:ProvenanceRelation
     */
    recordResourceOrInstantiationIsSourceOfProvenanceRelation = this.toIri().concat('recordResourceOrInstantiationIsSourceOfProvenanceRelation');
    /**
     ...
     * @range       rico:IntellectualPropertyRightsRelation
     */
    recordResourceOrInstantiationIsTargetOfIntellectualPropertyRightsRelation = this.toIri().concat('recordResourceOrInstantiationIsTargetOfIntellectualPropertyRightsRelation');
    /**
     ...
     * @range       rico:ManagementRelation
     */
    recordResourceOrInstantiationIsTargetOfManagementRelation = this.toIri().concat('recordResourceOrInstantiationIsTargetOfManagementRelation');
    /**
     ...
     * @range       rico:RecordResourceHoldingRelation
     */
    recordResourceOrInstantiationIsTargetOfRecordResourceHoldingRelation = this.toIri().concat('recordResourceOrInstantiationIsTargetOfRecordResourceHoldingRelation');
    /**
     ...
     * @range       rico:RecordResource
     */
    recordResourceRelationConnects = this.toIri().concat('recordResourceRelationConnects');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    recordResourceStructure = this.toIri().concat('recordResourceStructure');
    /**
     ...
     * @range       rico:RecordResource
     */
    recordResourceToInstantiationRelationHasSource = this.toIri().concat('recordResourceToInstantiationRelationHasSource');
    /**
     ...
     * @range       rico:Instantiation
     */
    recordResourceToInstantiationRelationHasTarget = this.toIri().concat('recordResourceToInstantiationRelationHasTarget');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    referenceSystem = this.toIri().concat('referenceSystem');
    /**
     ...
     * @range       rico:Thing
     */
    regulatesOrRegulated = this.toIri().concat('regulatesOrRegulated');
    /**
     ...
     * @range       rico:Thing
     */
    relationConnects = this.toIri().concat('relationConnects');
    /**
     ...
     * @range       rico:Thing
     */
    relationHasContext = this.toIri().concat('relationHasContext');
    /**
     ...
     * @range       rico:Thing
     */
    relationHasSource = this.toIri().concat('relationHasSource');
    /**
     ...
     * @range       rico:Thing
     */
    relationHasTarget = this.toIri().concat('relationHasTarget');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    relationState = this.toIri().concat('relationState');
    /**
     ...
     * @range       rico:Event
     */
    resultsOrResultedFrom = this.toIri().concat('resultsOrResultedFrom');
    /**
     ...
     * @range       rico:Thing
     */
    resultsOrResultedIn = this.toIri().concat('resultsOrResultedIn');
    /**
     ...
     * @range       rico:CreationRelation
     */
    roleIsContextOfCreationRelation = this.toIri().concat('roleIsContextOfCreationRelation');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    ruleFollowed = this.toIri().concat('ruleFollowed');
    /**
     ...
     */
    ruleIsSourceOfRuleRelation = this.toIri().concat('ruleIsSourceOfRuleRelation');
    /**
     ...
     * @range       rico:Rule
     */
    ruleRelationHasSource = this.toIri().concat('ruleRelationHasSource');
    /**
     ...
     * @range       rico:Thing
     */
    ruleRelationHasTarget = this.toIri().concat('ruleRelationHasTarget');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    scopeAndContent = this.toIri().concat('scopeAndContent');
    /**
     ...
     * @range       rico:Thing
     */
    sequentialRelationHasSource = this.toIri().concat('sequentialRelationHasSource');
    /**
     ...
     * @range       rico:Thing
     */
    sequentialRelationHasTarget = this.toIri().concat('sequentialRelationHasTarget');
    /**
     ...
     * @range       rico:Person
     */
    siblingRelationConnects = this.toIri().concat('siblingRelationConnects');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    source = this.toIri().concat('source');
    /**
     ...
     * @range       rico:Person
     */
    spouseRelationConnects = this.toIri().concat('spouseRelationConnects');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    structure = this.toIri().concat('structure');
    /**
     ...
     * @range       rico:Person
     */
    teachingRelationHasSource = this.toIri().concat('teachingRelationHasSource');
    /**
     ...
     * @range       rico:Person
     */
    teachingRelationHasTarget = this.toIri().concat('teachingRelationHasTarget');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    technicalCharacteristics = this.toIri().concat('technicalCharacteristics');
    /**
     ...
     * @range       rico:Thing
     */
    temporalRelationHasSource = this.toIri().concat('temporalRelationHasSource');
    /**
     ...
     * @range       rico:Thing
     */
    temporalRelationHasTarget = this.toIri().concat('temporalRelationHasTarget');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    textualValue = this.toIri().concat('textualValue');
    /**
     ...
     * @range       rico:Relation
     */
    thingIsConnectedToRelation = this.toIri().concat('thingIsConnectedToRelation');
    /**
     ...
     * @range       rico:Relation
     */
    thingIsContextOfRelation = this.toIri().concat('thingIsContextOfRelation');
    /**
     ...
     * @range       rico:Relation
     */
    thingIsSourceOfRelation = this.toIri().concat('thingIsSourceOfRelation');
    /**
     ...
     */
    thingIsSourceOfSequentialRelation = this.toIri().concat('thingIsSourceOfSequentialRelation');
    /**
     ...
     */
    thingIsSourceOfTemporalRelation = this.toIri().concat('thingIsSourceOfTemporalRelation');
    /**
     ...
     */
    thingIsSourceOfWholePartRelation = this.toIri().concat('thingIsSourceOfWholePartRelation');
    /**
     ...
     * @range       rico:AppellationRelation
     */
    thingIsTargetOfAppellationRelation = this.toIri().concat('thingIsTargetOfAppellationRelation');
    /**
     ...
     * @range       rico:AuthorityRelation
     */
    thingIsTargetOfAuthorityRelation = this.toIri().concat('thingIsTargetOfAuthorityRelation');
    /**
     ...
     * @range       rico:EventRelation
     */
    thingIsTargetOfEventRelation = this.toIri().concat('thingIsTargetOfEventRelation');
    /**
     ...
     * @range       rico:OwnershipRelation
     */
    thingIsTargetOfOwnershipRelation = this.toIri().concat('thingIsTargetOfOwnershipRelation');
    /**
     ...
     * @range       rico:PlaceRelation
     */
    thingIsTargetOfPlaceRelation = this.toIri().concat('thingIsTargetOfPlaceRelation');
    /**
     ...
     * @range       rico:Relation
     */
    thingIsTargetOfRelation = this.toIri().concat('thingIsTargetOfRelation');
    /**
     ...
     * @range       rico:RuleRelation
     */
    thingIsTargetOfRuleRelation = this.toIri().concat('thingIsTargetOfRuleRelation');
    /**
     ...
     * @range       rico:SequentialRelation
     */
    thingIsTargetOfSequentialRelation = this.toIri().concat('thingIsTargetOfSequentialRelation');
    /**
     ...
     * @range       rico:TemporalRelation
     */
    thingIsTargetOfTemporalRelation = this.toIri().concat('thingIsTargetOfTemporalRelation');
    /**
     ...
     */
    thingIsTargetOfTypeRelation = this.toIri().concat('thingIsTargetOfTypeRelation');
    /**
     ...
     * @range       rico:WholePartRelation
     */
    thingIsTargetOfWholePartRelation = this.toIri().concat('thingIsTargetOfWholePartRelation');
    /**
     * **[rico:title](https://www.ica.org/standards/RiC/ontology#title)**
     *
     ...
     * @range       rico:TypeRelation
     */
    typeIsSourceOfTypeRelation = this.toIri().concat('typeIsSourceOfTypeRelation');
    /**
     ...
     * @range       rico:Type
     */
    typeRelationHasSource = this.toIri().concat('typeRelationHasSource');
    /**
     ...
     * @range       rico:Thing
     */
    typeRelationHasTarget = this.toIri().concat('typeRelationHasTarget');
    /**
     * **[rico:unit of measurement](https://www.ica.org/standards/RiC/ontology#unitOfMeasurement)**
     *
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    usedFromDate = this.toIri().concat('usedFromDate');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Literal
     */
    usedToDate = this.toIri().concat('usedToDate');
    /**
     ...
     * @range       rico:Date
     */
    wasLastUpdatedAtDate = this.toIri().concat('wasLastUpdatedAtDate');
    /**
     ...
     * @range       rico:Date
     */
    wasUsedFromDate = this.toIri().concat('wasUsedFromDate');
    /**
     ...
     * @range       rico:Date
     */
    wasUsedToDate = this.toIri().concat('wasUsedToDate');
    /**
     ...
     * @range       rico:Thing
     */
    wholePartRelationHasSource = this.toIri().concat('wholePartRelationHasSource');
    /**
     ...
     * @range       rico:Thing
     */
    wholePartRelationHasTarget = this.toIri().concat('wholePartRelationHasTarget');
    /**
     ...
     * @range       rico:Agent
     */
    workRelationConnects = this.toIri().concat('workRelationConnects');
}
/**
