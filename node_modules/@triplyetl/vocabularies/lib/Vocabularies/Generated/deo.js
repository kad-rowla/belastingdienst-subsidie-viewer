...
class Vocabulary extends VocabularyBase {
     ...
     */
    Acknowledgements = this.toIri().concat('Acknowledgements');
    /**
     ...
     * @parent      deo:DiscourseElement
     */
    AuthorContribution = this.toIri().concat('AuthorContribution');
    /**
     ...
     * @parent      deo:DiscourseElement
     */
    Background = this.toIri().concat('Background');
    /**
     ...
     */
    BibliographicReference = this.toIri().concat('BibliographicReference');
    /**
     ...
     * @parent      deo:DiscourseElement
     */
    Caption = this.toIri().concat('Caption');
    /**
     ...
     * @parent      deo:DiscourseElement
     */
    Conclusion = this.toIri().concat('Conclusion');
    /**
     ...
     * @parent      deo:DiscourseElement
     */
    Contribution = this.toIri().concat('Contribution');
    /**
     ...
     */
    DatasetDescription = this.toIri().concat('DatasetDescription');
    /**
     ...
     * @parent      deo:DiscourseElement
     */
    Dedication = this.toIri().concat('Dedication');
    /**
     ...
     */
    DiscourseElement = this.toIri().concat('DiscourseElement');
    /**
     ...
     * @parent      deo:DiscourseElement
     */
    Discussion = this.toIri().concat('Discussion');
    /**
     ...
     * @parent      deo:DiscourseElement
     */
    Epilogue = this.toIri().concat('Epilogue');
    /**
     ...
     * @parent      deo:DiscourseElement
     */
    Evaluation = this.toIri().concat('Evaluation');
    /**
     ...
     */
    ExternalResourceDescription = this.toIri().concat('ExternalResourceDescription');
    /**
     ...
     * @parent      deo:DiscourseElement
     */
    FutureWork = this.toIri().concat('FutureWork');
    /**
     ...
     * @parent      deo:DiscourseElement
     */
    Introduction = this.toIri().concat('Introduction');
    /**
     ...
     * @parent      deo:Caption
     */
    Legend = this.toIri().concat('Legend');
    /**
     ...
     * @parent      deo:DiscourseElement
     */
    Materials = this.toIri().concat('Materials');
    /**
     ...
     * @parent      deo:DiscourseElement
     */
    Methods = this.toIri().concat('Methods');
    /**
     ...
     * @parent      deo:DiscourseElement
     */
    Motivation = this.toIri().concat('Motivation');
    /**
     ...
     * @parent      deo:DiscourseElement
     */
    Postscript = this.toIri().concat('Postscript');
    /**
     ...
     * @parent      deo:DiscourseElement
     */
    ProblemStatement = this.toIri().concat('ProblemStatement');
    /**
     ...
     * @parent      deo:DiscourseElement
     */
    Prologue = this.toIri().concat('Prologue');
    /**
     ...
     * @parent      deo:DiscourseElement
     */
    RelatedWork = this.toIri().concat('RelatedWork');
    /**
     ...
     * @parent      deo:DiscourseElement
     */
    Results = this.toIri().concat('Results');
    /**
     ...
     * @parent      deo:DiscourseElement
     */
    Scenario = this.toIri().concat('Scenario');
    /**
     ...
     * @parent      deo:ExternalResourceDescription
     */
    SupplementaryInformationDescription = this.toIri().concat('SupplementaryInformationDescription');
}
/**
 ...
 * Version: 2015-07-03
 */
const deo = new Vocabulary('http://purl.org/spar/deo/');
export default deo;
