...
class Vocabulary extends VocabularyBase {
     ...
     *
     * @type        class
     * @parent      fabio:Expression
     */
    Abstract = this.toIri().concat('Abstract');
    /**
     * **[fabio:academic proceedings](http://purl.org/spar/fabio/AcademicProceedings)**
     *
     * A document containing the programme and collected papers, or their abstracts, presented at an academic meeting.
     *
     * @type        class
     * @parent      fabio:ExpressionCollection
     */
    AcademicProceedings = this.toIri().concat('AcademicProceedings');
    /**
     * **[fabio:addendum](http://purl.org/spar/fabio/Addendum)**
     *
     ...
     * @parent      fabio:Expression
     */
    Addendum = this.toIri().concat('Addendum');
    /**
     * **[fabio:algorithm](http://purl.org/spar/fabio/Algorithm)**
     *
     ...
     *
     * @type        class
     * @parent      fabio:Specification
     */
    Algorithm = this.toIri().concat('Algorithm');
    /**
     * **[fabio:analog item](http://purl.org/spar/fabio/AnalogItem)**
     *
     ...
     * @parent      fabio:Item
     */
    AnalogItem = this.toIri().concat('AnalogItem');
    /**
     * **[fabio:analog manifestation](http://purl.org/spar/fabio/AnalogManifestation)**
     *
     * A manifestation in an analog form.
     *
     * @type        class
     * @parent      fabio:Manifestation
     */
    AnalogManifestation = this.toIri().concat('AnalogManifestation');
    /**
     * **[fabio:analog storage medium](http://purl.org/spar/fabio/AnalogStorageMedium)**
     *
     ...
     *
     * @type        class
     * @parent      fabio:StorageMedium
     */
    AnalogStorageMedium = this.toIri().concat('AnalogStorageMedium');
    /**
     * **[fabio:announcement](http://purl.org/spar/fabio/Announcement)**
     *
     ...
     * @parent      fabio:Work
     */
    Announcement = this.toIri().concat('Announcement');
    /**
     * **[fabio:anthology](http://purl.org/spar/fabio/Anthology)**
     *
     ...
     * @parent      fabio:ExpressionCollection
     */
    Anthology = this.toIri().concat('Anthology');
    /**
     * **[fabio:application profile](http://purl.org/spar/fabio/ApplicationProfile)**
     *
     ...
     *
     * @type        class
     * @parent      fabio:Metadata
     */
    ApplicationProfile = this.toIri().concat('ApplicationProfile');
    /**
     * **[fabio:API](http://purl.org/spar/fabio/ApplicationProgrammingInterface)**
     *
     ...
     *
     * @type        class
     * @parent      fabio:ComputerProgram
     */
    ApplicationProgrammingInterface = this.toIri().concat('ApplicationProgrammingInterface');
    /**
     * **[fabio:archival document](http://purl.org/spar/fabio/ArchivalDocument)**
     *
     ...
     * @parent      fabio:Expression
     */
    ArchivalDocument = this.toIri().concat('ArchivalDocument');
    /**
     * **[fabio:archival document set](http://purl.org/spar/fabio/ArchivalDocumentSet)**
     *
     ...
     * @parent      fabio:ExpressionCollection
     */
    ArchivalDocumentSet = this.toIri().concat('ArchivalDocumentSet');
    /**
     * **[fabio:archival record](http://purl.org/spar/fabio/ArchivalRecord)**
     *
     ...
     * @parent      fabio:Work
     */
    ArchivalRecord = this.toIri().concat('ArchivalRecord');
    /**
     * **[fabio:archival record set](http://purl.org/spar/fabio/ArchivalRecordSet)**
     *
     * A collection of archival records.
     *
     * @type        class
     * @parent      fabio:WorkCollection
     */
    ArchivalRecordSet = this.toIri().concat('ArchivalRecordSet');
    /**
     * **[fabio:article](http://purl.org/spar/fabio/Article)**
     *
     ...
     * @parent      fabio:Expression
     */
    Article = this.toIri().concat('Article');
    /**
     * **[fabio:artistic work](http://purl.org/spar/fabio/ArtisticWork)**
     *
     ...
     * @parent      fabio:Work
     */
    ArtisticWork = this.toIri().concat('ArtisticWork');
    /**
     * **[fabio:audio document](http://purl.org/spar/fabio/AudioDocument)**
     *
     ...
     * @parent      fabio:Expression
     */
    AudioDocument = this.toIri().concat('AudioDocument');
    /**
     * **[fabio:authority file](http://purl.org/spar/fabio/AuthorityFile)**
     *
     ...
     *
     * @type        class
     * @parent      fabio:ControlledVocabulary
     */
    AuthorityFile = this.toIri().concat('AuthorityFile');
    /**
     * **[fabio:bachelor's thesis](http://purl.org/spar/fabio/BachelorsThesis)**
     *
     ...
     * @parent      fabio:Thesis
     */
    BachelorsThesis = this.toIri().concat('BachelorsThesis');
    /**
     * **[fabio:bibliographic database](http://purl.org/spar/fabio/BibliographicDatabase)**
     *
     ...
     *
     * @type        class
     * @parent      fabio:Database
     */
    BibliographicDatabase = this.toIri().concat('BibliographicDatabase');
    /**
     * **[fabio:bibliographic metadata](http://purl.org/spar/fabio/BibliographicMetadata)**
     *
     ...
     * @parent      fabio:Metadata
     */
    BibliographicMetadata = this.toIri().concat('BibliographicMetadata');
    /**
     * **[fabio:biography](http://purl.org/spar/fabio/Biography)**
     *
    ...
    /**
     * **[fabio:blog](http://purl.org/spar/fabio/Blog)**
     *
     * A Web publication medium containing blog posts.
     *
     * @type        class
     * @parent      fabio:WebManifestation
     */
    Blog = this.toIri().concat('Blog');
    /**
     * **[fabio:blog post](http://purl.org/spar/fabio/BlogPost)**
     *
     ...
     * @parent      fabio:Entry
     */
    BlogPost = this.toIri().concat('BlogPost');
    /**
     * **[fabio:book](http://purl.org/spar/fabio/Book)**
     *
     ...
     * @parent      fabio:Expression
     */
    Book = this.toIri().concat('Book');
    /**
     * **[fabio:book chapter](http://purl.org/spar/fabio/BookChapter)**
     *
     * A defined chapter of a book, usually with a separate title or number.
     *
     * @type        class
     * @parent      fabio:Chapter
     */
    BookChapter = this.toIri().concat('BookChapter');
    /**
     * **[fabio:book review](http://purl.org/spar/fabio/BookReview)**
     *
     ...
     * @parent      fabio:Review
     */
    BookReview = this.toIri().concat('BookReview');
    /**
     * **[fabio:book series](http://purl.org/spar/fabio/BookSeries)**
     *
     ...
     * @parent      fabio:Series
     */
    BookSeries = this.toIri().concat('BookSeries');
    /**
     * **[fabio:book set](http://purl.org/spar/fabio/BookSet)**
     *
     ...
     * @parent      fabio:ExpressionCollection
     */
    BookSet = this.toIri().concat('BookSet');
    /**
     * **[fabio:brief report](http://purl.org/spar/fabio/BriefReport)**
     *
     ...
     * @parent      fabio:Expression
     */
    BriefReport = this.toIri().concat('BriefReport');
    /**
     * **[fabio:call for applications](http://purl.org/spar/fabio/CallForApplications)**
     *
     ...
     * @parent      fabio:Expression
     */
    CallForApplications = this.toIri().concat('CallForApplications');
    /**
     * **[fabio:case for support](http://purl.org/spar/fabio/CaseForSupport)**
     *
     ...
     * @parent      fabio:Work
     */
    CaseForSupport = this.toIri().concat('CaseForSupport');
    /**
     * **[fabio:case for support document](http://purl.org/spar/fabio/CaseForSupportDocument)**
     *
     ...
     * @parent      fabio:Expression
     */
    CaseForSupportDocument = this.toIri().concat('CaseForSupportDocument');
    /**
     * **[fabio:case report](http://purl.org/spar/fabio/CaseReport)**
     *
     ...
     * @parent      fabio:Report
     */
    CaseReport = this.toIri().concat('CaseReport');
    /**
     * **[fabio:catalog](http://purl.org/spar/fabio/Catalog)**
     *
     ...
     * @parent      fabio:Specification
     */
    Catalog = this.toIri().concat('Catalog');
    /**
     * **[fabio:chapter](http://purl.org/spar/fabio/Chapter)**
     *
     ...
     * @parent      fabio:Expression
     */
    Chapter = this.toIri().concat('Chapter');
    /**
     * **[fabio:citation metadata](http://purl.org/spar/fabio/CitationMetadata)**
     *
     ...
     * @parent      fabio:Metadata
     */
    CitationMetadata = this.toIri().concat('CitationMetadata');
    /**
     * **[fabio:clinical case report](http://purl.org/spar/fabio/ClinicalCaseReport)**
     *
     ...
     *
     * @type        class
     * @parent      fabio:CaseReport
     */
    ClinicalCaseReport = this.toIri().concat('ClinicalCaseReport');
    /**
     * **[fabio:clinical guideline](http://purl.org/spar/fabio/ClinicalGuideline)**
     *
     ...
     *
     * @type        class
     * @parent      fabio:InstructionalWork
     */
    ClinicalGuideline = this.toIri().concat('ClinicalGuideline');
    /**
     * **[fabio:clinical trial design](http://purl.org/spar/fabio/ClinicalTrialDesign)**
     *
     ...
     * @parent      fabio:Specification
     */
    ClinicalTrialDesign = this.toIri().concat('ClinicalTrialDesign');
    /**
     * **[fabio:clinical trial report](http://purl.org/spar/fabio/ClinicalTrialReport)**
     *
     ...
     *
     * @type        class
     * @parent      fabio:TrialReport
     */
    ClinicalTrialReport = this.toIri().concat('ClinicalTrialReport');
    /**
     * **[fabio:collected works](http://purl.org/spar/fabio/CollectedWorks)**
     *
     * A collection of the literary or scholastic works of a single person.
     *
     * @type        class
     * @parent      fabio:Anthology
     */
    CollectedWorks = this.toIri().concat('CollectedWorks');
    /**
    ...
    /**
     * **[fabio:complete works](http://purl.org/spar/fabio/CompleteWorks)**
     *
     * A collection of all the literary or scholastic works of a single person.
     *
     * @type        class
     * @parent      fabio:CollectedWorks
     */
    CompleteWorks = this.toIri().concat('CompleteWorks');
    /**
     * **[fabio:computer application](http://purl.org/spar/fabio/ComputerApplication)**
     *
     ...
     * @parent      fabio:ComputerProgram
     */
    ComputerApplication = this.toIri().concat('ComputerApplication');
    /**
     * **[fabio:computer file](http://purl.org/spar/fabio/ComputerFile)**
     *
     * A digital item containing information in computer-readable form encoded in a particular format.
     *
     * @type        class
     * @parent      fabio:DigitalItem
     */
    ComputerFile = this.toIri().concat('ComputerFile');
    /**
     * **[fabio:computer program](http://purl.org/spar/fabio/ComputerProgram)**
     *
     ...
     * @parent      fabio:Expression
     */
    ComputerProgram = this.toIri().concat('ComputerProgram');
    /**
     * **[fabio:conference paper](http://purl.org/spar/fabio/ConferencePaper)**
     *
     ...
     *
     * @type        class
     * @parent      fabio:ProceedingsPaper
     */
    ConferencePaper = this.toIri().concat('ConferencePaper');
    /**
     * **[fabio:conference poster](http://purl.org/spar/fabio/ConferencePoster)**
     *
     ...
     * @parent      fabio:Expression
     */
    ConferencePoster = this.toIri().concat('ConferencePoster');
    /**
     * **[fabio:conference proceedings](http://purl.org/spar/fabio/ConferenceProceedings)**
     *
     ...
     *
     * @type        class
     * @parent      fabio:AcademicProceedings
     */
    ConferenceProceedings = this.toIri().concat('ConferenceProceedings');
    /**
     * **[fabio:controlled vocabulary](http://purl.org/spar/fabio/ControlledVocabulary)**
     *
     ...
     *
     * @type        class
     * @parent      fabio:Vocabulary
     */
    ControlledVocabulary = this.toIri().concat('ControlledVocabulary');
    /**
     * **[fabio:correction](http://purl.org/spar/fabio/Correction)**
     *
     ...
     * @parent      fabio:Work
     */
    Correction = this.toIri().concat('Correction');
    /**
     * **[fabio:corrigendum](http://purl.org/spar/fabio/Corrigendum)**
     *
     * A formal correction to an error introduced by the author into a previously published document.
     *
     * @type        class
     * @parent      fabio:Correction
     */
    Corrigendum = this.toIri().concat('Corrigendum');
    /**
     * **[fabio:cover](http://purl.org/spar/fabio/Cover)**
     *
     ...
     * @parent      fabio:Expression
     */
    Cover = this.toIri().concat('Cover');
    /**
     * **[fabio:critical edition](http://purl.org/spar/fabio/CriticalEdition)**
     *
     ...
     * @parent      fabio:Work
     */
    CriticalEdition = this.toIri().concat('CriticalEdition');
    /**
     * **[fabio:data file](http://purl.org/spar/fabio/DataFile)**
     *
     ...
     * @parent      fabio:Expression
     */
    DataFile = this.toIri().concat('DataFile');
    /**
     * **[fabio:data management policy](http://purl.org/spar/fabio/DataManagementPolicy)**
     *
     ...
     * @parent      fabio:Policy
     */
    DataManagementPolicy = this.toIri().concat('DataManagementPolicy');
    /**
     * **[fabio:data management policy document](http://purl.org/spar/fabio/DataManagementPolicyDocument)**
     *
     * A document embodying a policy that descibes and defines how data should be managed, preserved and shared.
     *
     * @type        class
     * @parent      fabio:PolicyDocument
     */
    DataManagementPolicyDocument = this.toIri().concat('DataManagementPolicyDocument');
    /**
     * **[fabio:data management plan](http://purl.org/spar/fabio/DataMangementPlan)**
     *
     ...
     * @parent      fabio:Expression
     */
    DataMangementPlan = this.toIri().concat('DataMangementPlan');
    /**
     * **[fabio:data repository](http://purl.org/spar/fabio/DataRepository)**
     *
     * A repository for storing data.
     *
     * @type        class
     * @parent      fabio:Repository
     */
    DataRepository = this.toIri().concat('DataRepository');
    /**
     * **[fabio:database](http://purl.org/spar/fabio/Database)**
     *
    ...
    /**
     * **[fabio:database management system](http://purl.org/spar/fabio/DatabaseManagementSystem)**
     *
     ...
     * @parent      fabio:ComputerProgram
     */
    DatabaseManagementSystem = this.toIri().concat('DatabaseManagementSystem');
    /**
     * **[fabio:dataset](http://purl.org/spar/fabio/Dataset)**
     *
    ...
    /**
     * **[fabio:definitive version](http://purl.org/spar/fabio/DefinitiveVersion)**
     *
     ...
     *
     * @type        class
     * @parent      fabio:Manuscript
     */
    DefinitiveVersion = this.toIri().concat('DefinitiveVersion');
    /**
     * **[fabio:demo paper](http://purl.org/spar/fabio/DemoPaper)**
     *
     ...
     * @parent      fabio:Expression
     */
    DemoPaper = this.toIri().concat('DemoPaper');
    /**
     * **[fabio:diary](http://purl.org/spar/fabio/Diary)**
     *
     ...
     *
     * @type        class
     * @parent      fabio:Notebook
     */
    Diary = this.toIri().concat('Diary');
    /**
     * **[fabio:digital item](http://purl.org/spar/fabio/DigitalItem)**
     *
     ...
     * @parent      fabio:Item
     */
    DigitalItem = this.toIri().concat('DigitalItem');
    /**
     * **[fabio:digital manifestation](http://purl.org/spar/fabio/DigitalManifestation)**
     *
     ...
     * @parent      fabio:Manifestation
     */
    DigitalManifestation = this.toIri().concat('DigitalManifestation');
    /**
     * **[fabio:digital storage medium](http://purl.org/spar/fabio/DigitalStorageMedium)**
     *
     ...
     * @parent      fabio:StorageMedium
     */
    DigitalStorageMedium = this.toIri().concat('DigitalStorageMedium');
    /**
     * **[fabio:directory](http://purl.org/spar/fabio/Directory)**
     *
     ...
     * @parent      fabio:Database
     */
    Directory = this.toIri().concat('Directory');
    /**
     * **[fabio:discipline dictionary](http://purl.org/spar/fabio/DisciplineDictionary)**
     *
     ...
     */
    DisciplineDictionary = this.toIri().concat('DisciplineDictionary');
    /**
     * **[fabio:doctoral thesis](http://purl.org/spar/fabio/DoctoralThesis)**
     *
     ...
     * @parent      fabio:Thesis
     */
    DoctoralThesis = this.toIri().concat('DoctoralThesis');
    /**
     * **[fabio:document repository](http://purl.org/spar/fabio/DocumentRepository)**
     *
     ...
     * @parent      fabio:Repository
     */
    DocumentRepository = this.toIri().concat('DocumentRepository');
    /**
     * **[fabio:dust jacket](http://purl.org/spar/fabio/DustJacket)**
     *
     ...
     * @parent      fabio:Expression
     */
    DustJacket = this.toIri().concat('DustJacket');
    /**
     * **[fabio:editorial](http://purl.org/spar/fabio/Editorial)**
     *
     ...
     * @parent      fabio:Expression
     */
    Editorial = this.toIri().concat('Editorial');
    /**
     * **[fabio:e-mail](http://purl.org/spar/fabio/Email)**
     *
     ...
     * @parent      fabio:Expression
     */
    Email = this.toIri().concat('Email');
    /**
     * **[fabio:entity metadata](http://purl.org/spar/fabio/EntityMetadata)**
     *
     ...
     * @parent      fabio:Metadata
     */
    EntityMetadata = this.toIri().concat('EntityMetadata');
    /**
     * **[fabio:entry](http://purl.org/spar/fabio/Entry)**
     *
     ...
     * @parent      fabio:Expression
     */
    Entry = this.toIri().concat('Entry');
    /**
     * **[fabio:erratum](http://purl.org/spar/fabio/Erratum)**
     *
     ...
     * @parent      fabio:Correction
     */
    Erratum = this.toIri().concat('Erratum');
    /**
     * **[fabio:essay](http://purl.org/spar/fabio/Essay)**
     *
     ...
     * @parent      fabio:Work
     */
    Essay = this.toIri().concat('Essay');
    /**
     * **[fabio:examination paper](http://purl.org/spar/fabio/ExaminationPaper)**
     *
     ...
     *
     * @type        class
     * @parent      fabio:BriefReport
     */
    ExecutiveSummary = this.toIri().concat('ExecutiveSummary');
    /**
     * **[fabio:experimental protocol](http://purl.org/spar/fabio/ExperimentalProtocol)**
     *
     ...
     * @parent      fabio:Specification
     */
    ExperimentalProtocol = this.toIri().concat('ExperimentalProtocol');
    /**
     * **[fabio:expression](http://purl.org/spar/fabio/Expression)**
     *
     ...
     *
     * @type        class
     * @parent      http://purl.org/vocab/frbr/core#Expression
     */
    Expression = this.toIri().concat('Expression');
    /**
     * **[fabio:expression collection](http://purl.org/spar/fabio/ExpressionCollection)**
     *
     ...
     * @parent      fabio:Expression
     */
    ExpressionCollection = this.toIri().concat('ExpressionCollection');
    /**
     * **[fabio:figure](http://purl.org/spar/fabio/Figure)**
     *
    ...
    /**
     * **[fabio:film](http://purl.org/spar/fabio/Film)**
     *
     ...
     * @parent      fabio:Movie
     */
    Film = this.toIri().concat('Film');
    /**
     * **[fabio:folksonomy](http://purl.org/spar/fabio/Folksonomy)**
     *
     ...
     *
     * @type        class
     * @parent      fabio:UncontrolledVocabulary
     */
    Folksonomy = this.toIri().concat('Folksonomy');
    /**
     * **[fabio:Gantt chart](http://purl.org/spar/fabio/GanttChart)**
     *
     ...
     * @parent      fabio:Expression
     */
    GanttChart = this.toIri().concat('GanttChart');
    /**
     * **[fabio:grant application](http://purl.org/spar/fabio/GrantApplication)**
     *
     ...
     * @parent      fabio:Work
     */
    GrantApplication = this.toIri().concat('GrantApplication');
    /**
     * **[fabio:grant application document](http://purl.org/spar/fabio/GrantApplicationDocument)**
     *
     ...
     * @parent      fabio:Expression
     */
    GrantApplicationDocument = this.toIri().concat('GrantApplicationDocument');
    /**
     * **[fabio:hardback](http://purl.org/spar/fabio/Hardback)**
     *
     ...
     *
     * @type        class
     * @parent      fabio:PrintObject
     */
    Hardback = this.toIri().concat('Hardback');
    /**
     * **[fabio:image](http://purl.org/spar/fabio/Image)**
     *
    ...
    /**
     * **[fabio:in brief](http://purl.org/spar/fabio/InBrief)**
     *
     ...
     *
     * @type        class
     * @parent      fabio:NewsItem
     */
    InBrief = this.toIri().concat('InBrief');
    /**
     * **[fabio:in-use paper](http://purl.org/spar/fabio/InUsePaper)**
     *
     ...
     *
     * @type        class
     * @parent      fabio:ScholarlyWork
     */
    InUsePaper = this.toIri().concat('InUsePaper');
    /**
     * **[fabio:index](http://purl.org/spar/fabio/Index)**
     *
     ...
     * @parent      fabio:Expression
     */
    Index = this.toIri().concat('Index');
    /**
     * **[fabio:instruction manual](http://purl.org/spar/fabio/InstructionManual)**
     *
     ...
     * @parent      fabio:Expression
     */
    InstructionManual = this.toIri().concat('InstructionManual');
    /**
     * **[fabio:instructional work](http://purl.org/spar/fabio/InstructionalWork)**
     *
     ...
     * @parent      fabio:Work
     */
    InstructionalWork = this.toIri().concat('InstructionalWork');
    /**
     * **[fabio:item](http://purl.org/spar/fabio/Item)**
     *
     ...
     *
     * @type        class
     * @parent      http://purl.org/vocab/frbr/core#Item
     */
    Item = this.toIri().concat('Item');
    /**
     * **[fabio:item collection](http://purl.org/spar/fabio/ItemCollection)**
     *
     ...
     * @parent      fabio:Item
     */
    ItemCollection = this.toIri().concat('ItemCollection');
    /**
     * **[fabio:journal](http://purl.org/spar/fabio/Journal)**
     *
     ...
     *
     * @type        class
     * @parent      fabio:Periodical
     */
    Journal = this.toIri().concat('Journal');
    /**
     * **[fabio:journal article](http://purl.org/spar/fabio/JournalArticle)**
     *
     ...
     *
     * @type        class
     * @parent      fabio:Article
     */
    JournalArticle = this.toIri().concat('JournalArticle');
    /**
     * **[fabio:journal editorial](http://purl.org/spar/fabio/JournalEditorial)**
     *
     * An editorial published in an issue of a journal.
     *
     * @type        class
     * @parent      fabio:Editorial
     */
    JournalEditorial = this.toIri().concat('JournalEditorial');
    /**
     * **[fabio:journal issue](http://purl.org/spar/fabio/JournalIssue)**
     *
     * A particular published issue of a journal, one or more of which will constitute a volume of the journal.
     *
     * @type        class
     * @parent      fabio:PeriodicalIssue
     */
    JournalIssue = this.toIri().concat('JournalIssue');
    /**
     * **[fabio:journal news item](http://purl.org/spar/fabio/JournalNewsItem)**
     *
     ...
     * @parent      fabio:NewsItem
     */
    JournalNewsItem = this.toIri().concat('JournalNewsItem');
    /**
     * **[fabio:journal volume](http://purl.org/spar/fabio/JournalVolume)**
     *
     * A particular published volume of a journal, comprising one or more journal issues.
     *
     * @type        class
     * @parent      fabio:PeriodicalVolume
     */
    JournalVolume = this.toIri().concat('JournalVolume');
    /**
     * **[fabio:laboratory notebook](http://purl.org/spar/fabio/LaboratoryNotebook)**
     *
     ...
     * @parent      fabio:Notebook
     */
    LaboratoryNotebook = this.toIri().concat('LaboratoryNotebook');
    /**
     * **[fabio:lecture notes](http://purl.org/spar/fabio/LectureNotes)**
     *
     ...
     * @parent      fabio:Expression
     */
    LectureNotes = this.toIri().concat('LectureNotes');
    /**
     * **[fabio:legal opinion](http://purl.org/spar/fabio/LegalOpinion)**
     *
     ...
     *
     * @type        class
     * @parent      fabio:Opinion
     */
    LegalOpinion = this.toIri().concat('LegalOpinion');
    /**
     * **[fabio:letter](http://purl.org/spar/fabio/Letter)**
     *
     ...
     * @parent      fabio:Expression
     */
    Letter = this.toIri().concat('Letter');
    /**
     * **[fabio:library catalog](http://purl.org/spar/fabio/LibraryCatalog)**
     *
     * The catalog of the holdings of a library, for example that of the Library of Congress (http://catalog.loc.gov/).
     *
     * @type        class
     * @parent      fabio:Catalog
     */
    LibraryCatalog = this.toIri().concat('LibraryCatalog');
    /**
     * **[fabio:literary artistic work](http://purl.org/spar/fabio/LiteraryArtisticWork)**
     *
     * A literary creative work, such as a novel, play, poem or song.
     *
     * @type        class
     * @parent      fabio:ArtisticWork
     */
    LiteraryArtisticWork = this.toIri().concat('LiteraryArtisticWork');
    /**
     * **[fabio:magazine](http://purl.org/spar/fabio/Magazine)**
     *
     ...
     * @parent      fabio:Periodical
     */
    Magazine = this.toIri().concat('Magazine');
    /**
     * **[fabio:magazine article](http://purl.org/spar/fabio/MagazineArticle)**
     *
     ...
     * @parent      fabio:Article
     */
    MagazineArticle = this.toIri().concat('MagazineArticle');
    /**
     * **[fabio:magazine editorial](http://purl.org/spar/fabio/MagazineEditorial)**
     *
     ...
     * @parent      fabio:Editorial
     */
    MagazineEditorial = this.toIri().concat('MagazineEditorial');
    /**
     * **[fabio:magazine issue](http://purl.org/spar/fabio/MagazineIssue)**
     *
     ...
     * @parent      fabio:PeriodicalIssue
     */
    MagazineIssue = this.toIri().concat('MagazineIssue');
    /**
     * **[fabio:magazine news item](http://purl.org/spar/fabio/MagazineNewsItem)**
     *
     ...
     * @parent      fabio:NewsItem
     */
    MagazineNewsItem = this.toIri().concat('MagazineNewsItem');
    /**
     * **[fabio:manifestation](http://purl.org/spar/fabio/Manifestation)**
     *
     ...
     *
     * @type        class
     * @parent      http://purl.org/vocab/frbr/core#Manifestation
     */
    Manifestation = this.toIri().concat('Manifestation');
    /**
     * **[fabio:manifestation collection](http://purl.org/spar/fabio/ManifestationCollection)**
     *
     ...
     * @parent      fabio:Manifestation
     */
    ManifestationCollection = this.toIri().concat('ManifestationCollection');
    /**
     * **[fabio:manuscript](http://purl.org/spar/fabio/Manuscript)**
     *
     ...
     * @parent      fabio:Expression
     */
    Manuscript = this.toIri().concat('Manuscript');
    /**
     * **[fabio:master's thesis](http://purl.org/spar/fabio/MastersThesis)**
     *
     ...
     * @parent      fabio:Thesis
     */
    MastersThesis = this.toIri().concat('MastersThesis');
    /**
     * **[fabio:meeting report](http://purl.org/spar/fabio/MeetingReport)**
     *
     ...
     * @parent      fabio:Report
     */
    MeetingReport = this.toIri().concat('MeetingReport');
    /**
     * **[fabio:metadata](http://purl.org/spar/fabio/Metadata)**
     *
     ...
     * @parent      fabio:Work
     */
    Metadata = this.toIri().concat('Metadata');
    /**
     * **[fabio:metadata document](http://purl.org/spar/fabio/MetadataDocument)**
     *
     ...
     * @parent      fabio:Expression
     */
    MetadataDocument = this.toIri().concat('MetadataDocument');
    /**
     * **[fabio:methods paper](http://purl.org/spar/fabio/MethodsPaper)**
     *
     ...
     * @parent      fabio:ScholarlyWork
     */
    MethodsPaper = this.toIri().concat('MethodsPaper');
    /**
     * **[fabio:microblog](http://purl.org/spar/fabio/Microblog)**
     *
     ...
     * @parent      fabio:Blog
     */
    Microblog = this.toIri().concat('Microblog');
    /**
     * **[fabio:micropost](http://purl.org/spar/fabio/Micropost)**
     *
     ...
     * @parent      fabio:Entry
     */
    Micropost = this.toIri().concat('Micropost');
    /**
     * **[fabio:minimal information standard](http://purl.org/spar/fabio/MinimalInformationStandard)**
     *
     ...
     * @parent      fabio:Specification
     */
    MinimalInformationStandard = this.toIri().concat('MinimalInformationStandard');
    /**
     * **[fabio:model](http://purl.org/spar/fabio/Model)**
     *
     ...
     * @parent      fabio:Work
     */
    Model = this.toIri().concat('Model');
    /**
     * **[fabio:movie](http://purl.org/spar/fabio/Movie)**
     *
     ...
     * @parent      fabio:Expression
     */
    Movie = this.toIri().concat('Movie');
    /**
     * **[fabio:moving image](http://purl.org/spar/fabio/MovingImage)**
     *
    ...
    /**
     * **[fabio:musical composition](http://purl.org/spar/fabio/MusicalComposition)**
     *
     * A piece of music, typically in the form of a composition recorded in musical notation.
     *
     * @type        class
     * @parent      fabio:LiteraryArtisticWork
     */
    MusicalComposition = this.toIri().concat('MusicalComposition');
    /**
     * **[fabio:nanopublication](http://purl.org/spar/fabio/Nanopublication)**
     *
     * A single, attributable and machine-readable factual assertion - the smallest unit of publishable information that can be uniquely identified and attributed to its author – typically expressed in RDF.  The minimal components of a nanopublication are as follows:* the factual assertion itself, in the form subject, predicate and object (e.g. malaria is_a disease);* provenance information about the nanopublication, defining its authorship and creation date;* supporting information (optional), providing context for the assertion;* a unique identifier for the nanopublication, in the form of a URI;* an integrity key that ensures that the nanopublication is in its original form and has not been altered.
     *
     * @type        class
     * @parent      fabio:Expression
     */
    Nanopublication = this.toIri().concat('Nanopublication');
    /**
     * **[fabio:news item](http://purl.org/spar/fabio/NewsItem)**
     *
     ...
     * @parent      fabio:Expression
     */
    NewsItem = this.toIri().concat('NewsItem');
    /**
     * **[fabio:news report](http://purl.org/spar/fabio/NewsReport)**
     *
     ...
     * @parent      fabio:Report
     */
    NewsReport = this.toIri().concat('NewsReport');
    /**
     * **[fabio:newspaper](http://purl.org/spar/fabio/Newspaper)**
     *
     ...
     * @parent      fabio:Periodical
     */
    Newspaper = this.toIri().concat('Newspaper');
    /**
     * **[fabio:newspaper article](http://purl.org/spar/fabio/NewspaperArticle)**
     *
     ...
     * @parent      fabio:Article
     */
    NewspaperArticle = this.toIri().concat('NewspaperArticle');
    /**
     * **[fabio:newspaper editorial](http://purl.org/spar/fabio/NewspaperEditorial)**
     *
     ...
     * @parent      fabio:Editorial
     */
    NewspaperEditorial = this.toIri().concat('NewspaperEditorial');
    /**
     * **[fabio:newspaper issue](http://purl.org/spar/fabio/NewspaperIssue)**
     *
     ...
     * @parent      fabio:PeriodicalIssue
     */
    NewspaperIssue = this.toIri().concat('NewspaperIssue');
    /**
     * **[fabio:newspaper news item](http://purl.org/spar/fabio/NewspaperNewsItem)**
     *
     ...
     * @parent      fabio:NewsItem
     */
    NewspaperNewsItem = this.toIri().concat('NewspaperNewsItem');
    /**
     * **[fabio:notebook](http://purl.org/spar/fabio/Notebook)**
     *
     ...
     * @parent      fabio:Book
     */
    Notebook = this.toIri().concat('Notebook');
    /**
     * **[fabio:notification of receipt](http://purl.org/spar/fabio/NotificationOfReceipt)**
     *
     * A notification of receipt of something, for example of receipt of a book that will later be the subject of a book review.
     *
     * @type        class
     * @parent      fabio:Announcement
     */
    NotificationOfReceipt = this.toIri().concat('NotificationOfReceipt');
    /**
     * **[fabio:novel](http://purl.org/spar/fabio/Novel)**
     *
     ...
     * @parent      fabio:LiteraryArtisticWork
     */
    Novel = this.toIri().concat('Novel');
    /**
     * **[fabio:obituary](http://purl.org/spar/fabio/Obituary)**
     *
     ...
     *
     * @type        class
     * @parent      fabio:NewsReport
     */
    Obituary = this.toIri().concat('Obituary');
    /**
     * **[fabio:ontology](http://purl.org/spar/fabio/Ontology)**
     *
    ...
    /**
     * **[fabio:ontology document](http://purl.org/spar/fabio/OntologyDocument)**
     *
     * A document containing an ontology, for example an OWL (Web Ontology Language) file (http://www.w3.org/TR/owl-features/).
     *
     * @type        class
     * @parent      fabio:VocabularyDocument
     */
    OntologyDocument = this.toIri().concat('OntologyDocument');
    /**
     * **[fabio:opinion](http://purl.org/spar/fabio/Opinion)**
     *
     ...
     * @parent      fabio:Work
     */
    Opinion = this.toIri().concat('Opinion');
    /**
     * **[fabio:oration](http://purl.org/spar/fabio/Oration)**
     *
     ...
     * @parent      fabio:Expression
     */
    Oration = this.toIri().concat('Oration');
    /**
     * **[fabio:page](http://purl.org/spar/fabio/Page)**
     *
     ...
     * @parent      fabio:Manifestation
     */
    Page = this.toIri().concat('Page');
    /**
     * **[fabio:paperback](http://purl.org/spar/fabio/Paperback)**
     *
     ...
     * @parent      fabio:PrintObject
     */
    Paperback = this.toIri().concat('Paperback');
    /**
     * **[fabio:patent](http://purl.org/spar/fabio/Patent)**
     *
     ...
     * @parent      fabio:Specification
     */
    Patent = this.toIri().concat('Patent');
    /**
     * **[fabio:patent application](http://purl.org/spar/fabio/PatentApplication)**
     *
     ...
     * @parent      fabio:Specification
     */
    PatentApplication = this.toIri().concat('PatentApplication');
    /**
     * **[fabio:patent application document](http://purl.org/spar/fabio/PatentApplicationDocument)**
     *
     * The physical or electronic realization of a patent application.
     *
     * @type        class
     * @parent      fabio:SpecificationDocument
     */
    PatentApplicationDocument = this.toIri().concat('PatentApplicationDocument');
    /**
     * **[fabio:patent document](http://purl.org/spar/fabio/PatentDocument)**
     *
     ...
     * @parent      fabio:SpecificationDocument
     */
    PatentDocument = this.toIri().concat('PatentDocument');
    /**
     * **[fabio:periodical](http://purl.org/spar/fabio/Periodical)**
     *
     ...
     * @parent      fabio:ExpressionCollection
     */
    Periodical = this.toIri().concat('Periodical');
    /**
     * **[fabio:periodical issue](http://purl.org/spar/fabio/PeriodicalIssue)**
     *
     ...
     * @parent      fabio:Expression
     */
    PeriodicalIssue = this.toIri().concat('PeriodicalIssue');
    /**
     * **[fabio:periodical item](http://purl.org/spar/fabio/PeriodicalItem)**
     *
     * A piece of writing published in a periodical issue, typically accompanied by other items by different authors.
     *
     * @type        class
     */
    PeriodicalItem = this.toIri().concat('PeriodicalItem');
    /**
     * **[fabio:periodical volume](http://purl.org/spar/fabio/PeriodicalVolume)**
     *
     ...
     * @parent      fabio:Expression
     */
    PeriodicalVolume = this.toIri().concat('PeriodicalVolume');
    /**
     * **[fabio:personal communication](http://purl.org/spar/fabio/PersonalCommunication)**
     *
     ...
     * @parent      fabio:Expression
     */
    PersonalCommunication = this.toIri().concat('PersonalCommunication');
    /**
     * **[fabio:Ph.D. symposium paper](http://purl.org/spar/fabio/PhDSymposiumPaper)**
     *
     ...
     * @parent      fabio:Expression
     */
    PhDSymposiumPaper = this.toIri().concat('PhDSymposiumPaper');
    /**
     * **[fabio:play](http://purl.org/spar/fabio/Play)**
     *
     ...
     * @parent      fabio:LiteraryArtisticWork
     */
    Play = this.toIri().concat('Play');
    /**
     * **[fabio:poem](http://purl.org/spar/fabio/Poem)**
     *
     ...
     * @parent      fabio:LiteraryArtisticWork
     */
    Poem = this.toIri().concat('Poem');
    /**
     * **[fabio:policy](http://purl.org/spar/fabio/Policy)**
     *
     ...
     * @parent      fabio:Work
     */
    Policy = this.toIri().concat('Policy');
    /**
     * **[fabio:policy document](http://purl.org/spar/fabio/PolicyDocument)**
     *
     ...
     * @parent      fabio:Expression
     */
    PolicyDocument = this.toIri().concat('PolicyDocument');
    /**
     * **[fabio:position paper](http://purl.org/spar/fabio/PositionPaper)**
     *
     * A scholarly work that reports a particular intellectual position or viewpoint regarding a particular scholarly topic. Usually, these papers are dependent on the author's opinion or interpretation, do not have an evaluation, and need to present relevant and novel discussion points in a thorough manner.E.g. see https://datasciencehub.net/content/guidelines-authors
     *
     * @type        class
     * @parent      fabio:Opinion
     */
    PositionPaper = this.toIri().concat('PositionPaper');
    /**
     * **[fabio:poster paper](http://purl.org/spar/fabio/PosterPaper)**
     *
     ...
     * @parent      fabio:Expression
     */
    PosterPaper = this.toIri().concat('PosterPaper');
    /**
     * **[fabio:postprint](http://purl.org/spar/fabio/Postprint)**
     *
     ...
     * @parent      fabio:Manuscript
     */
    Postprint = this.toIri().concat('Postprint');
    /**
     * **[fabio:preprint](http://purl.org/spar/fabio/Preprint)**
     *
     ...
     * @parent      fabio:Manuscript
     */
    Preprint = this.toIri().concat('Preprint');
    /**
     * **[fabio:presentation](http://purl.org/spar/fabio/Presentation)**
     *
     ...
     * @parent      fabio:Expression
     */
    Presentation = this.toIri().concat('Presentation');
    /**
     * **[fabio:press release](http://purl.org/spar/fabio/PressRelease)**
     *
     ...
     * @parent      fabio:NewsItem
     */
    PressRelease = this.toIri().concat('PressRelease');
    /**
     * **[fabio:print object](http://purl.org/spar/fabio/PrintObject)**
     *
     * An analog manifestation in physical printed form, typically on paper.
     *
     * @type        class
     * @parent      fabio:AnalogManifestation
     */
    PrintObject = this.toIri().concat('PrintObject');
    /**
     * **[fabio:proceedings paper](http://purl.org/spar/fabio/ProceedingsPaper)**
     *
     ...
     * @parent      fabio:Expression
     */
    ProceedingsPaper = this.toIri().concat('ProceedingsPaper');
    /**
     * **[fabio:product review](http://purl.org/spar/fabio/ProductReview)**
     *
     ...
     * @parent      fabio:Review
     */
    ProductReview = this.toIri().concat('ProductReview');
    /**
     * **[fabio:project metadata](http://purl.org/spar/fabio/ProjectMetadata)**
     *
     ...
     * @parent      fabio:Metadata
     */
    ProjectMetadata = this.toIri().concat('ProjectMetadata');
    /**
     * **[fabio:project plan](http://purl.org/spar/fabio/ProjectPlan)**
     *
     ...
     * @parent      fabio:Expression
     */
    ProjectPlan = this.toIri().concat('ProjectPlan');
    /**
     * **[fabio:deliverable report](http://purl.org/spar/fabio/ProjectReport)**
     *
     ...
     * @parent      fabio:Report
     */
    ProjectReport = this.toIri().concat('ProjectReport');
    /**
     * **[fabio:deliverable](http://purl.org/spar/fabio/ProjectReportDocument)**
     *
     ...
     *
     * @type        class
     * @parent      fabio:ReportDocument
     */
    ProjectReportDocument = this.toIri().concat('ProjectReportDocument');
    /**
     * **[fabio:proof](http://purl.org/spar/fabio/Proof)**
     *
     ...
     * @parent      fabio:Manuscript
     */
    Proof = this.toIri().concat('Proof');
    /**
     * **[fabio:proposition](http://purl.org/spar/fabio/Proposition)**
     *
     ...
     * @parent      fabio:Work
     */
    Proposition = this.toIri().concat('Proposition');
    /**
     * **[fabio:questionnaire](http://purl.org/spar/fabio/Questionnaire)**
     *
     ...
     * @parent      fabio:Work
     */
    Questionnaire = this.toIri().concat('Questionnaire');
    /**
     * **[fabio:quotation](http://purl.org/spar/fabio/Quotation)**
     *
     * A passage of speech selected from a larger verbal or written expression for use in another expression, with specific attribution to its original source, and usually demarcated by quotation marks and / or by placing it in a separate indented paragraph. [Note: Use fabio:Quotation to indicate a segment or passage selected from another expression that is a passage of speech, and fabio:Excerpt to indicate a segment or passage selected from another expression that is not a passage of speech.]
     *
     * @type        class
     * @parent      fabio:Expression
     */
    Quotation = this.toIri().concat('Quotation');
    /**
     * **[fabio:rapid communication](http://purl.org/spar/fabio/RapidCommunication)**
     *
     ...
     * @parent      fabio:Expression
     */
    RapidCommunication = this.toIri().concat('RapidCommunication');
    /**
     * **[fabio:reference book](http://purl.org/spar/fabio/ReferenceBook)**
     *
     ...
     * @parent      fabio:Book
     */
    ReferenceBook = this.toIri().concat('ReferenceBook');
    /**
     * **[fabio:reference entry](http://purl.org/spar/fabio/ReferenceEntry)**
     *
     ...
     * @parent      fabio:Entry
     */
    ReferenceEntry = this.toIri().concat('ReferenceEntry');
    /**
     * **[fabio:reference work](http://purl.org/spar/fabio/ReferenceWork)**
     *
     ...
     * @parent      fabio:Work
     */
    ReferenceWork = this.toIri().concat('ReferenceWork');
    /**
     * **[fabio:relational database](http://purl.org/spar/fabio/RelationalDatabase)**
     *
     ...
     * @parent      fabio:Database
     */
    RelationalDatabase = this.toIri().concat('RelationalDatabase');
    /**
     * **[fabio:reply](http://purl.org/spar/fabio/Reply)**
     *
     ...
     * @parent      fabio:Work
     */
    Reply = this.toIri().concat('Reply');
    /**
     * **[fabio:report](http://purl.org/spar/fabio/Report)**
     *
     ...
     * @parent      fabio:Work
     */
    Report = this.toIri().concat('Report');
    /**
     * **[fabio:report document](http://purl.org/spar/fabio/ReportDocument)**
     *
     ...
     * @parent      fabio:Expression
     */
    ReportDocument = this.toIri().concat('ReportDocument');
    /**
     * **[fabio:reporting standard](http://purl.org/spar/fabio/ReportingStandard)**
     *
     ...
     * @parent      fabio:Specification
     */
    ReportingStandard = this.toIri().concat('ReportingStandard');
    /**
     * **[fabio:repository](http://purl.org/spar/fabio/Repository)**
     *
     ...
     * @parent      fabio:Expression
     */
    Repository = this.toIri().concat('Repository');
    /**
     * **[fabio:research paper](http://purl.org/spar/fabio/ResearchPaper)**
     *
     ...
     * @parent      fabio:ScholarlyWork
     */
    ResearchPaper = this.toIri().concat('ResearchPaper');
    /**
     * **[fabio:resource paper](http://purl.org/spar/fabio/ResourcePaper)**
     *
     ...
     * @parent      fabio:ScholarlyWork
     */
    ResourcePaper = this.toIri().concat('ResourcePaper');
    /**
     * **[fabio:retraction](http://purl.org/spar/fabio/Retraction)**
     *
     * A formal statement retracting a statement or publicationA retraction is a public statement made about an earlier statement that withdraws, cancels, refutes, diametrically reverses the original statement or ceases and desists from publishing the original statement.
     *
     * @type        class
     * @parent      fabio:Announcement
     */
    Retraction = this.toIri().concat('Retraction');
    /**
     * **[fabio:review](http://purl.org/spar/fabio/Review)**
     *
     ...
     * @parent      fabio:Work
     */
    Review = this.toIri().concat('Review');
    /**
     * **[fabio:review article](http://purl.org/spar/fabio/ReviewArticle)**
     *
     ...
     * @parent      fabio:Article
     */
    ReviewArticle = this.toIri().concat('ReviewArticle');
    /**
     * **[fabio:review paper](http://purl.org/spar/fabio/ReviewPaper)**
     *
     * A scholarly work that surveys the state of the art of topics central to a particular subject or relating to a specific domain (e.g. the scope of a certain journal or conference). Papers of this kind may contain a selective bibliography listing key papers related to the subject or providing advice on information sources, or they may strive to be comprehensive, covering all contributions to the development of a topic and exploring their different findings or views.E.g. see http://www.emeraldgrouppublishing.com/products/journals/author_guidelines.htm?id=JD
     *
     * @type        class
     * @parent      fabio:Review
     */
    ReviewPaper = this.toIri().concat('ReviewPaper');
    /**
     * **[fabio:scholarly work](http://purl.org/spar/fabio/ScholarlyWork)**
     *
     ...
     * @parent      fabio:Work
     */
    ScholarlyWork = this.toIri().concat('ScholarlyWork');
    /**
     * **[fabio:screenplay](http://purl.org/spar/fabio/Screenplay)**
     *
     ...
     * @parent      fabio:LiteraryArtisticWork
     */
    Screenplay = this.toIri().concat('Screenplay');
    /**
     * **[fabio:script](http://purl.org/spar/fabio/Script)**
     *
     ...
     * @parent      fabio:ComputerProgram
     */
    Script = this.toIri().concat('Script');
    /**
     * **[fabio:series](http://purl.org/spar/fabio/Series)**
     *
     ...
     * @parent      fabio:ExpressionCollection
     */
    Series = this.toIri().concat('Series');
    /**
     * **[fabio:short story](http://purl.org/spar/fabio/ShortStory)**
     *
     ...
     * @parent      fabio:LiteraryArtisticWork
     */
    ShortStory = this.toIri().concat('ShortStory');
    /**
     * **[fabio:song](http://purl.org/spar/fabio/Song)**
     *
     * A musical composition that contains vocal parts ('lyrics') that are performed ('sung').
     *
     * @type        class
     * @parent      fabio:MusicalComposition
     */
    Song = this.toIri().concat('Song');
    /**
     * **[fabio:sound recording](http://purl.org/spar/fabio/SoundRecording)**
     *
     ...
     * @parent      fabio:Work
     */
    SoundRecording = this.toIri().concat('SoundRecording');
    /**
     * **[fabio:specification](http://purl.org/spar/fabio/Specification)**
     *
     ...
     * @parent      fabio:Work
     */
    Specification = this.toIri().concat('Specification');
    /**
     * **[fabio:specification document](http://purl.org/spar/fabio/SpecificationDocument)**
     *
     ...
     * @parent      fabio:Expression
     */
    SpecificationDocument = this.toIri().concat('SpecificationDocument');
    /**
     * **[fabio:spreadsheet](http://purl.org/spar/fabio/Spreadsheet)**
     *
     ...
     * @parent      fabio:Expression
     */
    Spreadsheet = this.toIri().concat('Spreadsheet');
    /**
     * **[fabio:standard operating procedure](http://purl.org/spar/fabio/StandardOperatingProcedure)**
     *
     ...
     * @parent      fabio:Specification
     */
    StandardOperatingProcedure = this.toIri().concat('StandardOperatingProcedure');
    /**
     * **[fabio:still image](http://purl.org/spar/fabio/StillImage)**
     *
    ...
    /**
     * **[fabio:storage medium](http://purl.org/spar/fabio/StorageMedium)**
     *
     * A device for recording information or storing data.
     *
     * @type        class
     */
    StorageMedium = this.toIri().concat('StorageMedium');
    /**
     * **[fabio:structured summary](http://purl.org/spar/fabio/StructuredSummary)**
     *
     ...
     * @parent      fabio:SpecificationDocument
     */
    StructuredSummary = this.toIri().concat('StructuredSummary');
    /**
     * **[fabio:subject discipline](http://purl.org/spar/fabio/SubjectDiscipline)**
     *
     ...
     */
    SubjectDiscipline = this.toIri().concat('SubjectDiscipline');
    /**
     * **[fabio:subject term](http://purl.org/spar/fabio/SubjectTerm)**
     *
     ...
     * @parent      http://www.w3.org/2004/02/skos/core#Concept
     */
    SubjectTerm = this.toIri().concat('SubjectTerm');
    /**
     * **[fabio:supplement](http://purl.org/spar/fabio/Supplement)**
     *
     ...
     * @parent      fabio:Expression
     */
    Supplement = this.toIri().concat('Supplement');
    /**
     * **[fabio:supplementary information file](http://purl.org/spar/fabio/SupplementaryInformation)**
     *
     ...
     * @parent      fabio:Expression
     */
    SupplementaryInformation = this.toIri().concat('SupplementaryInformation');
    /**
     * **[fabio:systematic review](http://purl.org/spar/fabio/SystematicReview)**
     *
     ...
     * @parent      fabio:Review
     */
    SystematicReview = this.toIri().concat('SystematicReview');
    /**
     * **[fabio:table](http://purl.org/spar/fabio/Table)**
     *
     ...
     * @parent      fabio:Expression
     */
    Table = this.toIri().concat('Table');
    /**
     * **[fabio:table of contents](http://purl.org/spar/fabio/TableOfContents)**
     *
     ...
     * @parent      fabio:Table
     */
    TableOfContents = this.toIri().concat('TableOfContents');
    /**
     * **[fabio:taxonomy](http://purl.org/spar/fabio/Taxonomy)**
     *
     ...
     * @parent      fabio:ControlledVocabulary
     */
    Taxonomy = this.toIri().concat('Taxonomy');
    /**
     * **[fabio:technical report](http://purl.org/spar/fabio/TechnicalReport)**
     *
     ...
     * @parent      fabio:Report
     */
    TechnicalReport = this.toIri().concat('TechnicalReport');
    /**
     * **[fabio:technical standard](http://purl.org/spar/fabio/TechnicalStandard)**
     *
     ...
     * @parent      fabio:Specification
     */
    TechnicalStandard = this.toIri().concat('TechnicalStandard');
    /**
     * **[fabio:term dictionary](http://purl.org/spar/fabio/TermDictionary)**
     *
     ...
     * @parent      http://www.w3.org/2004/02/skos/core#ConceptScheme
     */
    TermDictionary = this.toIri().concat('TermDictionary');
    /**
     * **[fabio:textbook](http://purl.org/spar/fabio/Textbook)**
     *
     ...
     * @parent      fabio:Book
     */
    Textbook = this.toIri().concat('Textbook');
    /**
     * **[fabio:thesaurus](http://purl.org/spar/fabio/Thesaurus)**
     *
     ...
     * @parent      fabio:ControlledVocabulary
     */
    Thesaurus = this.toIri().concat('Thesaurus');
    /**
     * **[fabio:thesis](http://purl.org/spar/fabio/Thesis)**
     *
     ...
     * @parent      fabio:Book
     */
    Thesis = this.toIri().concat('Thesis');
    /**
     * **[fabio:timetable](http://purl.org/spar/fabio/Timetable)**
     *
     * A tabular dataset providing information about the times and locations of a planned series of events.
     *
     * @type        class
     * @parent      fabio:Dataset
     */
    Timetable = this.toIri().concat('Timetable');
    /**
     * **[fabio:trial report](http://purl.org/spar/fabio/TrialReport)**
     *
     ...
     * @parent      fabio:Report
     */
    TrialReport = this.toIri().concat('TrialReport');
    /**
     * **[fabio:triplestore](http://purl.org/spar/fabio/Triplestore)**
     *
     ...
     * @parent      fabio:Database
     */
    Triplestore = this.toIri().concat('Triplestore');
    /**
     * **[fabio:tweet](http://purl.org/spar/fabio/Tweet)**
     *
     ...
     *
     * @type        class
     * @parent      fabio:Micropost
     */
    Tweet = this.toIri().concat('Tweet');
    /**
     * **[fabio:uncontrolled vocabulary](http://purl.org/spar/fabio/UncontrolledVocabulary)**
     *
     ...
     * @parent      fabio:Vocabulary
     */
    UncontrolledVocabulary = this.toIri().concat('UncontrolledVocabulary');
    /**
     * **[fabio:vocabulary](http://purl.org/spar/fabio/Vocabulary)**
     *
     ...
     * @parent      fabio:Work
     */
    Vocabulary = this.toIri().concat('Vocabulary');
    /**
     * **[fabio:vocabulary document](http://purl.org/spar/fabio/VocabularyDocument)**
     *
     ...
     * @parent      fabio:Expression
     */
    VocabularyDocument = this.toIri().concat('VocabularyDocument');
    /**
     * **[fabio:vocabulary mapping](http://purl.org/spar/fabio/VocabularyMapping)**
     *
     ...
     * @parent      fabio:Specification
     */
    VocabularyMapping = this.toIri().concat('VocabularyMapping');
    /**
     * **[fabio:vocabulary mapping document](http://purl.org/spar/fabio/VocabularyMappingDocument)**
     *
     ...
     * @parent      fabio:SpecificationDocument
     */
    VocabularyMappingDocument = this.toIri().concat('VocabularyMappingDocument');
    /**
     * **[fabio:web archive](http://purl.org/spar/fabio/WebArchive)**
     *
     ...
     * @parent      fabio:Repository
     */
    WebArchive = this.toIri().concat('WebArchive');
    /**
     * **[fabio:web content](http://purl.org/spar/fabio/WebContent)**
     *
     ...
     * @parent      fabio:Expression
     */
    WebContent = this.toIri().concat('WebContent');
    /**
     * **[fabio:web manifestation](http://purl.org/spar/fabio/WebManifestation)**
     *
     * A digital manifestation on the Web, such as a wiki, a web site, a web page or a blog.
     *
     * @type        class
     * @parent      fabio:DigitalManifestation
     */
    WebManifestation = this.toIri().concat('WebManifestation');
    /**
     * **[fabio:web page](http://purl.org/spar/fabio/WebPage)**
     *
     ...
     * @parent      fabio:Page
     */
    WebPage = this.toIri().concat('WebPage');
    /**
     * **[fabio:web site](http://purl.org/spar/fabio/WebSite)**
     *
     ...
     * @parent      fabio:WebManifestation
     */
    WebSite = this.toIri().concat('WebSite');
    /**
     * **[fabio:white paper](http://purl.org/spar/fabio/WhitePaper)**
     *
     ...
     * @parent      fabio:ReportDocument
     */
    WhitePaper = this.toIri().concat('WhitePaper');
    /**
     * **[fabio:wiki](http://purl.org/spar/fabio/Wiki)**
     *
     ...
     * @parent      fabio:WebManifestation
     */
    Wiki = this.toIri().concat('Wiki');
    /**
     * **[fabio:wiki entry](http://purl.org/spar/fabio/WikiEntry)**
     *
     ...
     * @parent      fabio:Entry
     */
    WikiEntry = this.toIri().concat('WikiEntry');
    /**
     * **[fabio:wikipedia entry](http://purl.org/spar/fabio/WikipediaEntry)**
     *
     * Information about a particular topic in one of the versions of Wikipedia, the online encyclopedia (http://www.wikipedia.org/).
     *
     * @type        class
     * @parent      fabio:WikiEntry
     */
    WikipediaEntry = this.toIri().concat('WikipediaEntry');
    /**
     * **[fabio:work](http://purl.org/spar/fabio/Work)**
     *
     ...
     *
     * @type        class
     * @parent      http://purl.org/vocab/frbr/core#Work
     */
    Work = this.toIri().concat('Work');
    /**
     * **[fabio:work collection](http://purl.org/spar/fabio/WorkCollection)**
     *
     * @type        class
     * @parent      fabio:Work
     */
    WorkCollection = this.toIri().concat('WorkCollection');
    /**
     * **[fabio:work package](http://purl.org/spar/fabio/WorkPackage)**
     *
     ...
     * @parent      fabio:Work
     */
    WorkPackage = this.toIri().concat('WorkPackage');
    /**
     * **[fabio:workflow](http://purl.org/spar/fabio/Workflow)**
     *
     ...
     * @parent      fabio:Specification
     */
    Workflow = this.toIri().concat('Workflow');
    /**
     * **[fabio:working paper](http://purl.org/spar/fabio/WorkingPaper)**
     *
     ...
     * @parent      fabio:Work
     */
    WorkingPaper = this.toIri().concat('WorkingPaper');
    /**
     * **[fabio:workshop paper](http://purl.org/spar/fabio/WorkshopPaper)**
     *
     ...
     * @parent      fabio:ProceedingsPaper
     */
    WorkshopPaper = this.toIri().concat('WorkshopPaper');
    /**
     * **[fabio:workshop proceedings](http://purl.org/spar/fabio/WorkshopProceedings)**
     *
     ...
     * @parent      fabio:AcademicProceedings
     */
    WorkshopProceedings = this.toIri().concat('WorkshopProceedings');
    /**
     * **[fabio:analog magnetic tape](http://purl.org/spar/fabio/'analog-magnetic-tape')**
     *
     ...
     * @type        instance
     */
    'analog-magnetic-tape' = this.toIri().concat('analog-magnetic-tape');
    /**
     * **[fabio:CD](http://purl.org/spar/fabio/cd)**
     *
    ...
    /**
     * **[fabio:cloud](http://purl.org/spar/fabio/cloud)**
     *
     ...
     * @type        instance
     */
    cloud = this.toIri().concat('cloud');
    /**
     * **[fabio:date last updated](http://purl.org/spar/fabio/dateLastUpdated)**
     *
     * The date on which a particular endeavour, such as an ontology, was last updated.
     *
     * @type        property
     * @parent      http://purl.org/dc/terms/date
     * @range       http://www.w3.org/2001/XMLSchema#dateTime
     */
    dateLastUpdated = this.toIri().concat('dateLastUpdated');
    /**
     * **[fabio:digital magnetic tape](http://purl.org/spar/fabio/'digital-magnetic-tape')**
     *
     ...
     * @type        instance
     */
    'digital-magnetic-tape' = this.toIri().concat('digital-magnetic-tape');
    /**
     * **[fabio:digital versatile disc](http://purl.org/spar/fabio/dvd)**
     *
    ...
    film = this.toIri().concat('film');
    /**
     * **[fabio:floppy disk](http://purl.org/spar/fabio/'floppy-disk')**
     *
     ...
     * @type        instance
     */
    'floppy-disk' = this.toIri().concat('floppy-disk');
    /**
     * **[fabio:HD](http://purl.org/spar/fabio/'hard-drive')**
     *
     ...
     * @type        instance
     */
    'hard-drive' = this.toIri().concat('hard-drive');
    /**
     * **[fabio:has access date](http://purl.org/spar/fabio/hasAccessDate)**
     *
     ...
     * @range       http://www.w3.org/2001/XMLSchema#dateTime
     */
    hasAccessDate = this.toIri().concat('hasAccessDate');
    /**
     * **[fabio:has ArXiv identifier](http://purl.org/spar/fabio/hasArXivId)**
     *
     * An identifier used by the preprint repository ArXiv.
     *
     * @type        property
     * @parent      http://purl.org/dc/terms/identifier
     */
    hasArXivId = this.toIri().concat('hasArXivId');
    /**
     * **[fabio:has CODEN](http://purl.org/spar/fabio/hasCODEN)**
     *
     ...
     * @parent      http://purl.org/dc/terms/identifier
     */
    hasCODEN = this.toIri().concat('hasCODEN');
    /**
     * **[fabio:has character count](http://purl.org/spar/fabio/hasCharacterCount)**
     *
     * The count of the number of characters in a textual resource.
     *
     * @type        property
     * @parent      http://www.w3.org/2002/07/owl#topDataProperty
     * @domain      http://purl.org/vocab/frbr/core#Endeavour
     * @range       http://www.w3.org/2001/XMLSchema#positiveInteger
     */
    hasCharacterCount = this.toIri().concat('hasCharacterCount');
    /**
     * **[fabio:has copyright year](http://purl.org/spar/fabio/hasCopyrightYear)**
     *
     ...
     */
    hasCopyrightYear = this.toIri().concat('hasCopyrightYear');
    /**
     * **[fabio:has correction date](http://purl.org/spar/fabio/hasCorrectionDate)**
     *
     ...
     * @range       http://www.w3.org/2001/XMLSchema#dateTime
     */
    hasCorrectionDate = this.toIri().concat('hasCorrectionDate');
    /**
     * **[fabio:has date collected](http://purl.org/spar/fabio/hasDateCollected)**
     *
     ...
     * @range       http://www.w3.org/2001/XMLSchema#dateTime
     */
    hasDateCollected = this.toIri().concat('hasDateCollected');
    /**
     * **[fabio:has date received](http://purl.org/spar/fabio/hasDateReceived)**
     *
     ...
     * @range       http://www.w3.org/2001/XMLSchema#dateTime
     */
    hasDateReceived = this.toIri().concat('hasDateReceived');
    /**
     * **[fabio:has deadline](http://purl.org/spar/fabio/hasDeadline)**
     *
     ...
     * @range       http://www.w3.org/2001/XMLSchema#dateTime
     */
    hasDeadline = this.toIri().concat('hasDeadline');
    /**
     * **[fabio:has decision date](http://purl.org/spar/fabio/hasDecisionDate)**
     *
     ...
     * @range       http://www.w3.org/2001/XMLSchema#dateTime
     */
    hasDecisionDate = this.toIri().concat('hasDecisionDate');
    /**
     * **[fabio:has deposit date](http://purl.org/spar/fabio/hasDepositDate)**
     *
     ...
     * @range       http://www.w3.org/2001/XMLSchema#dateTime
     */
    hasDepositDate = this.toIri().concat('hasDepositDate');
    /**
     * **[fabio:has discipline](http://purl.org/spar/fabio/hasDiscipline)**
     *
     * The discipline to which a subject vocabulary belongs.
     *
     * @type        property
     * @parent      http://www.w3.org/2002/07/owl#topObjectProperty
     * @domain      fabio:TermDictionary or http://purl.org/vocab/frbr/core#Endeavour
     * @range       fabio:SubjectDiscipline
     */
    hasDiscipline = this.toIri().concat('hasDiscipline');
    /**
     * **[fabio:has preprint dissemination date](http://purl.org/spar/fabio/hasDistributionDate)**
     *
     ...
     * @range       http://www.w3.org/2001/XMLSchema#dateTime
     */
    hasDistributionDate = this.toIri().concat('hasDistributionDate');
    /**
     * **[fabio:has electronic article identifier](http://purl.org/spar/fabio/hasElectronicArticleIdentifier)**
     *
     ...
     * @domain      http://purl.org/vocab/frbr/core#Endeavour
     */
    hasElectronicArticleIdentifier = this.toIri().concat('hasElectronicArticleIdentifier');
    /**
     * **[fabio:has embargo date](http://purl.org/spar/fabio/hasEmbargoDate)**
     *
     ...
     * @range       http://www.w3.org/2001/XMLSchema#dateTime
     */
    hasEmbargoDate = this.toIri().concat('hasEmbargoDate');
    /**
     * **[fabio:has embargo period](http://purl.org/spar/fabio/hasEmbargoDuration)**
     *
     ...
     * @parent      http://purl.org/dc/terms/date
     */
    hasEmbargoDuration = this.toIri().concat('hasEmbargoDuration');
    /**
     * **[fabio:has handle](http://purl.org/spar/fabio/hasHandle)**
     *
     ...
     */
    hasHandle = this.toIri().concat('hasHandle');
    /**
     * **[fabio:has ISSN-L](http://purl.org/spar/fabio/hasIssnL)**
     *
     ...
     * @parent      http://purl.org/dc/terms/identifier
     */
    hasIssnL = this.toIri().concat('hasIssnL');
    /**
     * **[fabio:has manifestation](http://purl.org/spar/fabio/hasManifestation)**
     *
     ...
     *
     * @type        property
     * @parent      http://purl.org/vocab/frbr/core#relatedEndeavour
     * @domain      http://purl.org/vocab/frbr/core#Work
     * @range       http://purl.org/vocab/frbr/core#Manifestation
     */
    hasManifestation = this.toIri().concat('hasManifestation');
    /**
     * **[fabio:has National Library of Medicine journal title abbreviation](http://purl.org/spar/fabio/hasNLMJournalTitleAbbreviation)**
     *
     ...
     *
     * @type        property
     * @parent      fabio:hasShortTitle
     */
    hasNLMJournalTitleAbbreviation = this.toIri().concat('hasNLMJournalTitleAbbreviation');
    /**
     * **[fabio:has National Library of Medicine journal identifier](http://purl.org/spar/fabio/hasNationalLibraryOfMedicineJournalId)**
     *
     ...
     * @domain      http://purl.org/vocab/frbr/core#Endeavour
     */
    hasNationalLibraryOfMedicineJournalId = this.toIri().concat('hasNationalLibraryOfMedicineJournalId');
    /**
     * **[fabio:has PII](http://purl.org/spar/fabio/hasPII)**
     *
     ...
     * @parent      http://purl.org/dc/terms/identifier
     */
    hasPII = this.toIri().concat('hasPII');
    /**
     * **[fabio:has page count](http://purl.org/spar/fabio/hasPageCount)**
     *
     ...
     * @range       http://www.w3.org/2001/XMLSchema#positiveInteger
     */
    hasPageCount = this.toIri().concat('hasPageCount');
    /**
     * **[fabio:has patent number](http://purl.org/spar/fabio/hasPatentNumber)**
     *
     ...
     * @parent      http://purl.org/dc/terms/identifier
     */
    hasPatentNumber = this.toIri().concat('hasPatentNumber');
    /**
     * **[fabio:has place of publication](http://purl.org/spar/fabio/hasPlaceOfPublication)**
     *
     * The place (usually, the city) where the publisher of a particular bibliographic resource is located.
     *
     * @type        property
     * @domain      http://purl.org/vocab/frbr/core#Endeavour
     * @range       http://purl.org/vocab/frbr/core#Place
     */
    hasPlaceOfPublication = this.toIri().concat('hasPlaceOfPublication');
    /**
     * **[fabio:has portrayal](http://purl.org/spar/fabio/hasPortrayal)**
     *
     ...
     */
    hasPortrayal = this.toIri().concat('hasPortrayal');
    /**
     * **[fabio:has primary subject term](http://purl.org/spar/fabio/hasPrimarySubjectTerm)**
     *
     ...
     *
     * @type        property
     * @parent      fabio:hasSubjectTerm
     */
    hasPrimarySubjectTerm = this.toIri().concat('hasPrimarySubjectTerm');
    /**
     * **[fabio:has PubMed Central identifier](http://purl.org/spar/fabio/hasPubMedCentralId)**
     *
     ...
     * @range       http://www.w3.org/2001/XMLSchema#string
     */
    hasPubMedCentralId = this.toIri().concat('hasPubMedCentralId');
    /**
     * **[fabio:has PubMed identifier](http://purl.org/spar/fabio/hasPubMedId)**
     *
     ...
     * @range       http://www.w3.org/2001/XMLSchema#string
     */
    hasPubMedId = this.toIri().concat('hasPubMedId');
    /**
     * **[fabio:has publication year](http://purl.org/spar/fabio/hasPublicationYear)**
     *
     * The year in which a resource is published.
     *
     * @type        property
     * @parent      http://purl.org/dc/terms/issued
     * @range       http://www.w3.org/2001/XMLSchema#gYear
     */
    hasPublicationYear = this.toIri().concat('hasPublicationYear');
    /**
     * **[fabio:has representation](http://purl.org/spar/fabio/hasRepresentation)**
     *
     ...
     * @range       http://purl.org/vocab/frbr/core#Item
     */
    hasRepresentation = this.toIri().concat('hasRepresentation');
    /**
     * **[fabio:has request date](http://purl.org/spar/fabio/hasRequestDate)**
     *
     ...
     * @parent      http://purl.org/dc/terms/date
     */
    hasRequestDate = this.toIri().concat('hasRequestDate');
    /**
     * **[fabio:has retraction date](http://purl.org/spar/fabio/hasRetractionDate)**
     *
     ...
     * @range       http://www.w3.org/2001/XMLSchema#dateTime
     */
    hasRetractionDate = this.toIri().concat('hasRetractionDate');
    /**
     * **[fabio:has SICI](http://purl.org/spar/fabio/hasSICI)**
     *
     ...
     * @range       http://www.w3.org/2001/XMLSchema#string
     */
    hasSICI = this.toIri().concat('hasSICI');
    /**
     * **[fabio:has season](http://purl.org/spar/fabio/hasSeason)**
     *
     ...
     * @parent      http://www.w3.org/2002/07/owl#topDataProperty
     */
    hasSeason = this.toIri().concat('hasSeason');
    /**
     * **[fabio:has number](http://purl.org/spar/fabio/hasSequenceIdentifier)**
     *
     ...
     * @domain      http://purl.org/vocab/frbr/core#Endeavour
     */
    hasSequenceIdentifier = this.toIri().concat('hasSequenceIdentifier');
    /**
     * **[fabio:has short title](http://purl.org/spar/fabio/hasShortTitle)**
     *
     ...
     *
     * @type        property
     * @parent      http://purl.org/dc/terms/title
     * @domain      http://purl.org/vocab/frbr/core#Endeavour
     * @range       http://www.w3.org/2001/XMLSchema#string
     */
    hasShortTitle = this.toIri().concat('hasShortTitle');
    /**
     * **[fabio:has standard number](http://purl.org/spar/fabio/hasStandardNumber)**
     *
     ...
     * @parent      http://purl.org/dc/terms/identifier
     */
    hasStandardNumber = this.toIri().concat('hasStandardNumber');
    /**
     * **[fabio:has subject term](http://purl.org/spar/fabio/hasSubjectTerm)**
     *
     ...
     * @parent      http://www.w3.org/2002/07/owl#topObjectProperty
     * @domain      http://purl.org/vocab/frbr/core#Endeavour
     * @range       fabio:SubjectTerm
     */
    hasSubjectTerm = this.toIri().concat('hasSubjectTerm');
    /**
     * **[fabio:has subtitle](http://purl.org/spar/fabio/hasSubtitle)**
     *
     ...
     * @range       http://www.w3.org/2001/XMLSchema#string
     */
    hasSubtitle = this.toIri().concat('hasSubtitle');
    /**
     * **[fabio:has translated subtitle](http://purl.org/spar/fabio/hasTranslatedSubtitle)**
     *
     ...
     * @parent      http://purl.org/dc/terms/title
     */
    hasTranslatedSubtitle = this.toIri().concat('hasTranslatedSubtitle');
    /**
     * **[fabio:has translated title](http://purl.org/spar/fabio/hasTranslatedTitle)**
     *
     ...
     * @parent      http://purl.org/dc/terms/title
     */
    hasTranslatedTitle = this.toIri().concat('hasTranslatedTitle');
    /**
     * **[fabio:has URL](http://purl.org/spar/fabio/hasURL)**
     *
     ...
     */
    hasURL = this.toIri().concat('hasURL');
    /**
     * **[fabio:has volume count](http://purl.org/spar/fabio/hasVolumeCount)**
     *
     ...
     */
    hasVolumeCount = this.toIri().concat('hasVolumeCount');
    /**
     * **[fabio:internet](http://purl.org/spar/fabio/internet)**
     *
     ...
     * @type        instance
     */
    internet = this.toIri().concat('internet');
    /**
     * **[fabio:intranet](http://purl.org/spar/fabio/intranet)**
     *
     ...
     * @type        instance
     */
    intranet = this.toIri().concat('intranet');
    /**
     * **[fabio:is discipline of](http://purl.org/spar/fabio/isDisciplineOf)**
     *
     * This property relates a subject vocabulary to the discipline to which it belongs.
     *
     * @type        property
     * @parent      http://www.w3.org/2002/07/owl#topObjectProperty
     * @domain      fabio:SubjectDiscipline
     * @range       fabio:TermDictionary or http://purl.org/vocab/frbr/core#Endeavour
     */
    isDisciplineOf = this.toIri().concat('isDisciplineOf');
    /**
     * **[fabio:is manifestation of](http://purl.org/spar/fabio/isManifestationOf)**
     *
     ...
     * @type        property
     * @parent      http://purl.org/vocab/frbr/core#relatedEndeavour
     * @domain      http://purl.org/vocab/frbr/core#Manifestation
     * @range       http://purl.org/vocab/frbr/core#Work
     */
    isManifestationOf = this.toIri().concat('isManifestationOf');
    /**
     * **[fabio:is portrayal of](http://purl.org/spar/fabio/isPortrayalOf)**
     *
     ...
     * @type        property
     * @parent      http://purl.org/vocab/frbr/core#relatedEndeavour
     * @domain      http://purl.org/vocab/frbr/core#Item
     * @range       http://purl.org/vocab/frbr/core#Work
     */
    isPortrayalOf = this.toIri().concat('isPortrayalOf');
    /**
     * **[fabio:is representation of](http://purl.org/spar/fabio/isRepresentationOf)**
     *
     ...
     */
    isRepresentationOf = this.toIri().concat('isRepresentationOf');
    /**
     * **[fabio:is scheme of](http://purl.org/spar/fabio/isSchemeOf)**
     *
     ...
     */
    isSchemeOf = this.toIri().concat('isSchemeOf');
    /**
     * **[fabio:is stored on](http://purl.org/spar/fabio/isStoredOn)**
     *
     ...
     * @parent      http://www.w3.org/2002/07/owl#topObjectProperty
     * @domain      fabio:Item
     * @range       fabio:StorageMedium
     */
    isStoredOn = this.toIri().concat('isStoredOn');
    /**
     * **[fabio:paper](http://purl.org/spar/fabio/paper)**
     *
     * A thin flat material, typically made from wood pulp, mainly used for writing upon, for printing upon or for packaging.
     *
     * @type        instance
     */
    paper = this.toIri().concat('paper');
    /**
     * **[fabio:RAM](http://purl.org/spar/fabio/ram)**
     *
     ...
     * @type        instance
     */
    ram = this.toIri().concat('ram');
    /**
     * **[fabio:solid state memory](http://purl.org/spar/fabio/'solid-state-memory')**
     *
     * A digital storage device built entirely from solid electronic materials with no moving parts, e.g. a USB flash drive.
     *
     * @type        instance
     */
    'solid-state-memory' = this.toIri().concat('solid-state-memory');
    /**
     * **[fabio:stores](http://purl.org/spar/fabio/stores)**
     *
     * This property relates a storage medium to the fabio:Item stored upon it.
     *
     * @type        property
     * @parent      http://www.w3.org/2002/07/owl#topObjectProperty
     * @domain      fabio:StorageMedium
     * @range       fabio:Item
     */
    stores = this.toIri().concat('stores');
    /**
     * **[fabio:uses calendar](http://purl.org/spar/fabio/usesCalendar)**
     *
     ...
     * @parent      http://www.w3.org/2002/07/owl#topDataProperty
     */
    usesCalendar = this.toIri().concat('usesCalendar');
    /**
     * **[fabio:vinyl disk](http://purl.org/spar/fabio/'vinyl-disk')**
     *
 ...
 */
const fabio = new Vocabulary('http://purl.org/spar/fabio/');
export default fabio;
//# sourceMappingURL=fabio.js.map