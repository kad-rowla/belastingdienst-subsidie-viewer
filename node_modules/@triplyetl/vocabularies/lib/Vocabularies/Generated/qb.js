...
class Vocabulary extends VocabularyBase {
     ...
     * @type        class
     */
    Attachable = this.toIri().concat('Attachable');
    /**
     ...
     */
    AttributeProperty = this.toIri().concat('AttributeProperty');
    /**
     ...
     * @parent      qb:ComponentProperty
     */
    CodedProperty = this.toIri().concat('CodedProperty');
    /**
     ...
     */
    ComponentProperty = this.toIri().concat('ComponentProperty');
    /**
     ...
     * @type        class
     */
    ComponentSet = this.toIri().concat('ComponentSet');
    /**
     ...
     */
    ComponentSpecification = this.toIri().concat('ComponentSpecification');
    /**
     ...
     * @parent      qb:ComponentSet
     */
    DataStructureDefinition = this.toIri().concat('DataStructureDefinition');
    /**
     ...
     */
    DimensionProperty = this.toIri().concat('DimensionProperty');
    /**
     ...
     * @type        class
     */
    HierarchicalCodeList = this.toIri().concat('HierarchicalCodeList');
    /**
     ...
     * @parent      qb:ComponentProperty
     */
    MeasureProperty = this.toIri().concat('MeasureProperty');
    /**
     ...
     * @parent      qb:Attachable
     */
    Observation = this.toIri().concat('Observation');
    /**
     ...
     * @type        class
     */
    ObservationGroup = this.toIri().concat('ObservationGroup');
    /**
     ...
     * @parent      qb:ComponentSet
     */
    SliceKey = this.toIri().concat('SliceKey');
    /**
     ...
     */
    attribute = this.toIri().concat('attribute');
    /**
     ...
     */
    codeList = this.toIri().concat('codeList');
    /**
     ...
     */
    component = this.toIri().concat('component');
    /**
     ...
     */
    componentAttachment = this.toIri().concat('componentAttachment');
    /**
     ...
     */
    componentRequired = this.toIri().concat('componentRequired');
    /**
     ...
     */
    dimension = this.toIri().concat('dimension');
    /**
     ...
     */
    hierarchyRoot = this.toIri().concat('hierarchyRoot');
    /**
     ...
     * @range       qb:DimensionProperty
     */
    measureDimension = this.toIri().concat('measureDimension');
    /**
     ...
     * @range       qb:MeasureProperty
     */
    measureType = this.toIri().concat('measureType');
    /**
     * **[qb:observation](http://purl.org/linked-data/cube#observation)**
     *
     ...
     */
    parentChildProperty = this.toIri().concat('parentChildProperty');
    /**
     * **[qb:slice](http://purl.org/linked-data/cube#slice)**
     *
     ...
     * @range       qb:SliceKey
     */
    sliceStructure = this.toIri().concat('sliceStructure');
    /**
 ...
 */
const qb = new Vocabulary('http://purl.org/linked-data/cube#');
export default qb;
