...
class Vocabulary extends VocabularyBase {
     ...
     * @parent      void:Dataset
     */
    Linkset = this.toIri().concat('Linkset');
    /**
     ...
     * @type        class
     */
    TechnicalFeature = this.toIri().concat('TechnicalFeature');
    /**
     ...
     * @range       void:Dataset
     */
    classPartition = this.toIri().concat('classPartition');
    /**
     ...
     */
    classes = this.toIri().concat('classes');
    /**
     ...
     */
    dataDump = this.toIri().concat('dataDump');
    /**
     ...
     * @range       http://www.w3.org/2001/XMLSchema#integer
     */
    distinctObjects = this.toIri().concat('distinctObjects');
    /**
     ...
     * @range       http://www.w3.org/2001/XMLSchema#integer
     */
    distinctSubjects = this.toIri().concat('distinctSubjects');
    /**
     ...
     * @range       http://www.w3.org/2001/XMLSchema#integer
     */
    entities = this.toIri().concat('entities');
    /**
     ...
     * @range       http://www.w3.org/2000/01/rdf-schema#Resource
     */
    exampleResource = this.toIri().concat('exampleResource');
    /**
     ...
     * @range       void:Dataset
     */
    inDataset = this.toIri().concat('inDataset');
    /**
     ...
     */
    linkPredicate = this.toIri().concat('linkPredicate');
    /**
     ...
     * @range       void:Dataset
     */
    objectsTarget = this.toIri().concat('objectsTarget');
    /**
     ...
     */
    openSearchDescription = this.toIri().concat('openSearchDescription');
    /**
     ...
     * @range       http://www.w3.org/2001/XMLSchema#integer
     */
    properties = this.toIri().concat('properties');
    /**
     ...
     * @range       void:Dataset
     */
    propertyPartition = this.toIri().concat('propertyPartition');
    /**
     ...
     * @domain      void:Dataset
     */
    rootResource = this.toIri().concat('rootResource');
    /**
     ...
     * @domain      void:Dataset
     */
    sparqlEndpoint = this.toIri().concat('sparqlEndpoint');
    /**
     ...
     * @range       void:Dataset
     */
    subjectsTarget = this.toIri().concat('subjectsTarget');
    /**
     ...
     * @range       void:Dataset
     */
    subset = this.toIri().concat('subset');
    /**
     ...
     * @range       http://www.w3.org/2001/XMLSchema#integer
     */
    triples = this.toIri().concat('triples');
    /**
     ...
     * @domain      void:Dataset
     */
    uriLookupEndpoint = this.toIri().concat('uriLookupEndpoint');
    /**
     ...
     * @domain      void:Dataset
     */
    uriRegexPattern = this.toIri().concat('uriRegexPattern');
    /**
     ...
     */
    uriSpace = this.toIri().concat('uriSpace');
    /**
