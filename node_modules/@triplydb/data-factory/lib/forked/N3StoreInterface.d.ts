...
export interface Store extends RDF.Store<Quad>, RDF.DatasetCore<Quad, Quad> {
    ...
    removeQuad(subject: Quad["subject"], predicate: Quad["predicate"], object: Quad["object"] | Array<Quad["object"]>, graph?: Quad["graph"], done?: () => void): void;
    ...
    match(subject?: Term | null, predicate?: Term | null, object?: Term | null, graph?: Term | null): RDF.Stream<Quad> & RDF.DatasetCore<Quad, Quad>;
...
//# sourceMappingURL=N3StoreInterface.d.ts.map